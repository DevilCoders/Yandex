...
export async function* createSlide() {
    console.log('/--------------------------------------------/');
    console.log('START DETECT QUALITY SLIDE');
    let download_link = 'https://charts.yandex-team.ru/api/scr/v1/screenshots/preview/editor/smta6idn2nx6n-not-blocked-stats?_no_controls=true&__scr_width=1600&__scr_height=720&_embedded=1';
    ...
    let textboxText = "Качество детекта";
