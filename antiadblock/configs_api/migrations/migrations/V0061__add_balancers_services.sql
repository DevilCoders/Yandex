ALTER TABLE public.services ADD COLUMN balancers_prod varchar(256) ARRAY DEFAULT '{}';
ALTER TABLE public.services ADD COLUMN balancers_test varchar(256) ARRAY DEFAULT '{}';
