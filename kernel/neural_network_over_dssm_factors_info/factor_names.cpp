...
// autogenerated code
#include <kernel/neural_network_over_dssm_factors_info/factors_gen.cpp>

#include <kernel/generated_factors_info/simple_factors_info.h>

namespace NNeuralNetworkOverDssmFactors {
    ...
    TAutoPtr<IFactorsInfo> GetFactorsInfoIf(size_t begin, size_t end) {
        ...
        return new TWebFactorsInfo<TFactorInfo>(begin, end, NNeuralNetworkOverDssmFactors::GetFactorsInfo());
    }
