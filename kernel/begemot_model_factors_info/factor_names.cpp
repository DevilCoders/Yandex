...
// autogenerated code
#include <kernel/begemot_model_factors_info/factors_gen.cpp>

#include <kernel/generated_factors_info/simple_factors_info.h>

namespace NBegemotModelFactors {
    ...
    TAutoPtr<IFactorsInfo> GetFactorsInfoIf(size_t begin, size_t end) {
        ...
        return new TWebFactorsInfo<TFactorInfo>(begin, end, NBegemotModelFactors::GetFactorsInfo());
    }
