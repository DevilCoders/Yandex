...
def test_generate_identifier_unicode():
    result = generate_identifier(u"/my/awesome/ugc/", u"/user/123456", context_id="текст отзыва")
    assert result == u"HjQjAiU-agSV4R1CI3X7OsmpUkWbu6zpY"
    assert isinstance(result, unicode)


def test_generate_identifier_cyrillic_unicode():
    assert generate_identifier("/my/awesome/ugc/", "/user/123456", context_id=u"текст отзыва") == "HjQjAiU-agSV4R1CI3X7OsmpUkWbu6zpY"
