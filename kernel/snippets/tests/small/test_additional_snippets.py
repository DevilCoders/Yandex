...
CANONICAL_OUTPUT_PATH = yatest.common.output_path('additional_snippets.tsv')
...
def test_additional_snippets():
    with open(SNIPPET_DUMP_OUTPUT_PATH, 'w') as fout:
        yatest.common.execute(
            [
                CSNIP_PATH,
                '-r', 'json',
                '-E', 'fact_snip_candidates,fact_snip_top_candidate_count=10',
                '-i', CONTEXT_DATA_PATH,
            ],
            stdout=fout,
