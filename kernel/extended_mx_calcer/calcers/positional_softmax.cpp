...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TPositionalSoftmaxWithSubtargetsBundle - multiclassification bundle with subtargets
//                                          treat some pos as do not show value
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class TPositionalSoftmaxWithSubtargetsBundle : public TBundleBase<TPositionalSoftmaxWithSubtargetsConstProto> {
...
public:
    TPositionalSoftmaxWithSubtargetsBundle(const NSc::TValue& scheme)
      : TBundleBase(scheme) {}
    ...
    void InitializeAfterStorageLoad(const ISharedFormulasAdapter* const formulasStoragePtr) override {
        ...
        Y_ENSURE(targetsCount >= upperNumFeats, "not enough target fmls");
...
public:
    double DoCalcRelevExtended(const float* features, const size_t featuresCount, TCalcContext& context) const override {
        ...
        TFactors factors(1);
        factors[0].reserve(subResults.size() + UseSourceFeaturesInUpperFml * featuresCount);
        for (const auto& res : subResults)
            factors[0].push_back(res.front());
...
TExtendedCalculatorRegistrator<TPositionalSoftmaxWithSubtargetsBundle> PositionalSoftmaxWithSubtargetsBundleRegistrator("positional_softmax_with_subtargets");
