...
public final class Labels3 extends Labels {

    private final Label label0;
    private final Label label1;
    private final Label label2;

    public Labels3(Label label0, Label label1, Label label2) {
        this.label0 = label0;
        this.label1 = label1;
        this.label2 = label2;
    }

    public Labels3(LabelsBuilder builder) {
    ...
    public Stream<Label> stream() {
        return Stream.of(label0, label1, label2);
    }
    ...
    public LabelsBuilder toBuilder() {
        return new LabelsBuilder(SortState.SORTED, label0, label1, label2);
    }
    ...
    public List<Label> toList() {
        return Arrays.asList(label0, label1, label2);
    }
