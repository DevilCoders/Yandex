...
Y_UNIT_TEST_SUITE(TFredrikssonNikitinArrayTest) {
    Y_UNIT_TEST(Test1) {
        TVector<ui64> data(1, 0);
        TFredrikssonNikitinArray<ui64> ef(data.begin(), data.end());
    ...
    Y_UNIT_TEST(Test7) {
        ...
        TFredrikssonNikitinArray<ui64> ef(data, data + Y_ARRAY_SIZE(data));
    ...
    Y_UNIT_TEST(Test9) {
        ...
        for (size_t i = 0; i < data.size(); ++i)
            data[i] = RandomNumber<ui64>(1024);
        TFredrikssonNikitinArray<ui64> ef;
    ...
    Y_UNIT_TEST(Test10) {
        ...
        TFredrikssonNikitinArray<ui64> efSaved;
        ::Load(&ss, efSaved);
