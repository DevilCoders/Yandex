...
from core.actions import packformer
from core.models import TaskPool, User
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm['core.User'].objects.filter(
            role=User.Role.ASSESSOR
        ):
            packformer.create_packs(user, est_class=orm['core.Estimation'],
                                    pack_class=orm['core.TaskPack'])
        orm['core.TaskPool'].objects.filter(
    ...
    def backwards(self, orm):
        ...
        for user in orm['core.User'].objects.all():
            packformer.delete_packs(user, pack_class=orm['core.TaskPack'])
