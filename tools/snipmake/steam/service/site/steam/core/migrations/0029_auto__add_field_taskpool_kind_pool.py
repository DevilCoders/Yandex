...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskPool.kind_pool'
        db.add_column(u'core_taskpool', 'kind_pool',
                      self.gf('django.db.models.fields.CharField')(default='MCR', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskPool.kind_pool'
        db.delete_column(u'core_taskpool', 'kind_pool')
    ...
    models = {
        ...
        u'core.taskpool': {
            ...
            'kind_pool': ('django.db.models.fields.CharField', [], {'default': "'MCR'", 'max_length': '3'}),
