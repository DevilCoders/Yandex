...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        self.change_keys(orm, 'sapidity', 'content_richness')


    def backwards(self, orm):
        "Write your backwards methods here."
        self.change_keys(orm, 'content_richness', 'sapidity')


    def change_keys(self, orm, old, new):
        for est in orm['core.Estimation'].objects.all():
            if old in est.json_value:
                est.json_value[new] = est.json_value[old]
                del est.json_value[old]
                est.save()
