...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estimation.rendering_time'
        db.add_column(u'core_estimation', 'rendering_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estimation.rendering_time'
        db.delete_column(u'core_estimation', 'rendering_time')
