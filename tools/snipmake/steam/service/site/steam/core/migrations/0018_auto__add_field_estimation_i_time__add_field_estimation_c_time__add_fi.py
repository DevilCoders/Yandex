...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estimation.i_time'
        db.add_column(u'core_estimation', 'i_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Estimation.c_time'
        db.add_column(u'core_estimation', 'c_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Estimation.r_time'
        db.add_column(u'core_estimation', 'r_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estimation.i_time'
        db.delete_column(u'core_estimation', 'i_time')

        # Deleting field 'Estimation.c_time'
        db.delete_column(u'core_estimation', 'c_time')

        # Deleting field 'Estimation.r_time'
        db.delete_column(u'core_estimation', 'r_time')
