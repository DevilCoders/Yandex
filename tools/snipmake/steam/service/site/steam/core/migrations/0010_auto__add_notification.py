...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_notification', (
            ...
            ('taskpack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TaskPack'], null=True)),
            ('estimation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Estimation'], null=True)),
        ))
