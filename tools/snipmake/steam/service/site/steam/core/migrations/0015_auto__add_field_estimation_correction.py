...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estimation.correction'
        db.add_column(u'core_estimation', 'correction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Correction'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estimation.correction'
        db.delete_column(u'core_estimation', 'correction_id')
