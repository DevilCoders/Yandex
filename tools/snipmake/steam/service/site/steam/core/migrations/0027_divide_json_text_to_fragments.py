...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        def fix_snip(snip):
            snip.data['text'] = [snip.data['text']]
            return snip

        for i in range(16):
            qs = orm['core.Snippet'].objects.filter(snippet_id__startswith=('%X' % i))
            snips = [fix_snip(snip) for snip in qs.iterator()]
            qs.delete()
            orm['core.Snippet'].objects.bulk_create(snips, 10000)
            print('Finished "%X*"' % i)
    ...
    def backwards(self, orm):
        ...
        def fix_snip(snip):
            snip.data['text'] = u'…'.join(snip.data['text'])
            return snip
    ...
    models = {
        ...
        u'core.task': {
            ...
            'first_snippet_id': ('django.db.models.fields.CharField', [], {'max_length': '74'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'region': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'request': ('django.db.models.fields.TextField', [], {}),
            'second_snippet_id': ('django.db.models.fields.CharField', [], {'max_length': '74'}),
