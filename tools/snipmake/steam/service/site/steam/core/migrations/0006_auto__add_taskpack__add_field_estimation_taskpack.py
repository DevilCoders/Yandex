...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskPack'
        db.create_table(u'core_taskpack', (
        ...
        db.send_create_signal(u'core', ['TaskPack'])

        # Adding field 'Estimation.taskpack'
        db.add_column(u'core_estimation', 'taskpack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TaskPack'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TaskPack'
        db.delete_table(u'core_taskpack')

        # Deleting field 'Estimation.taskpack'
        db.delete_column(u'core_estimation', 'taskpack_id')
