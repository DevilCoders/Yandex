...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskPool.first_pool_tpl'
        db.add_column(u'core_taskpool', 'first_pool_tpl',
                      self.gf('django.db.models.fields.CharField')(default='ANY', max_length=3),
                      keep_default=False)

        # Adding field 'TaskPool.second_pool_tpl'
        db.add_column(u'core_taskpool', 'second_pool_tpl',
                      self.gf('django.db.models.fields.CharField')(default='ANY', max_length=3),
                      keep_default=False)

        # Adding field 'SnippetPool.tpl'
        db.add_column(u'core_snippetpool', 'tpl',
                      self.gf('django.db.models.fields.CharField')(default='ANY', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskPool.first_pool_tpl'
        db.delete_column(u'core_taskpool', 'first_pool_tpl')

        # Deleting field 'TaskPool.second_pool_tpl'
        db.delete_column(u'core_taskpool', 'second_pool_tpl')

        # Deleting field 'SnippetPool.tpl'
        db.delete_column(u'core_snippetpool', 'tpl')
