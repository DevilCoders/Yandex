...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Estimation.taskpack'
        db.alter_column(u'core_estimation', 'taskpack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TaskPack'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Estimation.taskpack'
        db.alter_column(u'core_estimation', 'taskpack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TaskPack'], null=True))
