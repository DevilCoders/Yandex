...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Syncronizer'
        db.create_table(u'core_syncronizer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('aadmin_email', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'core', ['Syncronizer'])


    def backwards(self, orm):
        # Deleting model 'Syncronizer'
        db.delete_table(u'core_syncronizer')
