...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskPool.country'
        db.delete_column(u'core_taskpool', 'country')


    def backwards(self, orm):
        # Adding field 'TaskPool.country'
        db.add_column(u'core_taskpool', 'country',
                      self.gf('django.db.models.fields.CharField')(default='RU', max_length=4),
                      keep_default=False)
