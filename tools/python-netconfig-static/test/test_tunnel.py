...
def test_ipv6_tunnel_has_ipv4_loopback():
    ...
    assert has_postup(
        iface, 'route add 5.255.240.211 via 2a02:6b8:0:1435::1 dev eth0 src 37.9.69.65')
    assert has_postdown(
        iface, 'route del 5.255.240.211 via 2a02:6b8:0:1435::1 dev eth0 src 37.9.69.65')
