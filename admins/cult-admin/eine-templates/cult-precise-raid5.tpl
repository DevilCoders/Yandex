...
if [ $lxc -eq 0 ]; then
	raid /home -d md1 -e 1.2 -l 5 -a "-p ls" -t ext4 -o "defaults,noatime,nobarrier,nodelalloc" raid.02 raid.12 raid.22 raid.32 -- --assume-clean
else
	raid pv -d md1 -e 1.2 -l 5 -a "-p ls" raid.02 raid.12 raid.22 raid.32 -- --assume-clean
fi
