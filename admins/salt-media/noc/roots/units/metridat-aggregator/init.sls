/etc/metridat-aggregator/config.yaml:
  file.managed:
    - source: salt://{{ slspath }}/files/etc/metridat-aggregator/config.yaml
    - template: jinja
    - user: metridat
    - group: metridat
    - mode: 600
...
/etc/telegraf/telegraf.d/metridat-aggregator.conf:
  file.managed:
    - source: salt://{{ slspath }}/files/etc/telegraf/telegraf.d/metridat-aggregator.conf
    - template: jinja
    - user: telegraf
    - group: telegraf
    - mode: 600
