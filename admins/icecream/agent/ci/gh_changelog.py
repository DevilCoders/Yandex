...
PULSE_URL = 'https://github.yandex-team.ru/yandex-icecream/agent/pulse'
PULLS_URL = 'https://api.github.yandex-team.ru/repos/yandex-icecream/agent/pulls' \
            '?state=closed&sort=updated&direction=desc'
PULL_URL_TPL = 'https://github.yandex-team.ru/yandex-icecream/agent/pull/{}'
