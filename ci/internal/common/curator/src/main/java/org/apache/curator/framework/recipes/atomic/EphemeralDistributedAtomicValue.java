 ...
 */
public class EphemeralDistributedAtomicValue
{
     ...
     */
    public EphemeralDistributedAtomicValue(CuratorFramework client, String path, RetryPolicy retryPolicy)
    {
     ...
     */
    public EphemeralDistributedAtomicValue(CuratorFramework client, String path, RetryPolicy retryPolicy, @Nullable PromotedToLock promotedToLock)
    {
        this.client = client;
    ...
    public void forceSet(byte[] newValue) throws Exception
    {
        ...
        catch ( KeeperException.NoNodeException dummy )
        {
            try
            {
                client.create().creatingParentContainersIfNeeded().withMode(CreateMode.EPHEMERAL).forPath(path, newValue);
            }
    ...
    public boolean initialize(byte[] value) throws Exception
    {
        try
        {
            client.create().creatingParentContainersIfNeeded().withMode(CreateMode.EPHEMERAL).forPath(path, value);
        }
