 ...
 */
public class EphemeralDistributedAtomicLong implements DistributedAtomicNumber<Long>
{
    private final EphemeralDistributedAtomicValue        value;
     ...
     */
    public EphemeralDistributedAtomicLong(CuratorFramework client, String counterPath, RetryPolicy retryPolicy)
    {
     ...
     */
    public EphemeralDistributedAtomicLong(CuratorFramework client, String counterPath, RetryPolicy retryPolicy, @Nullable PromotedToLock promotedToLock)
    {
        value = new EphemeralDistributedAtomicValue(client, counterPath, retryPolicy, promotedToLock);
    }
    ...
    @VisibleForTesting
    long bytesToValue(@Nullable byte[] data)
    {
    ...
    private AtomicValue<Long>   worker(final Long addAmount) throws Exception
    {
        ...
        {
            @Override
            public byte[] makeFrom(@Nullable byte[] previous)
            {
