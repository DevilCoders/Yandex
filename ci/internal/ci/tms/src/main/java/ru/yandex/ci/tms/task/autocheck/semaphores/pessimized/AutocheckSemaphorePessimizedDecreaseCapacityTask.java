...
public class AutocheckSemaphorePessimizedDecreaseCapacityTask extends AutocheckSemaphoreCapacityManagerCronTask {
    public AutocheckSemaphorePessimizedDecreaseCapacityTask(
            int maxRetries,
            boolean dryRun,
