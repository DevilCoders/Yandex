...
GENERATE_SCRIPT(
    ...
    OUT ${BINDIR}/bin/ci-storage-tms.sh
    CUSTOM_PROPERTY appName ci-storage-tms
    CUSTOM_PROPERTY mainClass ru.yandex.ci.storage.tms.CiStorageTmsMain
