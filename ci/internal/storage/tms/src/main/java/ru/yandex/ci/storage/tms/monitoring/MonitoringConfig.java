...
public class MonitoringConfig {
    ...
    @Bean
    public HeartbeatCronTask heartbeatCronTask(BazingaTaskManager bazingaTaskManager) {
        return new HeartbeatCronTask(bazingaTaskManager, Duration.ofSeconds(30));
    }
    ...
    public CronTasksFailurePercent cronTasksFailurePercent(
            ...
            @Value("${storage.cronTasksFailurePercent.failureCountToWarn}") int failureCountToWarn
    ) {
