locals {
    ...
    ipv6_addrs = [
        "2a02:6b8:c0e:501:0:f806:0:1588",
        "2a02:6b8:c02:901:0:f806:0:1588",
        "2a02:6b8:c03:501:0:f806:0:1588",
    ]
    ...
    secondary_disk_size = 16

    image_id = "fdveu45jcis2tbr038eg"

    name = "mk8s-master-preprod"
...
resource "ycp_compute_instance" "mk8s-master" {
    ...
    service_account_id  = "bfbcdk2dn956aq9ovr43"
