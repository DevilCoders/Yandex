...
variable "service_account_id" {
  // yc-cloud-trail/sa-trail-exporter
  default = "bfbbp230elbjmlh0tv41"
}
...
variable "ipv6_addresses" {
  ...
  default = ["2a02:6b8:c0e:501:0:f81f:0:121", "2a02:6b8:c02:901:0:f81f:0:121", "2a02:6b8:c03:501:0:f81f:0:121"]
}
...
variable "ipv4_addresses" {
  ...
  // MYT: 172.18.0.*
  // PREPROD IPs start with 120
  default = ["172.16.0.121", "172.17.0.121", "172.18.0.121"]
}
...
variable "system_bucket" {
  description = "intermediate bucket to write trail files before move to user bucket"
  default = "trail-exporter-system"
}

variable "exporter_fetch_limit" {
  description = "Fetch limit for exporter job"
  default = "500"
}
