...
variable "service_account_id" {
  // yc-cloud-trail/sa-trail-preparer
  default = "bfb2mr5qi7lljcmguq6r"
}
...
variable "ipv6_addresses" {
  ...
  default = ["2a02:6b8:c0e:501:0:f81f:0:125", "2a02:6b8:c02:901:0:f81f:0:125", "2a02:6b8:c03:501:0:f81f:0:125"]
}
...
variable "ipv4_addresses" {
  ...
  // MYT: 172.18.0.*
  // PREPROD IPs start with 120
  default = ["172.16.0.125", "172.17.0.125", "172.18.0.125"]
}
...
variable "logbroker_ingest_installation" {
  default = "YC_LOGBROKER_PREPROD"
}

variable "logbroker_ingest_topic" {
  default = "/aoedsmvctptsmbkj4g90/ingest/yc-events-ingest"
}

variable "logbroker_organizationmanager_source_topic" {
  default = "/aoedsmvctptsmbkj4g90/services/yc-organizationmanager"
}

variable "logbroker_storage_source_topic" {
  default = "/aoedsmvctptsmbkj4g90/services/yc-storage"
}

variable "logbroker_lockbox_data_source_topic" {
  default = "/aoedsmvctptsmbkj4g90/services/yc-lockbox-data"
}
...
variable "logbroker_source_max_messages" {
  default = "20"
}
