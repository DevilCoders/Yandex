...
module "api-locallb" {
  ...
  service_id              = "yandex.cloud.lockbox.v1.PayloadService"
...
module "lockbox-dpl-instance-group" {
...
resource "ycp_load_balancer_target_group" "dpl-load-balancer-tg" {
  ...
  dynamic "target" {
    ...
    content {
      address   = element(module.lockbox-dpl-instance-group.all_instance_ipv6_addresses, count.value)
...
resource "ycp_load_balancer_target_group" "dpl-load-balancer-v4-tg" {
  ...
  dynamic "target" {
    ...
    content {
      address   = element(module.lockbox-dpl-instance-group.all_instance_ipv4_addresses, count.value)
      subnet_id = lookup(module.common.subnets, element(module.common.yc_zones, count.value))
    }
  }
