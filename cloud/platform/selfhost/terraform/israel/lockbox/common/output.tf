...
output "cpl-placement-group-id" {
  value = data.terraform_remote_state.bootstrap-resources.outputs.yc-lockbox-cpl-pg-id
}

output "dpl-placement-group-id" {
  value = data.terraform_remote_state.bootstrap-resources.outputs.yc-lockbox-dpl-pg-id
}
