...
module "lockbox-data-plane-instance-group" {
  ...
  name_prefix     = "lockbox-data"
  hostname_prefix = "lockbox-data"
  hostname_suffix = var.hostname_suffix
  role_name       = "lockbox-data"
...
#
#  name    = "data-plane-ipv4-target-group"
#  token    = "${var.yc_token}"
...
module "ipv6-target-group" {
  ...
  name        = "data-plane-ipv6-target-group"
  ycp_profile = var.ycp_profile
  folder      = var.yc_folder
  zone        = var.yc_region
...
module "private-ipv6-load-balancer" {
  ...
  name        = "data-plane-private-ipv6-load-balancer"
  ycp_profile = var.ycp_profile
  folder      = var.yc_folder
  zone        = var.yc_region

  ip_version        = "IPV6"
  ip_address        = "2a0d:d6c0:0:1c::3c7"
  yandex_only       = true
...
module "public-ipv6-load-balancer" {
  ...
  name        = "data-plane-public-ipv6-load-balancer"
  ycp_profile = var.ycp_profile
  folder      = var.yc_folder
  zone        = var.yc_region

  ip_version        = "IPV6"
  ip_address        = "2a0d:d6c0:0:1c::40"
  yandex_only       = true
//  yandex_only       = false
...
module "public-ipv4-load-balancer" {
  ...
  name        = "data-plane-public-ipv4-load-balancer"
  ycp_profile = var.ycp_profile
  folder      = var.yc_folder
  zone        = var.yc_region

  ip_version        = "IPV4"
  ip_address        = "84.201.168.170"
  yandex_only       = false
  port              = var.lb_public_api_port
