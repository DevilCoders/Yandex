...
variable subnets {
  type        = map(string)
  description = "List of subnet_id to zone_id mapping to be used during deployment"
}
...
variable l3_tg {
  type        = bool
  description = "Whether should create LB TG"
  default     = false
}
...
variable platform_id {
  type        = string
  description = "[optional] Compute platform ID. Default: 'standard-v1'"
  default     = "standard-v1"
}
