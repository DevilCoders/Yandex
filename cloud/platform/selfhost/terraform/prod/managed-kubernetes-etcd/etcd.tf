locals {
    ...
    ipv6_addrs = [
        "2a02:6b8:c0e:500:0:f803:0:201",
        "2a02:6b8:c02:900:0:f803:0:201",
        "2a02:6b8:c03:500:0:f803:0:201",
    ]
...
resource "ycp_compute_instance" "mk8s-etcd" {
    ...
    service_account_id  = "ajefp2o8vi7rbqnof6eb"
...
//        configs              = element(data.template_file.etcd_configs.*.rendered, count.index)
//        infra-configs        = module.infrastructure-pod.infra-pod-configs
//        podmanifest          = element(data.template_file.etcd_pod_manifest.*.rendered, count.index)
