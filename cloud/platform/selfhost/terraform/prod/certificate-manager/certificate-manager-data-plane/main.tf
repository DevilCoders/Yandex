...
locals {
  ...
  "dpl-${lookup(module.common.yc_zone_suffix, element(module.common.yc_zones, count))}-${floor(count / length(module.common.yc_zones)) + count % length(module.common.yc_zones) - index(module.common.yc_zones, element(module.common.yc_zones, count)) + 1}.${module.common.hostname_suffix}"
  ]
...
module "ipv6-target-group" {
  ...
  tg_name_prefix    = "data-plane-ipv6"
...
module "ipv4-target-group" {
  ...
  tg_name_prefix    = "data-plane-ipv4"
...
module "public-ipv4-load-balancer" {
  ...
  lb_name_prefix  = "public-data-plane"
  ip_version      = "IPV4"
...
module "ipv6-load-balancer" {
  ...
  lb_name_prefix  = "yandex-only-data-plane"
  ip_version      = "IPV6"
