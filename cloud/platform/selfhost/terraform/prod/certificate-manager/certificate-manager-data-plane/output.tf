...
output "certificate_manager_data_plane_ipv4_target_group_id" {
  value = "${module.ipv4-target-group.id}"
}

output "certificate_manager_data_plane_ipv6_target_group_id" {
...
output "certificate_manager_data_plane_public_ipv4_load_balancer_spec" {
  value = "${module.public-ipv4-load-balancer.spec}"
}

output "certificate_manager_data_plane_public_ipv6_load_balancer_id" {
  value = "${module.public-ipv6-load-balancer.id}"
}

output "certificate_manager_data_plane_public_ipv6_load_balancer_spec" {
