...
data "template_file" "mk8s-master-infra-configs" {
...
data "template_file" "mk8s-master-infra-pod-spec" {
  template = "${file("${path.module}/files/infra-pod-mk8s-master-spec.yaml.tpl")}"
