{
  "/etc/api/envoy/techpark-envoy.yaml": {
    "content": ${jsonencode(techpark_envoy_config)}
  },
  ...
  "/etc/api/envoy/ssl/certs/techpark-api-gateway.crt": {
    "content": ${jsonencode(techpark_envoy_cert)}
  },
  "/etc/api/envoy/ssl/private/techpark-api-gateway.key": {
    "content": ${jsonencode(techpark_envoy_key)}
  },
