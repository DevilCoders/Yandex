...
if [[ "$UPSTREAM" == "true" ]]; then
    ...
    UPSTREAM_FILTER="grep \"\\\"authority\\\":\\\"serverless-triggers.private-api.ycp.\" | "
fi
...
$(dirname "$0")/yctriggers-cpl.sh "${CAT} | ${UPSTREAM_FILTER}${COMMAND} | ${HOSTNAME_TO_LOG}" | eval $(jq_sort_by_timestamp)
