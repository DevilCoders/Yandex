...
object DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLabNoAgentBuilds_EternalAcceptanceTest64GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1846"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLabNoAgentBuilds_EternalAcceptanceTest32GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
