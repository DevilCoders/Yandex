...
object DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLabNoAgentBuilds_EternalAcceptanceTest32GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1824"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLabNoAgentBuilds_EternalAcceptanceTest16GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
