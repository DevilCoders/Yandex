...
object Nfs_LocalTests_Trunk_FunctionalTestsGatewayNoAgentBuilds_FunctionalTestsReleaseThreadSanitizer : BuildType({
    ...
    params {
        ...
        param("sandbox.config_path", "%configs_dir%/runner/nfs/local_tests/%branch_name%/functional_tests_gateway/thread_sanitizer.yaml")
    }
