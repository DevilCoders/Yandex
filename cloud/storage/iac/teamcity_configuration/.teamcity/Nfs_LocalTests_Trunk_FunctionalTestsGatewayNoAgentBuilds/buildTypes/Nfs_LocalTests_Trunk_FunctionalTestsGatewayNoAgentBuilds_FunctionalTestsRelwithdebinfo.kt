...
object Nfs_LocalTests_Trunk_FunctionalTestsGatewayNoAgentBuilds_FunctionalTestsRelwithdebinfo : BuildType({
    ...
    params {
        ...
        param("sandbox.config_path", "%configs_dir%/runner/nfs/local_tests/%branch_name%/functional_tests_gateway/relwithdebinfo.yaml")
    }
