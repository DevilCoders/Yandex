...
object DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLab_EternalAcceptanceTest2GiB : BuildType({
    ...
    triggers {
        schedule {
            ...
            param("revisionRuleDependsOn", "CloudNbsTeam_DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLab_EternalAcceptanceTest8TiB")
        }
        finishBuildTrigger {
            id = "TRIGGER_1851"
            enabled = false
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_HwNbsStableLab_EternalAcceptanceTest8TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
