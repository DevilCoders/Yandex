...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest4TiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1849"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest2TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
