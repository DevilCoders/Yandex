...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest16GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1815"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest8GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
