...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest8TiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1850"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest4TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
