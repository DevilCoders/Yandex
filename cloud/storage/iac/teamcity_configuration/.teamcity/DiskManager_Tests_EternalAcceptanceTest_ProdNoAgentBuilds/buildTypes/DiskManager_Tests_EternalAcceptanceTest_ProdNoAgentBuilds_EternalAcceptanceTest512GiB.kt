...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest512GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1839"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest256GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
