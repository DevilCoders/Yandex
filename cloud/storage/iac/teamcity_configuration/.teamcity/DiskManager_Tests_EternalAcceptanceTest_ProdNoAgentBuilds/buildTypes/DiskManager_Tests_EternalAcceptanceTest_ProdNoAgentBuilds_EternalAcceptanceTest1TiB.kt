...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest1TiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1848"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest512GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
