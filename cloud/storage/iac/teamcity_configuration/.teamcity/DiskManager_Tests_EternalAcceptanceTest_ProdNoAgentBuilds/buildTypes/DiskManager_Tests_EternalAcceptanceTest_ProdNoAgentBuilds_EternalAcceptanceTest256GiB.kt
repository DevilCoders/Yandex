...
object DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest256GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1838"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_ProdNoAgentBuilds_EternalAcceptanceTest128GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
