...
object Nbs_LocalTests_Stable222_LocalLoadTestsNoAgentBuilds_LocalLoadTestsReleaseThreadSanitizer : BuildType({
    templates(_Self.buildTypes.Nbs_YcNbsCiRunYaMakeAgentless)
    name = "Local Load Tests (release, thread sanitizer)"

    params {
        param("sandbox.config_path", "%configs_dir%/runner/nbs/local_tests/%branch_name%/load_tests/thread_sanitizer.yaml")
    }
