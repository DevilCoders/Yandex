...
object DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestBig : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1831"
            buildType = "${DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestMedium.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
