package DiskManager_Tests_AcceptanceTests_Preprod.buildTypes
...
object DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestEnormous : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1841"
            buildType = "${DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestBig.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
