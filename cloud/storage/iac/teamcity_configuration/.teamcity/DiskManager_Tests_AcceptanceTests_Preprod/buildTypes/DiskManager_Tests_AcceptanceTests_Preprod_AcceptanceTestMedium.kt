...
object DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestMedium : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1832"
            buildType = "${DiskManager_Tests_AcceptanceTests_Preprod_AcceptanceTestSmall.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
