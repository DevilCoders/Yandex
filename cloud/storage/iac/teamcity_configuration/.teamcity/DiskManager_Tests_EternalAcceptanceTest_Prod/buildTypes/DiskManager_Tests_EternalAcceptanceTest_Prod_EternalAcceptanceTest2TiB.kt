...
object DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest2TiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1847"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest1TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
