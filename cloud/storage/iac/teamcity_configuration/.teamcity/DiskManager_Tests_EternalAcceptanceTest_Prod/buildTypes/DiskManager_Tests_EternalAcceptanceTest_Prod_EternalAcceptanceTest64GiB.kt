...
object DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest64GiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1846"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest32GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
