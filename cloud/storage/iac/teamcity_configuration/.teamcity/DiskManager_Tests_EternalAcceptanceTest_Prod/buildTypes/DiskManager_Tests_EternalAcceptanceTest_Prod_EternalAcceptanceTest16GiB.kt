...
object DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest16GiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1815"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest8GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
