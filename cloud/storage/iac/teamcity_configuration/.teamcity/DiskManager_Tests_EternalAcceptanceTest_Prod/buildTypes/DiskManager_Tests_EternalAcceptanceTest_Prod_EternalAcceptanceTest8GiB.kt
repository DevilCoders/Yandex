...
object DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest8GiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1796"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Prod_EternalAcceptanceTest4GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
