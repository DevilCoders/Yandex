...
object DiskManager_Tests_AcceptanceTests_PreprodNoAgentBuilds_AcceptanceTestMedium : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1829"
            buildType = "${DiskManager_Tests_AcceptanceTests_PreprodNoAgentBuilds_AcceptanceTestSmall.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
