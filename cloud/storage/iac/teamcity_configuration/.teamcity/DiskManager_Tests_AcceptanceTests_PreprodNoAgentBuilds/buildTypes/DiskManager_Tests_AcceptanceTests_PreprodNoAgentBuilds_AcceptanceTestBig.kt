...
object DiskManager_Tests_AcceptanceTests_PreprodNoAgentBuilds_AcceptanceTestBig : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1828"
            buildType = "${DiskManager_Tests_AcceptanceTests_PreprodNoAgentBuilds_AcceptanceTestMedium.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
