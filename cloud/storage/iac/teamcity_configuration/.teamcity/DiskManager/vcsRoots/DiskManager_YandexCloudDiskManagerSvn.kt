...
object DiskManager_YandexCloudDiskManagerSvn : SvnVcsRoot({
    name = "Yandex Cloud Disk Manager SVN"
    url = "svn+ssh://arcadia.yandex.ru/arc/%env.branch_path%/arcadia/cloud/disk_manager"
