...
object Nbs_LocalTests_Stable222_FunctionalTestsNoAgentBuilds_FunctionalTestsReleaseMemorySanitizer : BuildType({
    templates(_Self.buildTypes.Nbs_YcNbsCiRunYaMakeAgentless)
    name = "Functional Tests (release, memory sanitizer)"

    params {
        param("sandbox.config_path", "%configs_dir%/runner/nbs/local_tests/%branch_name%/functional_tests/memory_sanitizer.yaml")
    }
