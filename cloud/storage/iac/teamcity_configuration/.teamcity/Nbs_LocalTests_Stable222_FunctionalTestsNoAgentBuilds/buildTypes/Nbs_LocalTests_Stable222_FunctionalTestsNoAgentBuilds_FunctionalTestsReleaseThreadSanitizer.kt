...
object Nbs_LocalTests_Stable222_FunctionalTestsNoAgentBuilds_FunctionalTestsReleaseThreadSanitizer : BuildType({
    templates(_Self.buildTypes.Nbs_YcNbsCiRunYaMakeAgentless)
    name = "Functional Tests (release, thread sanitizer)"

    params {
        param("sandbox.config_path", "%configs_dir%/runner/nbs/local_tests/%branch_name%/functional_tests/thread_sanitizer.yaml")
    }
