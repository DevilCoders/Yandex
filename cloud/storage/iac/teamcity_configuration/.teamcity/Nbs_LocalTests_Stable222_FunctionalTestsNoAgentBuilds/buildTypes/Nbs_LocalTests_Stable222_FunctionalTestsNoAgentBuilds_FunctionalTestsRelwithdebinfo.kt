...
object Nbs_LocalTests_Stable222_FunctionalTestsNoAgentBuilds_FunctionalTestsRelwithdebinfo : BuildType({
    templates(_Self.buildTypes.Nbs_YcNbsCiRunYaMakeAgentless)
    name = "Functional Tests (relwithdebinfo)"

    params {
        param("sandbox.config_path", "%configs_dir%/runner/nbs/local_tests/%branch_name%/functional_tests/relwithdebinfo.yaml")
    }
