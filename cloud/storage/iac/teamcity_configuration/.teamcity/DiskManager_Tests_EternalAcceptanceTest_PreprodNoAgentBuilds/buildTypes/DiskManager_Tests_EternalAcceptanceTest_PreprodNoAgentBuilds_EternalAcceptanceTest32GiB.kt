...
object DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest32GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1824"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest16GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
