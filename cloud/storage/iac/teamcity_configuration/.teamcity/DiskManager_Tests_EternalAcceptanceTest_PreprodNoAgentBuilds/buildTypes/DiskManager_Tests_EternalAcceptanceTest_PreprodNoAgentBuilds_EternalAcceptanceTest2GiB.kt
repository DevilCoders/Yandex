...
object DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest2GiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1851"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest8TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
