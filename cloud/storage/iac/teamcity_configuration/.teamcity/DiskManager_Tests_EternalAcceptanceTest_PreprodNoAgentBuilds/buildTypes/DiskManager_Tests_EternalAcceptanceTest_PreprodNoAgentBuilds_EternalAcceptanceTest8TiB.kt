...
object DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest8TiB : BuildType({
    ...
    triggers {
        finishBuildTrigger {
            id = "TRIGGER_1850"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_PreprodNoAgentBuilds_EternalAcceptanceTest4TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
