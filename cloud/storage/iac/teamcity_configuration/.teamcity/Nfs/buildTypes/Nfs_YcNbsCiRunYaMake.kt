...
object Nfs_YcNbsCiRunYaMake : Template({
    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                if [[ ${'$'}CONTAINER_RESOURCE ]]; then
                    ARGS="${'$'}ARGS --container-resource ${'$'}CONTAINER_RESOURCE"
                fi
    ...
    requirements {
        ...
        doesNotMatch("teamcity.agent.name", "cm-build-agent-.*", "RQ_5199")
    }
})
