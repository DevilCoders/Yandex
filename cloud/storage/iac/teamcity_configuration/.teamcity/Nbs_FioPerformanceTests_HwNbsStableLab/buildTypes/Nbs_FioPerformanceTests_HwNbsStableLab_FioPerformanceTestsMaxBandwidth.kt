...
object Nbs_FioPerformanceTests_HwNbsStableLab_FioPerformanceTestsMaxBandwidth : BuildType({
    templates(Nbs.buildTypes.Nbs_YcNbsCiFioPerformanceTestSuite)
    name = "Fio Performance Tests (max bandwidth)"
    paused = true

    params {
        param("env.TEST_SUITE", "max_bandwidth")
    }
    ...
    steps {
        script {
            ...
            dockerRunParameters = """--rm --add-host="local-lb.cloud-lab.yandex.net:2a02:6b8:bf00:1300:9a03:9bff:feaa:b659" --network host --privileged=true --cap-add net_raw --cap-add net_admin"""
        }
    }
