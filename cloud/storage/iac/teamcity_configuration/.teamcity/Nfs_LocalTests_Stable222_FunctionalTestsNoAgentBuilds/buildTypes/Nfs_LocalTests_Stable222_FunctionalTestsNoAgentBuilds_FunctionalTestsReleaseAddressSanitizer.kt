...
object Nfs_LocalTests_Stable222_FunctionalTestsNoAgentBuilds_FunctionalTestsReleaseAddressSanitizer : BuildType({
    ...
    params {
        ...
        param("sandbox.config_path", "%configs_dir%/runner/nfs/local_tests/%branch_name%/functional_tests/address_sanitizer.yaml")
    }
