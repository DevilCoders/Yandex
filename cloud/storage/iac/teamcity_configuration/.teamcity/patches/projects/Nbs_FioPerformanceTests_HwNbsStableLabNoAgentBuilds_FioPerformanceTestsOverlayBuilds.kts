...
To apply the patch, create a project with id = 'Nbs_FioPerformanceTests_HwNbsStableLabNoAgentBuilds_FioPerformanceTestsOverlayBuilds'
in the project with id = 'Nbs_FioPerformanceTests_HwNbsStableLabNoAgentBuilds', and delete the patch script.
*/
create(RelativeId("Nbs_FioPerformanceTests_HwNbsStableLabNoAgentBuilds"), Project({
    id("Nbs_FioPerformanceTests_HwNbsStableLabNoAgentBuilds_FioPerformanceTestsOverlayBuilds")
