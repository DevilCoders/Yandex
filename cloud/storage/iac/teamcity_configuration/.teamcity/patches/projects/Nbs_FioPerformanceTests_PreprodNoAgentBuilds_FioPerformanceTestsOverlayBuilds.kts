...
To apply the patch, create a project with id = 'Nbs_FioPerformanceTests_PreprodNoAgentBuilds_FioPerformanceTestsOverlayBuilds'
in the project with id = 'Nbs_FioPerformanceTests_PreprodNoAgentBuilds', and delete the patch script.
*/
create(RelativeId("Nbs_FioPerformanceTests_PreprodNoAgentBuilds"), Project({
    id("Nbs_FioPerformanceTests_PreprodNoAgentBuilds_FioPerformanceTestsOverlayBuilds")
