...
To apply the patch, create a buildType with id = 'Nbs_FioPerformanceTests_PreprodNoAgentBuilds_FioPerformanceTestsMaxIops'
...
create(RelativeId("Nbs_FioPerformanceTests_PreprodNoAgentBuilds"), BuildType({
    ...
    id("Nbs_FioPerformanceTests_PreprodNoAgentBuilds_FioPerformanceTestsMaxIops")
