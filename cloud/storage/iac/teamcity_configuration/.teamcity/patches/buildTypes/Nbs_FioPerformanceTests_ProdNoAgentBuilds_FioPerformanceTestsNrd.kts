...
To apply the patch, create a buildType with id = 'Nbs_FioPerformanceTests_ProdNoAgentBuilds_FioPerformanceTestsNrd'
...
create(RelativeId("Nbs_FioPerformanceTests_ProdNoAgentBuilds"), BuildType({
    ...
    id("Nbs_FioPerformanceTests_ProdNoAgentBuilds_FioPerformanceTestsNrd")
