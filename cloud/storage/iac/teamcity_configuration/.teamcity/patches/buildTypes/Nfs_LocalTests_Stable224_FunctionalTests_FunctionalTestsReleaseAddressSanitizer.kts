...
To apply the patch, create a buildType with id = 'Nfs_LocalTests_Stable224_FunctionalTests_FunctionalTestsReleaseAddressSanitizer'
...
create(RelativeId("Nfs_LocalTests_Stable224_FunctionalTests"), BuildType({
    ...
    id("Nfs_LocalTests_Stable224_FunctionalTests_FunctionalTestsReleaseAddressSanitizer")
