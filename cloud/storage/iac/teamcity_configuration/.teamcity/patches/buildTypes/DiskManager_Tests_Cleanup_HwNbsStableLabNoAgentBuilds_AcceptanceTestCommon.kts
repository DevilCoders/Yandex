...
To apply the patch, create a buildType with id = 'DiskManager_Tests_Cleanup_HwNbsStableLabNoAgentBuilds_AcceptanceTestCommon'
...
create(RelativeId("DiskManager_Tests_Cleanup_HwNbsStableLabNoAgentBuilds"), BuildType({
    ...
    id("DiskManager_Tests_Cleanup_HwNbsStableLabNoAgentBuilds_AcceptanceTestCommon")
