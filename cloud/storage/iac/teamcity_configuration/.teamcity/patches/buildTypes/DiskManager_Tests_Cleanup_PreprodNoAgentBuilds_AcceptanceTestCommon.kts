...
To apply the patch, create a buildType with id = 'DiskManager_Tests_Cleanup_PreprodNoAgentBuilds_AcceptanceTestCommon'
...
create(RelativeId("DiskManager_Tests_Cleanup_PreprodNoAgentBuilds"), BuildType({
    ...
    id("DiskManager_Tests_Cleanup_PreprodNoAgentBuilds_AcceptanceTestCommon")
