...
To apply the patch, create a buildType with id = 'Nbs_LocalTests_Stable224_LocalLoadTests_LocalLoadTestsReleaseAddressSanitizer'
...
create(RelativeId("Nbs_LocalTests_Stable224_LocalLoadTests"), BuildType({
    ...
    id("Nbs_LocalTests_Stable224_LocalLoadTests_LocalLoadTestsReleaseAddressSanitizer")
