...
object Nfs_LocalTests_Trunk_LoadTestsNoAgentBuilds_LoadTestsReleaseUbSanitizer : BuildType({
    ...
    params {
        ...
        param("sandbox.config_path", "%configs_dir%/runner/nfs/local_tests/%branch_name%/load_tests/ub_sanitizer.yaml")
    }
