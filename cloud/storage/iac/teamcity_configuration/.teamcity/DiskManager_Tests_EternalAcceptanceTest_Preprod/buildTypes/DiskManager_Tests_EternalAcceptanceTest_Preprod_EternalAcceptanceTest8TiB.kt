...
object DiskManager_Tests_EternalAcceptanceTest_Preprod_EternalAcceptanceTest8TiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1850"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Preprod_EternalAcceptanceTest4TiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
