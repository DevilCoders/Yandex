...
object DiskManager_Tests_EternalAcceptanceTest_Preprod_EternalAcceptanceTest512GiB : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1839"
            buildType = "${DiskManager_Tests_EternalAcceptanceTest_Preprod_EternalAcceptanceTest256GiB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
