...
object Nbs_Cleanup_YcCleanup : Template({
    name = "yc-cleanup"

    maxRunningBuilds = 1

    params {
        param("env.IMAGE_TTL_DAYS", "1")
        param("env.INSTANCE_REGEX", "")
        param("env.INSTANCE_TTL_DAYS", "1")
        param("env.DISK_REGEX", "")
        param("env.DISK_TTL_DAYS", "1")
        param("env.CLUSTER", "")
        param("env.SNAPSHOT_TTL_DAYS", "1")
        param("env.IMAGE_REGEX", "")
        param("env.SNAPSHOT_REGEX", "")
    }
