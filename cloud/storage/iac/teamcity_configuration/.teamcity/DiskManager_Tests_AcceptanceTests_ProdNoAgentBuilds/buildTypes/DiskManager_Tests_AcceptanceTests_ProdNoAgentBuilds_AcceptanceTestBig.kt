...
object DiskManager_Tests_AcceptanceTests_ProdNoAgentBuilds_AcceptanceTestBig : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1828"
            buildType = "${DiskManager_Tests_AcceptanceTests_ProdNoAgentBuilds_AcceptanceTestMedium.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
