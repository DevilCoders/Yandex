...
object DiskManager_Tests_AcceptanceTests_ProdNoAgentBuilds_AcceptanceTestEnormous : BuildType({
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_1840"
            buildType = "${DiskManager_Tests_AcceptanceTests_ProdNoAgentBuilds_AcceptanceTestBig.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
