...
_r.children = ['global-vrouter-config', 'physical-router', 'virtual-router', 'config-node', 'analytics-node', 'database-node', 'service-appliance-set']
_r.parent = 'config-root'
_r.refs = ['bgp-router']
_r.back_refs = []
_r.properties = [
...
_r.parent = 'project'
_r.refs = ['service-instance', 'virtual-machine-interface', 'service-appliance-set', 'loadbalancer-healthmonitor']
...
_r.children = ['loadbalancer-pool', 'loadbalancer-healthmonitor', 'virtual-ip', 'security-group', 'virtual-network', 'qos-queue', 'qos-forwarding-class', 'network-ipam', 'network-policy', 'virtual-machine-interface', 'service-instance', 'route-table', 'interface-route-table', 'logical-router']
_r.parent = 'domain'
...
_r.children = []
_r.parent = 'project'
_r.refs = ['qos-forwarding-class', 'security-group', 'virtual-machine-interface', 'virtual-machine', 'virtual-network', 'routing-instance', 'interface-route-table']
_r.back_refs = ['loadbalancer-pool', 'virtual-ip', 'virtual-machine-interface', 'instance-ip', 'subnet', 'floating-ip', 'logical-interface', 'customer-attachment', 'logical-router']
_r.properties = [
