...
_r.properties = [
    ...
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
]
_r = schema._get_or_add_resource('alarm')
_r.children = []
_r.parent = 'project'
_r.refs = []
_r.back_refs = []
_r.properties = [
    ResourceProperty('uve-keys', is_list=False, is_map=False),
    ResourceProperty('alarm-severity', is_list=False, is_map=False),
    ResourceProperty('alarm-rules', is_list=True, is_map=False),
]
_r = schema._get_or_add_resource('alias-ip')
_r.children = []
_r.parent = 'alias-ip-pool'
_r.refs = ['project', 'virtual-machine-interface']
_r.back_refs = []
_r.properties = [
    ResourceProperty('alias-ip-address', is_list=False, is_map=False),
    ResourceProperty('alias-ip-address-family', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
]
_r = schema._get_or_add_resource('alias-ip-pool')
_r.children = ['alias-ip']
_r.parent = 'virtual-network'
_r.refs = []
...
_r.properties = [
    ...
    ResourceProperty('bgpaas-ipv4-mapped-ipv6-nexthop', is_list=False, is_map=False),
    ResourceProperty('bgpaas-suppress-route-advertisement', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
...
_r.properties = [
    ...
    ResourceProperty('floating-ip-port-mappings-enable', is_list=False, is_map=False),
    ResourceProperty('floating-ip-port-mappings', is_list=True, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
...
_r = schema._get_or_add_resource('forwarding-class')
_r.children = []
_r.parent = 'global-qos-config'
_r.refs = ['qos-queue']
_r.back_refs = []
_r.properties = [
    ResourceProperty('forwarding-class-id', is_list=False, is_map=False),
    ResourceProperty('forwarding-class-dscp', is_list=False, is_map=False),
    ResourceProperty('forwarding-class-vlan-priority', is_list=False, is_map=False),
    ResourceProperty('forwarding-class-mpls-exp', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
]
_r = schema._get_or_add_resource('global-qos-config')
_r.children = ['qos-config', 'forwarding-class', 'qos-queue']
_r.parent = 'global-system-config'
_r.refs = []
_r.back_refs = []
_r.properties = [
...
_r.children = ['global-vrouter-config', 'global-qos-config', 'physical-router', 'virtual-router', 'config-node', 'analytics-node', 'database-node', 'service-appliance-set', 'api-access-list', 'alarm']
_r.parent = 'config-root'
_r.refs = ['bgp-router']
_r.back_refs = ['qos-config']
_r.properties = [
    ResourceProperty('user-defined-log-statistics', is_list=False, is_map=True),
    ResourceProperty('autonomous-system', is_list=False, is_map=False),
    ResourceProperty('config-version', is_list=False, is_map=False),
    ResourceProperty('graceful-restart-parameters', is_list=False, is_map=False),
    ...
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
    ResourceProperty('alarm-enable', is_list=False, is_map=False),
]
...
_r.properties = [
    ...
    ResourceProperty('instance-ip-local-ip', is_list=False, is_map=False),
    ResourceProperty('service-instance-ip', is_list=False, is_map=False),
    ResourceProperty('service-health-check-ip', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
...
_r.children = []
_r.parent = 'project'
_r.refs = ['service-appliance-set', 'service-instance', 'virtual-machine-interface']
...
_r.children = []
_r.parent = 'project'
_r.refs = ['virtual-machine-interface', 'route-target', 'route-table', 'virtual-network', 'service-instance']
_r.back_refs = []
_r.properties = [
...
_r.properties = [
    ...
    ResourceProperty('ipam-subnets', is_list=True, is_map=False),
    ResourceProperty('ipam-subnet-method', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
...
_r.children = ['loadbalancer-pool', 'loadbalancer-healthmonitor', 'virtual-ip', 'loadbalancer-listener', 'loadbalancer', 'security-group', 'virtual-network', 'qos-config', 'network-ipam', 'network-policy', 'virtual-machine-interface', 'bgp-as-a-service', 'routing-policy', 'route-aggregate', 'service-instance', 'service-health-check', 'route-table', 'interface-route-table', 'logical-router', 'api-access-list', 'alarm']
_r.parent = 'domain'
_r.refs = ['namespace', 'floating-ip-pool', 'alias-ip-pool']
_r.back_refs = ['floating-ip', 'alias-ip']
_r.properties = [
...
_r = schema._get_or_add_resource('qos-config')
_r.children = []
_r.parent = 'project'
_r.refs = ['global-system-config']
_r.back_refs = ['virtual-network', 'virtual-machine-interface']
_r.properties = [
    ResourceProperty('qos-config-type', is_list=False, is_map=False),
    ResourceProperty('dscp-entries', is_list=False, is_map=True),
    ResourceProperty('vlan-priority-entries', is_list=False, is_map=True),
    ResourceProperty('mpls-exp-entries', is_list=False, is_map=True),
    ResourceProperty('default-forwarding-class-id', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
...
_r.parent = 'project'
_r.refs = []
_r.back_refs = ['virtual-network', 'logical-router']
_r.properties = [
...
_r.parent = 'global-system-config'
_r.refs = []
_r.back_refs = ['loadbalancer-pool', 'loadbalancer', 'service-template']
_r.properties = [
...
_r.children = []
_r.parent = 'project'
_r.refs = ['qos-config', 'security-group', 'virtual-machine-interface', 'virtual-machine', 'virtual-network', 'routing-instance', 'port-tuple', 'service-health-check', 'interface-route-table', 'physical-interface']
_r.back_refs = ['loadbalancer-pool', 'virtual-ip', 'loadbalancer', 'virtual-machine-interface', 'instance-ip', 'subnet', 'floating-ip', 'alias-ip', 'logical-interface', 'bgp-as-a-service', 'customer-attachment', 'logical-router']
_r.properties = [
...
_r.children = ['access-control-list', 'floating-ip-pool', 'alias-ip-pool', 'routing-instance']
_r.parent = 'project'
_r.refs = ['qos-config', 'network-ipam', 'network-policy', 'route-table']
...
_r.properties = [
    ...
    ResourceProperty('port-security-enabled', is_list=False, is_map=False),
    ...
    ResourceProperty('address-allocation-mode', is_list=False, is_map=False),
    ResourceProperty('id-perms', is_list=False, is_map=False),
    ResourceProperty('perms2', is_list=False, is_map=False),
    ResourceProperty('annotations', is_list=False, is_map=True),
    ResourceProperty('display-name', is_list=False, is_map=False),
