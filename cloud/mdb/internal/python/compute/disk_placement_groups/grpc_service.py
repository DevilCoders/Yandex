...
from .errors import DuplicateDiskPlacementGroupNameError


class DiskPlacementGroupsGRPCService(ComputeGRPCService):
    def specific_errors(self, rich_details: status_pb2.Status) -> exceptions.GRPCError:
        for detail in rich_details:
            ...
            if detail.Is(error_pb2.ErrorDetails.DESCRIPTOR):
                ...
                if error.type == DuplicateDiskPlacementGroupNameError.compute_type:
                    return DuplicateDiskPlacementGroupNameError(
