...
from yandex.cloud.priv.iam.v1 import operation_service_pb2, operation_service_pb2_grpc
...
class OperationsClient:
    ...
    def _operation_service(self):
        if self.__operation_service is None:
            ...
            self.__operation_service = WrappedGRPCService(
                self.logger,
                channel,
    ...
    @client_retry
    @tracing.trace('IAM Operations Get')
