...
const (
	ElasticSearchAllowUnlimitedHostsFeatureFlag string = "MDB_ELASTICSEARCH_ALLOW_UNLIMITED_HOSTS"
)
...
type OptionalEdition struct {
	Value Edition
	Valid bool
}

func NewOptionalEdition(v Edition) OptionalEdition {
	return OptionalEdition{Value: v, Valid: true}
}

func (o *OptionalEdition) Set(v Edition) {
	o.Value = v
	o.Valid = true
}

func (o *OptionalEdition) Get() (Edition, error) {
	if !o.Valid {
		return EditionUnknown, optional.ErrMissing
	}
	return o.Value, nil
}

func (o *OptionalEdition) GetDefault(def Edition) Edition {
	if !o.Valid {
		return def
	}
	return o.Value
...
type ElasticsearchSpecUpdate struct {
	MasterNode OptionalMasterNodeSpec
...
type ConfigSpecUpdate struct {
	Version       OptionalVersion
	Edition       OptionalEdition
	Elasticsearch ElasticsearchSpecUpdate
	AdminPassword OptionalSecretString
	Access        OptionalAccess
}
