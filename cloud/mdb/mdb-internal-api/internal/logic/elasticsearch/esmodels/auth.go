...
func (t AuthProviderType) AllowedForEdition(e Edition) bool {
	switch t {
	case AuthProviderTypeNative, AuthProviderTypeAnonymous:
		return e.Includes(EditionBasic)
	case AuthProviderTypeSaml, AuthProviderTypeOpenID:
		return e.Includes(EditionPlatinum)
	}
	return false
}
