...
//go:generate ../../../../scripts/mockgen.sh ElasticSearch

type ElasticSearch interface {
	Cluster(ctx context.Context, cid string) (esmodels.Cluster, error)
	Clusters(ctx context.Context, folderExtID string, limit, offset int64) ([]esmodels.Cluster, error)
	...
	AddHosts(ctx context.Context, cid string, args []esmodels.Host) (operations.Operation, error)
	DeleteHosts(ctx context.Context, cid string, fqdns []string) (operations.Operation, error)

	User(ctx context.Context, cid, name string) (esmodels.User, error)
	Users(ctx context.Context, cid string, limit, offset int64) ([]esmodels.User, error)
	CreateUser(ctx context.Context, cid string, spec esmodels.UserSpec) (operations.Operation, error)
	UpdateUser(ctx context.Context, spec UpdateUserArgs) (operations.Operation, error)
	...
	AllowedEditions(ctx context.Context) ([]esmodels.Edition, error)
	SupportedVersions(ctx context.Context) esmodels.SupportedVersions

	AuthProvider(ctx context.Context, cid string, name string) (*esmodels.AuthProvider, error)
	AuthProviders(ctx context.Context, cid string) (*esmodels.AuthProviders, error)
	AddAuthProviders(ctx context.Context, cid string, providers ...*esmodels.AuthProvider) (operations.Operation, error)
	UpdateAuthProviders(ctx context.Context, cid string, providers ...*esmodels.AuthProvider) (operations.Operation, error)
	DeleteAuthProviders(ctx context.Context, cid string, names ...string) (operations.Operation, error)
	UpdateAuthProvider(ctx context.Context, cid string, name string, provider *esmodels.AuthProvider) (operations.Operation, error)
	...
	Extension(ctx context.Context, cid string, extensionID string) (esmodels.Extension, error)
	Extensions(ctx context.Context, cid string) ([]esmodels.Extension, error)
...
type CreateClusterArgs struct {
	...
	HostSpec           []esmodels.Host
	ConfigSpec         esmodels.ClusterConfigSpec
	UserSpecs          []esmodels.UserSpec
	ExtensionSpecs     []esmodels.ExtensionSpec
...
type ModifyClusterArgs struct {
	...
	ConfigSpec         esmodels.ConfigSpecUpdate
