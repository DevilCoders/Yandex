...
import (
	...
	perfdiagdbmock "a.yandex-team.ru/cloud/mdb/mdb-internal-api/internal/logic/postgresql/perfdiagdb/mocks"
...
type SessionsStatsOutputs struct {
	SessionsStats []pgmodels.SessionsStats
	More          bool
	Err           error
}

func (f sessionsStatsFixture) ExpectSessionsStats(ctx context.Context, cid string, limit int64, opts pgmodels.GetSessionsStatsOptions, outputs SessionsStatsOutputs) {
...
func TestSessionsStats_Defaults(t *testing.T) {
	...
	limit := int64(42)
	opts := pgmodels.GetSessionsStatsOptions{}
	...
	msg, more, err := f.PerfDiag.GetSessionsStats(ctx, cid, limit, pgmodels.GetSessionsStatsOptions{})
