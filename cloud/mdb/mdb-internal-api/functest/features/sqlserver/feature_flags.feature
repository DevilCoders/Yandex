@sqlserver
@grpc_api
Feature: Create Microsoft SQLServer Cluster with feature flags
  Background:
  ...
  Scenario: Cluster creation and delete works with cloud's feature flag
    When we add cloud "cloud2"
    And we add folder "folder2" to cloud "cloud2"
    And we add feature flag "MDB_SQLSERVER_CLUSTER" for cloud "cloud2"
    Then we "Create" via gRPC at "yandex.cloud.priv.mdb.sqlserver.v1.ClusterService" with data
    """
    {
      "folderId": "folder2",
      "environment": "PRESTABLE",
