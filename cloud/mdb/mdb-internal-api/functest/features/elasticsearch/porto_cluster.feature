@elasticsearch
@grpc_api
Feature: ElasticSearch basic operations (porto)
  ...
  Scenario: Cluster listing works
    ...
    And we "List" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
        "folder_id": "folder1",
        "page_size": 100
  ...
  Scenario: Adding host works
    When we "AddHosts" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
        "host_specs": [{
            "type": "DATA_NODE",
    ...
    {
        "created_by": "user",
        "description": "Add datanode host to ElasticSearch cluster",
        "done": false,
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.elasticsearch.v1.AddClusterHostsMetadata",
            "cluster_id": "cid1",
  ...
  Scenario: Deleting host works
    When we "DeleteHosts" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
    ...
    {
        "created_by": "user",
        "description": "Delete datanode host from ElasticSearch cluster",
        "done": false,
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.elasticsearch.v1.DeleteClusterHostsMetadata",
            "cluster_id": "cid1",
            "host_names": ["man-1.db.yandex.net"]
        }
    }
  ...
  Scenario Outline: Deleting host with invalid params fails
    ...
    """
    And "worker_task_id2" acquired and finished by worker
    And we "DeleteHosts" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid2",
        "host_names": <hosts>
  ...
  Scenario: Create cluster with not allowed edition fails
    When we "Create" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
        "folder_id": "folder1",
    ...
    """
    Then we get gRPC response error with code FAILED_PRECONDITION and message "edition not allowed"
