@elasticsearch
@grpc_api
Feature: Maintenance Window for Elasticsearch
  ...
  Scenario: Schedule and reschedule a maintenance task on a cluster without specified maintenance window
    ...
    WITH locked_cluster AS (
        ...
        SELECT code.plan_maintenance_task(
            ...
            i_cid            => 'cid1',
            i_config_id      => 'elasticsearch_test_config',
            i_folder_id      => folder_id,
            i_operation_type => 'elasticsearch_cluster_modify',
            i_task_type      => 'elasticsearch_cluster_modify',
            i_task_args      => '{}',
            i_version        => 2,
            i_metadata       => '{}',
            ...
            i_info           => 'Elasticsearch test maintenance'
        ), actual_rev, next_rev
        FROM locked_cluster
    )
    ...
    """
    {
        ...
        "planned_operation": {
            ...
            "info": "Elasticsearch test maintenance"
        }
    }
    """
    And we "RescheduleMaintenance" via gRPC at "yandex.cloud.priv.mdb.elasticsearch.v1.ClusterService" with data
    """
    {
        "clusterId": "cid1",
    ...
    {
        "created_by": "user",
        "description": "Reschedule maintenance in ElasticSearch cluster",
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.elasticsearch.v1.RescheduleMaintenanceMetadata",
            "cluster_id": "cid1",
