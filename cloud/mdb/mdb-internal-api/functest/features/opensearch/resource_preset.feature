...
Feature: Get/List Resource Presets
  ...
  Scenario: Get resource preset works
    When we "Get" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ResourcePresetService" with data
    """
    {
  ...
  Scenario: List resource presets works
    When we "List" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ResourcePresetService"
    Then we get gRPC response with body
    """
    {
        "resource_presets": [
  ...
  Scenario: List resource presets with pagination works
    When we "List" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ResourcePresetService" with data
    """
    {
        "page_size": 2
    }
