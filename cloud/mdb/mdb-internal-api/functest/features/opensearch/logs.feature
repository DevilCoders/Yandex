...
Feature: OpenSearch logs
  ...
  Scenario: OpenSearch logs can be viewed
    ...
    """
    When we "ListLogs" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid1",
  ...
  Scenario: OpenSearch logs with page size limit can be viewed
    Given logsdb response
    """
    [
        [0, 0, "message 1"],
