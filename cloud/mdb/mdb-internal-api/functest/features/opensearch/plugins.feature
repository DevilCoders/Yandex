@opensearch
@grpc_api
Feature: Plugins for OpenSearch
  Background:
  ...
  Scenario: Update OpenSearch plugins
  ...
  Scenario: Update OpenSearch plugins with unknown plugin
    When we "Update" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid1",
    ...
    """
    Then we get gRPC response error with code INVALID_ARGUMENT and message "unknown OpenSearch plugin "super-puper-plugin"."
