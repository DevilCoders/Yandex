@opensearch
@grpc_api
Feature: OpenSearch basic operations (compute)
  Background:
  ...
  Scenario: Cluster creation and deletion works
    ...
    """
    When we "ListOperations" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
      "cluster_id": "cid1"
    }
  ...
  Scenario: Cluster stop and start works
    When we "Stop" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
      "cluster_id": "cid1"
    }
    ...
    {
        "created_by": "user",
        "description": "Stop OpenSearch cluster",
        "done": false,
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.opensearch.v1.StopClusterMetadata",
            "cluster_id": "cid1"
        },
        "response": {
            "@type": "type.googleapis.com/google.rpc.Status",
    ...
    """
    When we "Start" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid1"
    }
    ...
    {
        "created_by": "user",
        "description": "Start OpenSearch cluster",
        "done": false,
        "id": "worker_task_id3",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.opensearch.v1.StartClusterMetadata",
            "cluster_id": "cid1"
        },
        "response": {
            "@type": "type.googleapis.com/google.rpc.Status",
