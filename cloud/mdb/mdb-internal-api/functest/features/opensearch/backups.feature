@opensearch
@grpc_api
Feature: Backup OpenSearch cluster
  Background:
  ...
  Scenario: Backup creation works
    When we "Backup" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid1"
    }
    ...
    {
        "created_by": "user",
        "description": "Create a backup for OpenSearch cluster",
        "done": false,
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.opensearch.v1.BackupClusterMetadata",
            "cluster_id": "cid1"
        }
    }
    """
  ...
  Scenario: Backup list works
                    ...
                    "snapshots": [
                        {
                            ...
                            "indices_total": 11,
                            "indices": [
                                ".dashboards_security_session_1",
                                ".dashboards_task_manager_7.13.4_001",
                                ".mdb_dns_upper",
                                ".dashboards_7.13.4_001"
                            ],
                            "size": 2916841
                        }
                    ]
    ...
    """
    When we "List" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.BackupService" with data
    """
    {
        "folder_id": "folder1"
    }
        ...
        "backups": [
            {
               ...
               "opensearch_version": "7.13.4",
               "indices": [
                   ".dashboards_security_session_1",
                   ".dashboards_task_manager_7.13.4_001", ".mdb_dns_upper",
                   ".dashboards_7.13.4_001"
               ],
               "indices_total": "11",
               "size_bytes": "2916841",
  ...
  Scenario: Backup list by cid works
    ...
    """
    When we "ListBackups" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "cluster_id": "cid1"
    }
  ...
  Scenario: Backup get by id works
    ...
    """
    When we "Get" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.BackupService" with data
    """
    {
  ...
  Scenario: After cluster delete its backups are shown
    ...
    And we "List" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.BackupService" with data
    """
    {
        "folder_id": "folder1",
        "page_size": 5
  ...
  Scenario: Restore cluster from backup
    ...
    """
    When we "Restore" via gRPC at "yandex.cloud.priv.mdb.opensearch.v1.ClusterService" with data
    """
    {
        "backup_id": "cid1:snapshot-1gynmx0wsbuyhyh6mb4h-g",
        "folder_id": "folder1",
    ...
    {
        "created_by": "user",
        "description": "Restore OpenSearch cluster from backup",
        "done": false,
        "id": "worker_task_id2",
        "metadata": {
            "@type": "type.googleapis.com/yandex.cloud.priv.mdb.opensearch.v1.RestoreClusterMetadata",
            "backup_id": "cid1:snapshot-1gynmx0wsbuyhyh6mb4h-g",
            "cluster_id": "cid2"
        }
    }
