@greenplum
@grpc_api
Feature: Greenplum system metrics
    Background:
    ...
    Scenario: System metrics for master hosts works
    ...
    Scenario: System metrics for segment hosts works
