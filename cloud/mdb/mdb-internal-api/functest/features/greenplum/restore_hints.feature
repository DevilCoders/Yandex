...
@restore-hints
@grpc_api
Feature: Restore Greenplum cluster from backup with hints
    ...
    Scenario: Restore hints works with last backup
        When we "GetRestoreHints" via gRPC at "yandex.cloud.priv.mdb.greenplum.v1.ClusterService" with data
        """
        {
        ...
        """
        {
           ...
           "network_id": "network1",
           "version": "6.19",
           "time": "2021-12-05T22:58:56.000001Z",
           "master_resources": {
