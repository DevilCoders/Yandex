@maintenance
Feature: Management of Mongodb maintenance window
...
Scenario: Plan maintenance and reschedule
    ...
    WITH locked_cluster AS (
        ...
        SELECT code.plan_maintenance_task(
            ...
            i_cid            => 'cid1',
            i_config_id      => 'mongodb_minor_upgrade',
            i_folder_id      => folder_id,
            i_operation_type => 'mongodb_cluster_modify',
            i_task_type      => 'mongodb_cluster_update',
            i_task_args      => '{}',
            i_version        => 2,
            i_metadata       => '{}',
    ...
    FROM planned_task
    """
    When we POST "/mdb/mongodb/1.0/clusters/cid1:rescheduleMaintenance" with data
    """
    {
       "clusterId": "cid1",
    ...
    {
        "createdBy": "user",
        "description": "Reschedule maintenance in MongoDB cluster",
        "id": "worker_task_id2",
        "metadata": {
