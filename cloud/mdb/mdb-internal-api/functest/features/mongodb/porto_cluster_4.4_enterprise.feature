Feature: Create/Modify Porto MongoDB Cluster 4.4 Enterprise
  ...
  Scenario: Setting FCV to same value fails
    ...
    """
  @fcv
  Scenario: Setting FCV to "4.2" value works
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
  ...
  Scenario: Setting FCV to 4.0 fails
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
    ...
    {
        "code": 3,
        "message": "Error parsing configSpec: Invalid feature compatibility version for version 4.4-enterprise, allowed values: 4.2, 4.4"
    }
    """
