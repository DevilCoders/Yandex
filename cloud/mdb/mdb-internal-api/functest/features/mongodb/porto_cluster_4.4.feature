Feature: Create/Modify Porto MongoDB Cluster 4.4
  ...
  Scenario: Setting FCV to "3.4" value works
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
  ...
  Scenario: Setting FCV to 4.0 fails
    ...
    {
        "code": 3,
        "message": "Error parsing configSpec: Invalid feature compatibility version for version 4.4, allowed values: 4.2, 4.4"
    }
    """
