Feature: Porto MongoDB Cluster version upgrade 5.0 to 5.0
  ...
  Scenario: Upgrade 4.4 to 5.0 works
  ...
  Scenario: Upgrade 4.4 to unsupported version fails
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
  ...
  Scenario: Upgrade 4.4 to 5.0 with bad fcv fails
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
    ...
    {
        "code": 9,
        "message": "Current feature compatibility version 4.2 is invalid for upgrade to version 5.0, expected: 4.4"
    }
    """

  Scenario: Downgrade 5.0 to 4.4 fails
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
  ...
  Scenario: Upgrade 4.4 to 5.0 mixed with another changes fails
    When we PATCH "/mdb/mongodb/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
