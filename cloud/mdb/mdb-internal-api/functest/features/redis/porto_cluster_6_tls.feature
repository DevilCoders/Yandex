Feature: Create/Modify Porto Redis 6.0 tls Cluster
  ...
  Scenario: Switching off tls fails
  ...
  @events @grpc
  Scenario Outline: Manual failover works
  ...
  @events @grpc
  Scenario Outline: Manual failover with specified host works
