Feature: Create Porto Redis Cluster Validation
  Background:
  ...
  Scenario: Create cluster with bad notifyKeyspaceEvents fails
    ...
    {
        "code": 3,
        "message": "The request is invalid.\nconfigSpec.redisConfig_5_0.notifyKeyspaceEvents: Notify keyspace events 'm' should be a subset of KEg$lshzxeAt"
    }
    """
  ...
  Scenario: Create cluster with no password fails
    ...
    {
        "code": 3,
        "message": "The request is invalid.\nconfigSpec.redisConfig_5_0.password: Missing data for required field."
    }
    """
  ...
  Scenario: Create cluster with invalid password fails
    ...
    {
        "code": 3,
        "message": "The request is invalid.\nconfigSpec.redisConfig_5_0.password: Password 'inv*lid passw?rd' does not conform to naming rules"
    }
    """
  ...
  Scenario: Create cluster without feature flag fails and shows only available versions
    ...
    {
        "code": 3,
        "message": "Version '5' is not available, allowed versions are: 5.0, 6.0"
    }
    """
  ...
  Scenario: Create cluster with incorrect version fails
    ...
    {
        "code": 3,
        "message": "Version '5' is not available, allowed versions are: 5.0, 6.0, 6.2"
    }
    """
  ...
  Scenario: Create sharded cluster with incorrect number of shards fails
    Given feature flags
    """
    ["MDB_REDIS_SHARDING", "MDB_REDIS_ALLOW_DEPRECATED_5"]
    """
    When we POST "/mdb/redis/1.0/clusters?folderId=folder1" with data
    """
    {
  ...
  Scenario: Create 5.0 cluster without feature flag fails
    When we POST "/mdb/redis/1.0/clusters?folderId=folder1" with data
    """
    {
        "name": "test",
    ...
    {
        "code": 9,
        "message": "Can't create cluster, version '5.0' is deprecated"
    }
    """

  Scenario: Create 6.0 cluster without feature flag fails
    When we POST "/mdb/redis/1.0/clusters?folderId=folder1" with data
    """
    {
        "name": "test",
    ...
    {
        "code": 9,
        "message": "Can't create cluster, version '6.0' is deprecated"
    }
    """
