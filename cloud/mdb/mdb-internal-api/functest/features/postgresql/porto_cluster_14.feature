Feature: Create/Modify/Backup Porto PostgreSQL Cluster version 14
  ...
  Scenario: Version downgrade is not possible
  ...
  Scenario: Changing PostgreSQL 12 specific settings works
    ...
    When we GET "/mdb/postgresql/1.0/clusters/cid1"
    Then we get response with status 200
    And body at path "$.config.postgresqlConfig_14.userConfig" contains
    """
    {
        "logTransactionSampleRate": 0.5,
        "planCacheMode": "PLAN_CACHE_MODE_FORCE_GENERIC_PLAN"
    ...
    """
    And body at path "$.config.postgresqlConfig_14.effectiveConfig" contains
    """
    {
        "logTransactionSampleRate": 0.5,
        "planCacheMode": "PLAN_CACHE_MODE_FORCE_GENERIC_PLAN"
  ...
  Scenario: Changing PostgreSQL 14 specific settings works
    When we PATCH "/mdb/postgresql/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
            "postgresqlConfig_14": {
                "clientConnectionCheckInterval": 60000
            }
        }
    }
    """
    ...
    """
    {
        "client_connection_check_interval": "60000ms"
    }
    """
  ...
  Scenario: Changing plan_cache_mode to invalid value doesn't work
    ...
    {
        "code": 3,
        "message": "The request is invalid.\nconfigSpec.postgresqlConfig_14.planCacheMode: Invalid value 'force_nonexisting_plan', allowed values: PLAN_CACHE_MODE_AUTO, PLAN_CACHE_MODE_FORCE_CUSTOM_PLAN, PLAN_CACHE_MODE_FORCE_GENERIC_PLAN"
    }
    """
