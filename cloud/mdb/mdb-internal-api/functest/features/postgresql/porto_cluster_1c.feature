Feature: Create/Modify Porto PostgreSQL Cluster 1C

  Background:
    Given default headers
    And feature flags
    """
    ["MDB_POSTGRESQL_13_1C"]
    """
    And "create" data
    """
    {
  ...
  Scenario: Cluster 1C creation works
    When we POST "/mdb/postgresql/1.0/clusters?folderId=folder1" with "create1C" data
    Then we get response with status 200 and body contains
    """
    {
        "createdBy": "user",
  ...
  Scenario: Upgrade 13-1c version to 13 does not work
    Given feature flags
    """
    ["MDB_POSTGRESQL_13_1C"]
    """
    ...
    {
        "code": 12,
        "message": "Upgrade from 13-1c to 13 is not supported"
    }
    """

  Scenario: Upgrade 13-1c version to 14 does not work
    Given feature flags
    """
    ["MDB_POSTGRESQL_13_1C"]
    """
    ...
    {
        "code": 12,
        "message": "Upgrade from 13-1c to 14 is not supported"
    }
    """

  Scenario: Cluster creation with invalid version suffix doesn't work
    Given feature flags
    """
    ["MDB_POSTGRESQL_13_1C"]
    """
    ...
    {
        "code": 3,
        "message": "Version '13-1C' is not available, allowed versions are: 10, 11, 12, 13, 13-1c, 14"
    }
    """