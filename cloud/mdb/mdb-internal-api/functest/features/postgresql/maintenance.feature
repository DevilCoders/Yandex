@maintenance
Feature: Management of PostgreSQL maintenance window
...
Scenario: Plan maintenance and reschedule
    ...
    WITH locked_cluster AS (
        ...
        SELECT code.plan_maintenance_task(
            ...
            i_task_type      => 'postgresql_cluster_update',
            i_task_args      => '{}',
            i_version        => 2,
            i_metadata       => '{}',
    ...
    FROM planned_task
    """
    When we POST "/mdb/postgresql/1.0/clusters/cid1:rescheduleMaintenance" with data
    """
    {
       "clusterId": "cid1",
    ...
    {
        "createdBy": "user",
        "description": "Reschedule maintenance in PostgreSQL cluster",
        "id": "worker_task_id2",
        "metadata": {
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.postgresql.RescheduleMaintenance" event with
    """
    {
        "details": {
            "cluster_id": "cid1"
