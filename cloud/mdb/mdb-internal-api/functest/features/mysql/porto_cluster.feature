Feature: Create/Modify Porto MySQL Cluster
  ...
  Scenario: Adding host works
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.mysql.AddClusterHosts" event with
    """
    {
        "details": {
            "cluster_id": "cid1",
  ...
  Scenario: Deleting host works
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.mysql.DeleteClusterHosts" event with
    """
    {
        "details": {
            "cluster_id": "cid1",
  ...
  Scenario: Adding and modifying user with params works
    ...
    {
        "permissions": [],
        "globalPermissions": [ "PROCESS", "REPLICATION_CLIENT"],
        "connectionLimits": {
    ...
    When we GET "/api/v1.0/config/sas-1.db.yandex.net"
    Then we get response with status 200 and body equals to "default sas host config" data with following changes
      | $.data.mysql.users.test3.dbs.*[1]                                   | REPLICATION CLIENT    |
      | $.data.mysql.users.test3.dbs.*[0]                                   | PROCESS               |
      | $.data.mysql.users.test3.password.data                              | password              |
      | $.data.mysql.users.test3.password.encryption_version                | 0                     |
      | $.data.mysql.users.test3.services[0]                                | mysql                 |
      ...
      | $.data.mysql.users.test3.plugin                                     | mysql_native_password |

  Scenario: Adding user with not supported plugin
    When we POST "/mdb/mysql/1.0/clusters/cid1/users" with data
    """
    {
        "userSpec": {
    ...
    {
        "code": 3,
        "message": "Unsupported in mysql 5.7 plugin value: caching_sha2_password"
    }
    """
  ...
  @events
  Scenario: Backup window start option and retain policy may be specified during creation
    When we POST "/mdb/mysql/1.0/clusters?folderId=folder1" with data
    """
    {
        "name": "test2",
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.mysql.CreateCluster" event with
    """
    {
        "details": {
            "cluster_id": "cid2"
    ...
    Then we get response with status 200 and body matching following values
    | $.config.backupRetainPeriodDays        | 17       |
  ...
  @events
  Scenario: Backup window start option and retain policy change works
    When we PATCH "/mdb/mysql/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
  ...
  Scenario: Changing user password works
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.mysql.UpdateUser" event with
    """
    {
        "details": {
            "cluster_id": "cid1",
  ...
  Scenario: Scaling cluster up works
    ...
    | $.config.mysqlConfig_5_7.defaultConfig.innodbBufferPoolSize   | 4294967296 |
    | $.config.mysqlConfig_5_7.defaultConfig.maxConnections         | 256        |
    | $.config.mysqlConfig_5_7.effectiveConfig.innodbBufferPoolSize | 4294967296 |
    | $.config.mysqlConfig_5_7.effectiveConfig.maxConnections       | 256        |
  ...
  Scenario: Scaling cluster down fails on high resource dependent options
    When we PATCH "/mdb/mysql/1.0/clusters/cid1" with data
    """
    {
        "configSpec": {
    ...
    """
    {
        "configSpec": {
            "mysqlConfig_5_7": {
                "innodbBufferPoolSize": "7730941132"
            }
        }
    }
    """
    ...
    {
        "code": 3,
        "message": "innodb_buffer_pool_size: 7730941132 should be less than or equal to 2684354560"
    }
    """
  ...
  Scenario: Cluster removal works
    ...
    """
    And for "worker_task_id2" exists "yandex.cloud.events.mdb.mysql.DeleteCluster" event with
    """
    {
        "details": {
            "cluster_id": "cid1"
  ...
  Scenario: Slow log options change works
    ...
    When we GET "/mdb/mysql/1.0/clusters/cid1"
    Then we get response with status 200 and body equals to "default cluster config" data with following changes
    | $.config.mysqlConfig_5_7.userConfig.longQueryTime                    | 5     |
    | $.config.mysqlConfig_5_7.userConfig.logSlowRateLimit                 | 10    |
    | $.config.mysqlConfig_5_7.userConfig.logSlowRateType                  | QUERY |
    | $.config.mysqlConfig_5_7.userConfig.logSlowSpStatements              | true  |
    | $.config.mysqlConfig_5_7.userConfig.slowQueryLog                     | true  |
    | $.config.mysqlConfig_5_7.userConfig.slowQueryLogAlwaysWriteTime      | 15    |
    | $.config.mysqlConfig_5_7.effectiveConfig.longQueryTime               | 5     |
    | $.config.mysqlConfig_5_7.effectiveConfig.logSlowRateLimit            | 10    |
    | $.config.mysqlConfig_5_7.effectiveConfig.logSlowRateType             | QUERY |
    | $.config.mysqlConfig_5_7.effectiveConfig.logSlowSpStatements         | true  |
    | $.config.mysqlConfig_5_7.effectiveConfig.slowQueryLog                | true  |
    | $.config.mysqlConfig_5_7.effectiveConfig.slowQueryLogAlwaysWriteTime | 15    |
  ...
  Scenario: Mdb priority choice max lag change works
    ...
    When we GET "/mdb/mysql/1.0/clusters/cid1"
    Then we get response with status 200 and body equals to "default cluster config" data with following changes
    | $.config.mysqlConfig_5_7.userConfig.mdbPriorityChoiceMaxLag      | 99 |
    | $.config.mysqlConfig_5_7.effectiveConfig.mdbPriorityChoiceMaxLag | 99 |
  ...
  Scenario: Cluster modification in PROD env works without IDM flag
    Given default headers
    When we POST "/mdb/mysql/1.0/clusters?folderId=folder1" with "create production" data
    Then we get response with status 200 and body contains
    """
    {
        "createdBy": "user",
    ...
    """
    When "worker_task_id2" acquired and finished by worker
    When we PATCH "/mdb/mysql/1.0/clusters/cid2" with data
    """
    {
        "configSpec": {
            "resources": {
