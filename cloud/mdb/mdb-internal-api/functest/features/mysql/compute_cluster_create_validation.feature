Feature: Create Compute MySQL Cluster Validation
  Background:
  ...
  Scenario: Create cluster with 1 host and local disk fails
    ...
    {
        "code": 9,
        "message": "MySQL cluster with resource preset 's1.compute.1' and disk type 'local-nvme' requires at least 3 hosts"
    }
    """
