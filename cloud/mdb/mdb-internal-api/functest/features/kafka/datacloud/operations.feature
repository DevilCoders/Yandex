@grpc_api
Feature: Test Datacloud OperationService API fir kafka
  ...
  Scenario: Get Operation works
    When we "Get" via DataCloud at "datacloud.kafka.v1.OperationService" with data
    """
    {
  ...
  Scenario: List Operation works
    When we "List" via DataCloud at "datacloud.kafka.v1.OperationService" with data
    """
    {
        "project_id": "folder1"
    }
