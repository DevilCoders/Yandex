...
Feature: Apache Kafka v2.8
      ...
      "configSpec": {
        "kafka": {
          ...
          "kafka_config_2_8": {
            ...
            "ssl_cipher_suites":               ["TLS_AKE_WITH_AES_128_GCM_SHA256", "TLS_RSA_WITH_AES_256_CBC_SHA256"],
  ...
  Scenario: Change kafka config 2.8
      ...
      "config_spec": {
        ...
        "kafka": {
          "kafka_config_2_8": {
            ...
            "num_partitions":                  6010,
            "default_replication_factor":      1,
            "message_max_bytes":               1100,
            "replica_fetch_max_bytes":         2100000,
            "ssl_cipher_suites":               ["TLS_DHE_RSA_WITH_AES_128_CBC_SHA", "TLS_RSA_WITH_AES_256_CBC_SHA"],
            "offsets_retention_minutes":       20000
          }
        }
      }
    }
    ...
    """
    {
      ...
      "updateMask": {
          "paths": [
              ...
              "topic_spec.topic_config_2_8.cleanup_policy",
              "topic_spec.topic_config_2_8.compression_type",
              "topic_spec.topic_config_2_8.delete_retention_ms",
              "topic_spec.topic_config_2_8.file_delete_delay_ms",
              "topic_spec.topic_config_2_8.flush_messages",
              "topic_spec.topic_config_2_8.flush_ms",
              "topic_spec.topic_config_2_8.max_message_bytes",
              "topic_spec.topic_config_2_8.min_compaction_lag_ms",
              "topic_spec.topic_config_2_8.min_insync_replicas",
              "topic_spec.topic_config_2_8.retention_bytes",
              "topic_spec.topic_config_2_8.retention_ms",
              "topic_spec.topic_config_2_8.segment_bytes"
          ]
      }
    }
    """
