"""
Elasticsearch user create tests
"""
...
def test_porto_elasticsearch_user_create_interrupt_consistency(mocker):
    """
...
def test_compute_elasticsearch_user_create_interrupt_consistency(mocker):
    """
...
def test_elasticsearch_user_create_mlock_usage(mocker):
    """
