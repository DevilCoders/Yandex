...
def test_compute_mongodb_cluster_start_interrupt_consistency(mocker):
    """
    ...
    *_, state = checked_run_task_with_mocks(mocker, 'mongodb_cluster_stop', args, state=state)
...
def test_mongodb_cluster_start_mlock_usage(mocker):
    """
