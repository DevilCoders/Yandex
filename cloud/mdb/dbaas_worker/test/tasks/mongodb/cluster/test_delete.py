...
def test_porto_mongodb_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_compute_mongodb_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_mongodb_cluster_delete_mlock_usage(mocker):
    """
...
def test_mongodb_cluster_delete_alert_sync(mocker):
    """
    Check delete mlock usage
    """
    args = {
