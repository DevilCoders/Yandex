"""
MongoDB cluster create backup tests
"""
...
def test_porto_mongodb_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_compute_mongodb_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_mongodb_cluster_create_backup_mlock_usage(mocker):
    """
...
def test_mongodb_cluster_create_backup_revertable(mocker):
    """
