...
def test_porto_mongodb_cluster_resetup_interrupt_consistency(mocker):
    """
    Check porto resetup interruptions
    """
    args = {
        'hosts': {
...
def test_porto_mongodb_cluster_sharded_resetup_interrupt_consistency(mocker):
    """
    Check porto sharded resetup interruptions
    """
    args = {
        'hosts': {
            'host1': get_mongod_porto_host(geo='geo1'),
...
def test_compute_mongodb_cluster_resetup_interrupt_consistency(mocker):
    """
    Check compute resetup interruptions
    """
    args = {
        'hosts': {
...
def test_compute_mongodb_cluster_sharded_resetup_interrupt_consistency(mocker):
    """
    Check compute sharded resetup interruptions
    """
    args = {
        'hosts': {
            'host1': get_mongod_compute_host(geo='geo1'),
...
def test_mongodb_cluster_resetup_mlock_usage(mocker):
    """
    Check resetup mlock usage
    """
    args = {
        'hosts': {
            'host1': get_mongod_porto_host(geo='geo1'),
