"""
MongoDB cluster metadata tests
"""
...
def test_compute_mongodb_metadata_update_interrupt_consistency(mocker):
    """
...
def test_mongodb_metadata_update_mlock_usage(mocker):
    """
