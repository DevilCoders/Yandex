...
def test_compute_mongodb_cluster_restart_interrupt_consistency(mocker):
    """
    Check compute restart interruptions
    """
    args = {
        'hosts': {
...
def test_compute_mongodb_cluster_sharded_restart_interrupt_consistency(mocker):
    """
    Check compute sharded restart interruptions
    """
    args = {
        'hosts': {
            'host1': get_mongod_compute_host(geo='geo1'),
...
def test_mongodb_cluster_restart_mlock_usage(mocker):
    """
    Check restart mlock usage
    """
    args = {
        'hosts': {
            'host1': get_mongod_compute_host(geo='geo1'),
