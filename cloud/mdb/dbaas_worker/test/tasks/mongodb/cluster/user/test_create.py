...
def test_porto_mongodb_user_create_interrupt_consistency(mocker):
    """
...
def test_compute_mongodb_user_create_interrupt_consistency(mocker):
    """
...
def test_mongodb_user_create_mlock_usage(mocker):
    """
