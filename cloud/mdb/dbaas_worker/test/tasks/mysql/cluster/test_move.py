...
def test_porto_mysql_cluster_move_interrupt_consistency(mocker):
    """
...
def test_compute_mysql_cluster_move_interrupt_consistency(mocker):
    """
...
def test_mysql_cluster_move_mlock_usage(mocker):
    """
