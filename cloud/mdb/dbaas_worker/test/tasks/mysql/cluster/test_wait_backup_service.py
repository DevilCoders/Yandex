"""
MySQL cluster backup service tests
"""
...
def test_porto_mysql_cluster_test_wait_backup_service_interrupt_consistency(mocker):
    """
    Check porto backup service interruptions
    """
    args = {
        'hosts': {
...
def test_compute_mysql_cluster_wait_backup_service_interrupt_consistency(mocker):
    """
    Check compute backup service interruptions
    """
    args = {
        'hosts': {
...
def test_mysql_cluster_test_wait_backup_service_mlock_usage(mocker):
    """
    Check backup service mlock usage
    """
    args = {
        'hosts': {
            'host1': get_mysql_porto_host(geo='geo1'),
