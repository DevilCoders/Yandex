...
def test_porto_mysql_database_delete_interrupt_consistency(mocker):
    """
...
def test_compute_mysql_database_delete_interrupt_consistency(mocker):
    """
...
def test_mysql_database_delete_mlock_usage(mocker):
    """
