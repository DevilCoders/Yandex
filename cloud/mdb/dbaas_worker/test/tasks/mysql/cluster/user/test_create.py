...
def test_porto_mysql_user_create_interrupt_consistency(mocker):
    """
...
def test_compute_mysql_user_create_interrupt_consistency(mocker):
    """
...
def test_mysql_user_create_mlock_usage(mocker):
    """
