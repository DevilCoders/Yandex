...
def test_porto_mysql_user_modify_interrupt_consistency(mocker):
    """
...
def test_compute_mysql_user_modify_interrupt_consistency(mocker):
    """
...
def test_mysql_user_modify_mlock_usage(mocker):
    """
