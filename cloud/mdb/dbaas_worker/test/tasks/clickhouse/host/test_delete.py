...
def test_porto_clickhouse_host_delete_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_host_delete_interrupt_consistency(mocker):
    """
...
def test_clickhouse_host_delete_mlock_usage(mocker):
    """
...
def test_clickhouse_host_delete_alert_sync(mocker):
    """
    Check host delete mlock usage
    """
    args = {
