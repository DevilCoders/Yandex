"""
ClickHouse zookeeper host create tests
"""
...
def test_porto_clickhouse_zookeeper_host_create_interrupt_consistency(mocker):
    """
    Check porto zookeeper host create interruptions
    """
    args = {
        'hosts': {
    ...
    *_, state = checked_run_task_with_mocks(
    ...
    args['hosts']['host6'] = get_zookeeper_porto_host(geo='geo1')
    args['host'] = 'host6'
    args['zid_added'] = 4
...
def test_compute_clickhouse_zookeeper_host_create_interrupt_consistency(mocker):
    """
    Check compute zookeeper host create interruptions
    """
    args = {
        'hosts': {
    ...
    *_, state = checked_run_task_with_mocks(
    ...
    args['hosts']['host6'] = get_zookeeper_compute_host(geo='geo1')
    args['host'] = 'host6'
    args['zid_added'] = 4
...
def test_clickhouse_zookeeper_host_create_mlock_usage(mocker):
    """
    Check zookeeper host create mlock usage
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
...
def test_porto_clickhouse_zookeeper_host_create_revertable(mocker):
    """
    Check porto zookeeper host create revertability
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
...
def test_compute_clickhouse_zookeeper_host_create_revertable(mocker):
    """
    Check compute zookeeper host create revertability
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_compute_host(geo='geo1'),
