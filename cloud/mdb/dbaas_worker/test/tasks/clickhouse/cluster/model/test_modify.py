...
def test_porto_clickhouse_model_modify_interrupt_consistency(mocker):
    """
    Check porto model modify interruptions
    """
    args = {
        'hosts': {
...
def test_compute_clickhouse_model_modify_interrupt_consistency(mocker):
    """
    Check compute model modify interruptions
    """
    args = {
        'hosts': {
...
def test_clickhouse_model_modify_mlock_usage(mocker):
    """
    Check model modify mlock usage
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
