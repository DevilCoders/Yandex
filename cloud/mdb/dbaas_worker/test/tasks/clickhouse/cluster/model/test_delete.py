...
def test_porto_clickhouse_model_delete_interrupt_consistency(mocker):
    """
    Check porto model delete interruptions
    """
    args = {
        'hosts': {
...
def test_compute_clickhouse_model_delete_interrupt_consistency(mocker):
    """
    Check compute model delete interruptions
    """
    args = {
        'hosts': {
...
def test_clickhouse_model_delete_mlock_usage(mocker):
    """
    Check model delete mlock usage
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
