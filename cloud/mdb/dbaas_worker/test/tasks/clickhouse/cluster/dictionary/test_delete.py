"""
ClickHouse dictionary delete tests
"""
...
def test_porto_clickhouse_dictionary_delete_interrupt_consistency(mocker):
    """
    Check porto dictionary delete interruptions
    """
    args = {
        'hosts': {
    ...
    *_, state = checked_run_task_with_mocks(
    ...
    args['target-dictionary'] = 'test-dictionary'
...
def test_compute_clickhouse_dictionary_delete_interrupt_consistency(mocker):
    """
    Check compute dictionary delete interruptions
    """
    args = {
        'hosts': {
...
def test_clickhouse_dictionary_delete_mlock_usage(mocker):
    """
    Check dictionary delete mlock usage
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
