"""
ClickHouse format schema delete tests
"""
...
def test_porto_clickhouse_format_schema_delete_interrupt_consistency(mocker):
    """
    Check porto format schema delete interruptions
    """
    args = {
        'hosts': {
...
def test_compute_clickhouse_format_schema_delete_interrupt_consistency(mocker):
    """
    Check compute format schema delete interruptions
    """
    args = {
        'hosts': {
...
def test_clickhouse_format_schema_delete_mlock_usage(mocker):
    """
    Check format schema delete mlock usage
    """
    args = {
        'hosts': {
            'host1': get_clickhouse_porto_host(geo='geo1'),
