"""
ClickHouse database create tests
"""
...
def test_porto_clickhouse_database_create_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_database_create_interrupt_consistency(mocker):
    """
...
def test_clickhouse_database_create_mlock_usage(mocker):
    """
