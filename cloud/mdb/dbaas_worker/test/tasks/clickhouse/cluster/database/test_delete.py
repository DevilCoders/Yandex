"""
ClickHouse database delete tests
"""
...
def test_porto_clickhouse_database_delete_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_database_delete_interrupt_consistency(mocker):
    """
...
def test_clickhouse_database_delete_mlock_usage(mocker):
    """
