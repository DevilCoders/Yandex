...
def test_porto_clickhouse_cluster_move_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_cluster_move_interrupt_consistency(mocker):
    """
...
def test_clickhouse_cluster_move_mlock_usage(mocker):
    """
