...
def test_porto_clickhouse_user_modify_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_user_modify_interrupt_consistency(mocker):
    """
...
def test_clickhouse_user_modify_mlock_usage(mocker):
    """
