...
def test_porto_clickhouse_user_create_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_user_create_interrupt_consistency(mocker):
    """
...
def test_clickhouse_user_create_mlock_usage(mocker):
    """
