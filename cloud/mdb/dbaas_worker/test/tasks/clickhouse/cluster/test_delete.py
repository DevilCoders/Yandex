"""
ClickHouse cluster delete tests
"""
...
def test_porto_clickhouse_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_compute_clickhouse_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_clickhouse_cluster_delete_mlock_usage(mocker):
    """
...
def test_clickhouse_cluster_delete_alert_sync(mocker):
    """
    Check delete mlock usage
    """
    args = {
