...
def create_porto_cluster(mocker):
    env_porto(mocker)
    target_host, target_fqdn = get_greenplum_master_porto_host(geo='geo1'), 'foo.mdb.yacloud.net'
    host2, fqdn2 = get_greenplum_master_porto_host(geo='geo1'), 'bar.mdb.yacloud.net'
    host3, fqdn3 = get_greenplum_segment_porto_host(geo='geo1'), 'baz.mdb.yacloud.net'
    host4, fqdn4 = get_greenplum_segment_porto_host(geo='geo1'), 'bee.mdb.yacloud.net'
    args = {
        'hosts': {
...
def create_compute_cluster(mocker):
    env_compute(mocker)
    target_host, target_fqdn = get_greenplum_master_compute_host(geo='geo1'), 'foo.mdb.yacloud.net'
    host2, fqdn2 = get_greenplum_master_compute_host(geo='geo1'), 'bar.mdb.yacloud.net'
    host3, fqdn3 = get_greenplum_segment_compute_host(geo='geo1'), 'baz.mdb.yacloud.net'
    host4, fqdn4 = get_greenplum_segment_compute_host(geo='geo1'), 'bee.mdb.yacloud.net'
    args = {
        'hosts': {
            target_fqdn: target_host,
            fqdn2: host2,
