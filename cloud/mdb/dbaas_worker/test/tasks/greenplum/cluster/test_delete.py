"""
Greenplum cluster delete tests
"""
...
def test_porto_greenplum_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_compute_greenplum_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_greenplum_cluster_delete_mlock_usage(mocker):
    """
...
def test_greenplum_cluster_delete_alert_sync(mocker):
    """
    Check delete mlock usage
    """
    args = {
