"""
SqlServer database delete tests
"""
...
def test_compute_sqlserver_database_delete_interrupt_consistency(mocker):
    """
...
def test_sqlserver_database_delete_mlock_usage(mocker):
    """
