"""
SQLServer cluster metadata tests
"""
...
def test_compute_sqlserver_metadata_update_interrupt_consistency(mocker):
    """
...
def test_sqlserver_metadata_update_mlock_usage(mocker):
    """
