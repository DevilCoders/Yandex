"""
SQLServer cluster delete tests
"""
...
def test_compute_sqlserver_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_sqlserver_cluster_delete_alert_sync(mocker):
    """
...
def test_sqlserver_cluster_delete_mlock_usage(mocker):
    """
    Check delete mlock usage
    """
    args = {
