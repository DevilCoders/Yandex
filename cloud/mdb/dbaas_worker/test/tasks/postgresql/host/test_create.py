...
def test_porto_postgresql_host_create_interrupt_consistency(mocker):
    """
    ...
    *_, state = checked_run_task_with_mocks(
    ...
    args['hosts']['host4'] = get_postgresql_porto_host(geo='geo1')
    args['host'] = 'host4'
...
def test_compute_postgresql_host_create_interrupt_consistency(mocker):
    """
    ...
    *_, state = checked_run_task_with_mocks(
    ...
    args['hosts']['host4'] = get_postgresql_compute_host(geo='geo1')
    args['host'] = 'host4'
...
def test_postgresql_host_create_mlock_usage(mocker):
    """
...
def test_porto_postgresql_host_create_revertable(mocker):
    """
...
def test_compute_postgresql_host_create_revertable(mocker):
    """
