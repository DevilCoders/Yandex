"""
PostgreSQL cluster start tests
"""
...
def test_compute_postgresql_cluster_start_interrupt_consistency(mocker):
    """
...
def test_postgresql_cluster_start_mlock_usage(mocker):
    """
