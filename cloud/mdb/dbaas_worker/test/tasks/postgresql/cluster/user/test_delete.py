...
def test_porto_postgresql_user_delete_interrupt_consistency(mocker):
    """
...
def test_compute_postgresql_user_delete_interrupt_consistency(mocker):
    """
...
def test_postgresql_user_delete_mlock_usage(mocker):
    """
