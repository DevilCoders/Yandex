...
def test_porto_postgresql_user_modify_interrupt_consistency(mocker):
    """
...
def test_compute_postgresql_user_modify_interrupt_consistency(mocker):
    """
...
def test_postgresql_user_modify_mlock_usage(mocker):
    """
