"""
PostgreSQL cluster upgrade 14 tests
"""
...
def test_porto_postgresql_cluster_upgrade_14_interrupt_consistency(mocker):
    """
    Check porto upgrade 14 interruptions
    """
    args = {
        'hosts': {
...
def test_compute_postgresql_cluster_upgrade_14_interrupt_consistency(mocker):
    """
    Check compute upgrade 14 interruptions
    """
    args = {
        'hosts': {
...
def test_postgresql_cluster_upgrade_14_mlock_usage(mocker):
    """
    Check upgrade 14 mlock usage
    """
    args = {
        'hosts': {
            'host1': get_postgresql_porto_host(geo='geo1'),
