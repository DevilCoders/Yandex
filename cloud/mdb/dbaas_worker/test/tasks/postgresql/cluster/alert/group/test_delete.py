...
def test_postgre_alert_group_delete_interrupts(mocker):
    _patch_meta(mocker)
    ...
    check_task_interrupt_consistency(
        mocker,
        'postgresql_alert_group_delete',
        args,
        get_state(),
    )


def test_postgre_alert_group_delete_mlock(mocker):
    _patch_meta(mocker)
    _patch_solomon(mocker)
    args = {
        'hosts': {
...
def test_postgresql_alert_group_delete_alert_sync(mocker):
    args = {}
