"""
PostgreSQL cluster upgrade 11-1c tests
"""
...
def test_porto_postgresql_cluster_upgrade_11_interrupt_consistency(mocker):
    """
    Check porto upgrade 11 interruptions
    """
    args = {
        'hosts': {
...
def test_compute_postgresql_cluster_upgrade_11_interrupt_consistency(mocker):
    """
    Check compute upgrade 11 interruptions
    """
    args = {
        'hosts': {
...
def test_postgresql_cluster_upgrade_11_mlock_usage(mocker):
    """
    Check upgrade 11 mlock usage
    """
    args = {
        'hosts': {
            'host1': get_postgresql_porto_host(geo='geo1'),
