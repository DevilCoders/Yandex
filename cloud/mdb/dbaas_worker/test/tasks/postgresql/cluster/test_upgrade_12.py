"""
PostgreSQL cluster upgrade 12 tests
"""
...
def test_porto_postgresql_cluster_upgrade_12_interrupt_consistency(mocker):
    """
    Check porto upgrade 12 interruptions
    """
    args = {
        'hosts': {
...
def test_compute_postgresql_cluster_upgrade_12_interrupt_consistency(mocker):
    """
    Check compute upgrade 12 interruptions
    """
    args = {
        'hosts': {
...
def test_postgresql_cluster_upgrade_12_mlock_usage(mocker):
    """
    Check upgrade 12 mlock usage
    """
    args = {
        'hosts': {
            'host1': get_postgresql_porto_host(geo='geo1'),
