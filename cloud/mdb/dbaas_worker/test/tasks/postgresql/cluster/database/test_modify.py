"""
PostgreSQL database modify tests
"""
...
def test_porto_postgresql_database_modify_interrupt_consistency(mocker):
    """
    Check porto database modify interruptions
    """
    args = {
        'hosts': {
...
def test_compute_postgresql_database_modify_interrupt_consistency(mocker):
    """
...
def test_postgresql_database_modify_mlock_usage(mocker):
    """
