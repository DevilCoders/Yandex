...
def test_porto_kafka_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_compute_kafka_cluster_delete_interrupt_consistency(mocker):
    """
...
def test_kafka_cluster_delete_mlock_usage(mocker):
    """
...
def test_kafka_cluster_delete_alert_sync(mocker):
    """
    Check delete mlock usage
    """
    args = {
