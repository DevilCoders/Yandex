...
def test_porto_kafka_connector_resume_interrupt_consistency(mocker):
    """
    Check porto connector resume interruptions
    """
    args = {
        'hosts': {
...
def test_compute_kafka_connector_resume_interrupt_consistency(mocker):
    """
    Check compute connector resume interruptions
    """
    args = {
        'hosts': {
...
def test_kafka_connector_resume_mlock_usage(mocker):
    """
    Check connector resume mlock usage
    """
    args = {
        'hosts': {
            'host1': get_kafka_porto_host(geo='geo1'),
