...
def test_porto_kafka_connector_delete_interrupt_consistency(mocker):
    """
    Check porto connector delete interruptions
    """
    args = {
        'hosts': {
...
def test_compute_kafka_connector_delete_interrupt_consistency(mocker):
    """
    Check compute connector delete interruptions
    """
    args = {
        'hosts': {
...
def test_kafka_connector_delete_mlock_usage(mocker):
    """
    Check connector delete mlock usage
    """
    args = {
        'hosts': {
            'host1': get_kafka_porto_host(geo='geo1'),
