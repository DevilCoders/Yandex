...
def test_porto_kafka_connector_create_interrupt_consistency(mocker):
    """
    Check porto connector create interruptions
    """
    args = {
        'hosts': {
...
def test_compute_kafka_connector_create_interrupt_consistency(mocker):
    """
    Check compute connector create interruptions
    """
    args = {
        'hosts': {
...
def test_kafka_connector_create_mlock_usage(mocker):
    """
    Check connector create mlock usage
    """
    args = {
        'hosts': {
            'host1': get_kafka_porto_host(geo='geo1'),
