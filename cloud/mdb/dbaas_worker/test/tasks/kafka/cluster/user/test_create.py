...
def test_porto_kafka_user_create_interrupt_consistency(mocker):
    """
...
def test_compute_kafka_user_create_interrupt_consistency(mocker):
    """
...
def test_kafka_user_create_mlock_usage(mocker):
    """
