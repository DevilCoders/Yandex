...
def test_porto_kafka_topic_delete_interrupt_consistency(mocker):
    """
    Check porto topic delete interruptions
    """
    args = {
        'hosts': {
...
def test_compute_kafka_topic_delete_interrupt_consistency(mocker):
    """
    Check compute topic delete interruptions
    """
    args = {
        'hosts': {
...
def test_kafka_topic_delete_mlock_usage(mocker):
    """
    Check topic delete mlock usage
    """
    args = {
        'hosts': {
            'host1': get_kafka_porto_host(geo='geo1'),
