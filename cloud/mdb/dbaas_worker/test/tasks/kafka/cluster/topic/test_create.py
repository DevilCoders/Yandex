...
def test_porto_kafka_topic_create_interrupt_consistency(mocker):
    """
    Check porto topic create interruptions
    """
    args = {
        'hosts': {
...
def test_compute_kafka_topic_create_interrupt_consistency(mocker):
    """
    Check compute topic create interruptions
    """
    args = {
        'hosts': {
...
def test_kafka_topic_create_mlock_usage(mocker):
    """
    Check topic create mlock usage
    """
    args = {
        'hosts': {
            'host1': get_kafka_porto_host(geo='geo1'),
