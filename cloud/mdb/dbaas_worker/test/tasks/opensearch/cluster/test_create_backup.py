"""
Opensearch cluster create backup tests
"""
...
def test_porto_opensearch_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_compute_opensearch_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_opensearch_cluster_create_backup_mlock_usage(mocker):
    """
...
def test_opensearch_cluster_create_backup_revertable(mocker):
    """
