...
def test_porto_opensearch_user_delete_interrupt_consistency(mocker):
    """
...
def test_compute_opensearch_user_delete_interrupt_consistency(mocker):
    """
...
def test_opensearch_user_delete_mlock_usage(mocker):
    """
