"""
OpenSearch cluster upgrade tests
"""
...
def test_porto_opensearch_cluster_upgrade_interrupt_consistency(mocker):
    """
...
def test_compute_opensearch_cluster_upgrade_interrupt_consistency(mocker):
    """
...
def test_opensearch_cluster_upgrade_mlock_usage(mocker):
    """
