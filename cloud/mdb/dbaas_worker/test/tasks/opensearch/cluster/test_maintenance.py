"""
Opensearch cluster maintenance tests
"""
...
def test_opensearch_cluster_maintenance_not_healthy(mocker):
    args = {
        'hosts': {
...
def test_opensearch_cluster_maintenance_mlock_usage(mocker):
    args = {
        'hosts': {
            'host1': get_opensearch_datanode_porto_host(geo='geo1'),
            'host2': get_opensearch_datanode_porto_host(geo='geo2'),
...
def test_porto_opensearch_cluster_maintenance_interrupt_consistency(mocker):
    args = {
        'hosts': {
            'host1': get_opensearch_datanode_porto_host(geo='geo1'),
            'host2': get_opensearch_datanode_porto_host(geo='geo2'),
...
def test_compute_opensearch_cluster_maintenance_interrupt_consistency(mocker):
    args = {
        'hosts': {
