...
def create_porto_cluster(mocker):
    env_porto(mocker)
    target_host, target_fqdn = get_opensearch_masternode_porto_host(geo='geo1'), 'foo.mdb.yacloud.net'
    host2, fqdn2 = get_opensearch_datanode_porto_host(geo='geo2'), 'bar.mdb.yacloud.net'
    host3, fqdn3 = get_opensearch_datanode_porto_host(geo='geo3'), 'baz.mdb.yacloud.net'
    host4, fqdn4 = get_opensearch_masternode_porto_host(geo='geo2'), 'bee.mdb.yacloud.net'
    args = {
        'hosts': {
...
def create_compute_cluster(mocker):
    env_compute(mocker)
    target_host, target_fqdn = get_opensearch_masternode_compute_host(geo='geo1'), 'foo.mdb.yacloud.net'
    host2, fqdn2 = get_opensearch_datanode_compute_host(geo='geo2'), 'bar.mdb.yacloud.net'
    host3, fqdn3 = get_opensearch_datanode_compute_host(geo='geo3'), 'baz.mdb.yacloud.net'
    host4, fqdn4 = get_opensearch_masternode_compute_host(geo='geo2'), 'bee.mdb.yacloud.net'
    args = {
        'hosts': {
            target_fqdn: target_host,
            fqdn2: host2,
...
def test_porto_opensearch_cluster_readd_online_interrupt_consistency(mocker):
    """
...
def test_compute_opensearch_cluster_readd_online_interrupt_consistency(mocker):
    """
...
def test_compute_opensearch_cluster_readd_online_mlock_usage(mocker):
    """
    Check mlock usage
    """
    state, target_fqdn = create_compute_cluster(mocker)
...
def test_porto_opensearch_online_resetup_mlock_usage(mocker):
    """
    Check mlock usage
    """
    state, target_fqdn = create_porto_cluster(mocker)
...
def test_porto_opensearch_offline_resetup_mlock_usage(mocker):
    """
    Check mlock usage
    """
    state, target_fqdn = create_porto_cluster(mocker)
...
def test_porto_opensearch_cluster_readd_offline_interrupt_consistency(mocker):
    state, target_fqdn = create_porto_cluster(mocker)
    check_task_interrupt_consistency(
        mocker,
        'opensearch_cluster_offline_resetup',
...
def test_compute_opensearch_cluster_readd_offline_interrupt_consistency(mocker):
    env_compute(mocker)
    target_host, target_fqdn = get_opensearch_masternode_compute_host(geo='geo1'), 'foo.mdb.yacloud.net'
    host2, fqdn2 = get_opensearch_datanode_compute_host(geo='geo2'), 'bar.mdb.yacloud.net'
    host3, fqdn3 = get_opensearch_datanode_compute_host(geo='geo3'), 'baz.mdb.yacloud.net'
...
def test_compute_opensearch_offline_resetup_mlock_usage(mocker):
    """
    Check mlock usage
    """
    state, target_fqdn = create_compute_cluster(mocker)
...
def test_porto_opensearch_online_resetup_transfer(mocker):
    state, target_fqdn = create_porto_cluster(mocker)
...
def test_porto_opensearch_online_resetup_no_transfer(mocker):
    state, target_fqdn = create_porto_cluster(mocker)
...
def test_compute_opensearch_online_resetup_recreate_vm(mocker):
    state, target_fqdn = create_compute_cluster(mocker)
...
def test_compute_opensearch_online_resetup_preserve_vm(mocker):
    state, target_fqdn = create_compute_cluster(mocker)
