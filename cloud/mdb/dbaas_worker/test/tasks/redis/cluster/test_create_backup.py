"""
Redis cluster create backup tests
"""
...
def test_porto_redis_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_compute_redis_cluster_create_backup_interrupt_consistency(mocker):
    """
...
def test_redis_cluster_create_backup_mlock_usage(mocker):
    """
...
def test_redis_cluster_create_backup_revertable(mocker):
    """
