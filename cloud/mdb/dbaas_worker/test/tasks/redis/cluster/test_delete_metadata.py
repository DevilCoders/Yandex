"""
Redis cluster delete metadata tests
"""
...
def test_porto_redis_cluster_delete_metadata_interrupt_consistency(mocker):
    """
...
def test_compute_redis_cluster_delete_metadata_interrupt_consistency(mocker):
    """
