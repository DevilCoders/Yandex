...
def test_porto_redis_cluster_rebalance_interrupt_consistency(mocker):
    """
    Check porto rebalance interruptions
    """
    args = {
        'hosts': {
...
def test_compute_redis_cluster_rebalance_interrupt_consistency(mocker):
    """
    Check compute rebalance interruptions
    """
    args = {
        'hosts': {
...
def test_redis_cluster_rebalance_mlock_usage(mocker):
    """
    Check rebalance mlock usage
    """
    args = {
        'hosts': {
            'host1': get_redis_porto_host(geo='geo1'),
