...
def test_porto_redis_cluster_move_interrupt_consistency(mocker):
    """
...
def test_compute_redis_cluster_move_interrupt_consistency(mocker):
    """
...
def test_redis_cluster_move_mlock_usage(mocker):
    """
