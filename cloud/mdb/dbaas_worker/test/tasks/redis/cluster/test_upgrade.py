...
def test_porto_redis_cluster_upgrade_interrupt_consistency(mocker):
    """
...
def test_compute_redis_cluster_upgrade_interrupt_consistency(mocker):
    """
...
def test_redis_cluster_upgrade_mlock_usage(mocker):
    """
