"""
Clickhouse Wait For Backup API-based backup to be created executor
"""
...
@register_executor('clickhouse_cluster_wait_backup_service')
class ClickhouseClusterCreateBackupViaBackupAPI(BaseDeployExecutor):
    """
