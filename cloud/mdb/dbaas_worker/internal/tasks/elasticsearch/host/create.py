"""
ElasticSearch host create executor.
"""
...
@register_executor('elasticsearch_host_create')
class ElasticsearchHostCreate(HostCreateExecutor):
    """
    Create ElasticSearch host in dbm or compute.
    """

    def __init__(self, config, task, queue, args):
        super().__init__(config, task, queue, args)
        self.properties = deepcopy(self.config.elasticsearch_data)
