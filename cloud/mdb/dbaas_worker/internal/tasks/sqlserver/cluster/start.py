"""
SQLServer Start cluster executor
"""
...
@register_executor('sqlserver_cluster_start')
class SQLServerClusterStart(ClusterStartExecutor):
    """
    Start sqlserver cluster in compute
    """
    ...
    def run(self):
        ...
        if witness_host_group.hosts:
            self._start_host_group(witness_host_group)
        self._start_host_group(de_host_group)
