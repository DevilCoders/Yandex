"""
PostgreSQL Wait For Backup API-based backup to be deleted
"""
...
@register_executor('postgresql_backup_delete')
class PostgresqlClusterDeleteBackup(BaseDeployExecutor):
    """
