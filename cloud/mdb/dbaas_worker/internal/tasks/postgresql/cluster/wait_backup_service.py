"""
PostgreSQL Wait For Backup API-based backup to be created executor
"""
...
@register_executor('postgresql_cluster_wait_backup_service')
class PostgresqlClusterCreateBackupViaBackupAPI(BaseDeployExecutor):
    """
