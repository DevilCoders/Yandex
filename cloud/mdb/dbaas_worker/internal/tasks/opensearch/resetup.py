"""
Opensearch Resetup host executor
"""
...
from .cluster.create import OpensearchClusterCreate as ClusterCreateTask
from .cluster.start import OpensearchClusterStart as ClusterStartTask
from .cluster.stop import OpensearchClusterStop as ClusterStopTask
from .host.create import OpensearchHostCreate as HostCreateTask
...
class OpensearchPortoReaddHost(PortoOnlineResetupHost):
...
class OpensearchComputeOnlineReaddHost(ComputeOnlineResetupHost):
    def get_create_executer(self) -> BaseCreateExecutor:
        args = self.get_create_host_args(self.cid, self.fqdn)
...
class OpensearchComputeOfflineReaddHost(ComputeOfflineResetupHost):
    def get_create_executer(self) -> BaseCreateExecutor:
...
class TaskType:
    opensearch_online = 'opensearch_cluster_online_resetup'
    opensearch_offline = 'opensearch_cluster_offline_resetup'


ROUTINE_MAP = {
    (EnvironmentName.PORTO, ResetupActionType.READD, TaskType.opensearch_online): OpensearchPortoReaddHost,
    (EnvironmentName.PORTO, ResetupActionType.READD, TaskType.opensearch_offline): OpensearchPortoReaddHost,
    (EnvironmentName.COMPUTE, ResetupActionType.READD, TaskType.opensearch_online): OpensearchComputeOnlineReaddHost,
    (EnvironmentName.COMPUTE, ResetupActionType.READD, TaskType.opensearch_offline): OpensearchComputeOfflineReaddHost,
}


@register_executor(TaskType.opensearch_online)
@register_executor(TaskType.opensearch_offline)
class OpensearchClusterResetup(BaseExecutor):
    """
    Opensearch redis host
    """
