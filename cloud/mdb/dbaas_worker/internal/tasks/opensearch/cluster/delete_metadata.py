"""
OpenSearch Delete Metadata cluster executor
"""
...
@register_executor('opensearch_cluster_delete_metadata')
class OpensearchClusterDeleteMetadata(ClusterDeleteMetadataExecutor):
    """
    Delete OpenSearch cluster metadata
    """
    ...
    def run(self):
        ...
        if master_hosts:
            ...
            master_host_group = build_host_group(self.config.opensearch_master, master_hosts)
        ...
        data_host_group = build_host_group(self.config.opensearch_data, data_hosts)
