"""
Opensearch Modify cluster executor
"""
...
@register_executor('opensearch_cluster_modify')
class OpensearchClusterModify(ClusterModifyExecutor, OpensearchExecutorTrait):
    """
    ...
    def run(self):
        """
        Run modify on opensearch hosts
        """
