...
// Source: a.yandex-team.ru/cloud/mdb/mdb-pillar-config/internal/auth (interfaces: Authenticator)
...
func (m *MockAuthenticator) Authenticate(arg0 context.Context, arg1 []string) error {
	m.ctrl.T.Helper()
