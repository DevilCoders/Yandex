...
# copy systemd units
install -d -m 0755 ${PREFIX}/${SYSTEMD_UNIT_DIR}
cp ${DISTRO_DIR}/*.service ${PREFIX}/${SYSTEMD_UNIT_DIR}
...
cp -r ${BUILD_DIR}/zookeeper-contrib/zookeeper-contrib-rest ${PREFIX}/${LIB_DIR}/contrib/rest
...
install -d -m 0755 ${PREFIX}/${LIB_DIR}/contrib
cp -r ${BUILD_DIR}/zookeeper-contrib/zookeeper-contrib-rest ${PREFIX}/${LIB_DIR}/contrib/rest
mv ${PREFIX}/${LIB_DIR}/contrib/rest/conf ${PREFIX}/${CONF_DIST_DIR}/rest
