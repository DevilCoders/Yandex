...
{% set spark_driver_memory = salt['ydputils.get_spark_driver_memory']() %}
{% set spark_yarn_am_cores = salt['ydputils.get_yarn_appmaster_cores']() %}
{% set spark_yarn_am_memory = salt['ydputils.get_yarn_appmaster_memory']() %}
{% set spark_executor_cores = salt['ydputils.get_spark_executor_cores']() %}
{% set spark_executor_memory = salt['ydputils.get_spark_executor_memory']() %}
