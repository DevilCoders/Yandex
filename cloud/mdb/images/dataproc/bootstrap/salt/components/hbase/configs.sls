...
{% import 'components/hbase/hbase-policy.sls' as policy with context %}
{{ hbase_config_path }}/hbase-policy.xml:
    hadoop-property.present:
        - config_path: {{ hbase_config_path }}/hbase-policy.xml
        - properties:
            {{ policy.config_site['hbase-policy'] | json }}
