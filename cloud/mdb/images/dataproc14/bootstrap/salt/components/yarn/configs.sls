...
{% import 'components/yarn/yarn-site.sls' as c with context %}
...
patch-{{ hadoop_config_path }}/yarn-env.sh:
    file.append:
        ...
        - text:
            ...
            - 'YARN_OPTS="${YARN_OPTS} -Djava.net.preferIPv6Stack=false -Djava.net.preferIPv4Stack=true"'
...
spark-patch-{{ hadoop_config_path }}/yarn-env.sh:
    file.append:
        ...
        - text:
            ...
            - 'YARN_USER_CLASSPATH="/usr/lib/spark/yarn/*:${YARN_USER_CLASSPATH}"'
        - require:
            - pkg: spark_packages
