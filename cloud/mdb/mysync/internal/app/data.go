...
var (
	ErrNoMaster      = xerrors.NewSentinel("no alive master found")
	ErrManyMasters   = xerrors.NewSentinel("more than one master found")
	ErrNoActiveNodes = xerrors.NewSentinel("no active nodes found")
)
