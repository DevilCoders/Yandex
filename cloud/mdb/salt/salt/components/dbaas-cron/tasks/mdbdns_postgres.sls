...
/etc/dbaas-cron/modules/mdbdns_postgres.py:
    file.managed:
        - source: salt://components/dbaas-cron/conf/mdbdns_postgres.py
        - mode: '0640'
        - user: root
        - group: monitor
        - require:
...
/etc/dbaas-cron/conf.d/mdbdns_upper.conf:
    file.absent:
        - require_in: /etc/dbaas-cron/conf.d/mdbdns_postgres.conf

/etc/dbaas-cron/conf.d/mdbdns_postgres.conf:
    file.managed:
        - template: jinja
