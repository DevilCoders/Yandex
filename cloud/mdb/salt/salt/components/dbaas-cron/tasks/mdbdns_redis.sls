...
/etc/dbaas-cron/modules/mdbdns_redis.py:
    file.managed:
        - template: jinja
        - source: salt://components/dbaas-cron/conf/mdbdns_redis.py
        - mode: '0640'
        - user: root
        - group: monitor
        - require:
...
/etc/dbaas-cron/conf.d/mdbdns_upper.conf:
    file.absent:
        - require_in:
            - file: /etc/dbaas-cron/conf.d/mdbdns_redis.conf

/etc/dbaas-cron/conf.d/mdbdns_redis.conf:
    file.managed:
        - template: jinja
