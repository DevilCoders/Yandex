...
/etc/wal-g/wal-g.yaml:
    file.managed:
        ...
        - mode: 640
        - require:
            - test: greenplum-walg-config-req
        - require_in:
            - test: greenplum-walg-config-ready
...
/etc/wal-g-create-restore-point.conf:
    file.managed:
        - source: salt://{{ slspath }}/conf/wal-g-create-restore-point.conf
        - template: jinja
        - mode: 644
