# common certs between nginx opensearch and kibana in /etc/opensearch/certs
/etc/nginx/ssl:
    file.absent
...
nginx-service:
    service:
        ...
        - watch:
            ...
            - file: /etc/opensearch/certs/server.crt
...
{% if salt.pillar.get('data:opensearch:dashboards:enabled', False) %}
    file.managed:
        - makedirs: True
        - template: jinja
