...
def queue_command():
    try:
        die(0, zk_mntr()['zk_outstanding_requests'])
    except Exception as e:
        die(1, str(e))
...
def descriptors_command():
    try:
        die(0, zk_mntr()['zk_open_file_descriptor_count'])
    except Exception as e:
        die(1, str(e))
