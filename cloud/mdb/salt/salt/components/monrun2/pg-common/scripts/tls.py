...
def main():
    ...
    for port in args.PAIRS:
        ...
        try:
            ...
            certificate, ssock = get_certificate_from_socket(sock)
            ...
            if ssock:
                try:
                    ...
                    pass  # It seems that unwrap() doesn't work with Odyssey. Just close it
            if sock:
                sock.close()
...
def get_args():
    ...
    parser.add_argument(
        ...
        help='PostgreSQL certificate port:file')
    parser.add_argument(
