...
def fill_timezones(log, defaults_file, high_port=HIGH_PORT):
    log.info("filling timezones")
    cmd = """
        mysql_tzinfo_to_sql /usr/share/zoneinfo | mysql --defaults-file={mycnf} --port={port} mysql
...
def main():
    ...
    try:
        ...
        fill_timezones(log, args.defaults_file, args.port)
