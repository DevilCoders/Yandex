...
data:
    ...
    dbaas:
        vtype: compute
    dbaas-e2e:
        api_url: 'https://mdb.private-api.cloud.yandex.net'
        grpc_api_url: mdb-internal-api.private-api.cloud.yandex.net:443
        test_hadoop: True
        ...
        test_cases:
            compute-prod:
                ...
                network_id: enpfpe6rnmo0n39i3tk7
                subnet_id: b0cr1oju4805li8pos3b
                dualstack_network_id: ""
                dualstack_subnet_id: ""
                log_file: /var/log/monrun/dbaas-e2e-compute-prod.log
                dbname: dbaas_e2e_compute_prod
                api_client: internal
                iam:
                    host: ts.private-api.cloud.yandex.net:4282
                    cert_file: /opt/yandex/allCAs.pem
                sa_creds:
                    service_account_id: aje9me5qd4mld64qt20n
                    id: aje5460sif06q6cd2ig2
                    private_key: |
                        {{ salt.yav.get('ver-01ek2k20tm5nmmz0n4gxrhw7qv[private_key]') | indent(24) }}
                flavor: b2.medium
                ...
                hadoop_log_group_id: e23tdd242td7glis7kg3
