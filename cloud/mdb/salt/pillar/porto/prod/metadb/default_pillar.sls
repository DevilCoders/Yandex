        ...
        value:
          ...
          data:
            ...
            logship:
              use_rt: false
              topics:
                security_log: mdb/porto/prod/security-log
              tvm:
                client_id: 2018952
                server_id: 2001059
                secret:
                  data: {{ salt.yav.get('ver-01e61n78k30g61mc870rgweyyr[tvm_secret]') }}
            ...
            mdb_int_api:
              address: mdb-internal-api.db.yandex.net
            certs:
              readonly: True
            use_mdbsecrets: True
            monrun2: true
            ...
            s3:
              access_key_id:
                data: {{ salt.yav.get('ver-01fvtqb12bqr6r8brn8g369p8f[encrypted_id]') }}
                encryption_version: 1
              access_secret_key:
                data: {{ salt.yav.get('ver-01fvtqb12bqr6r8brn8g369p8f[encrypted_secret]') }}
                encryption_version: 1
