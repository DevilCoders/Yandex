      ...
      - type: clickhouse_cluster
        value:
          data:
            ...
            logship:
              topics:
                clickhouse_logs: mdb/porto/test/clickhouse-logs
            backup:
              start:
                hours: 23
                minutes: 0
      ...
      - type: mongodb_cluster
        value:
          data:
            ...
            logship:
              topics:
                mongodb_logs: mdb/porto/test/mongodb-logs
                mongodb_audit_logs: mdb/porto/test/mongodb-audit-logs
            perf_diag:
              tvm_secret:
                data: {{ salt.yav.get('ver-01e9dzjxfy1q4xt26p2mkyrfvf[secret]') }}
                encryption_version: 1
              topics:
                mongodb-profiler: mdb/porto/test/perf_diag/mongodb_profiler
              tvm_client_id: 2016993
      ...
      - type: redis_cluster
        value:
          data:
            ...
            logship:
              topics:
                redis_logs: mdb/porto/test/redis-logs
            backup:
              start:
                hours: 22
                minutes: 0
          ...
          firewall:
            ...
            - int: eth0
              net: ::/0
              ports_function: mdb_redis.get_public_ports
              type: addr6
            - int: eth0
              net: 0.0.0.0/0
              ports_function: mdb_redis.get_public_ports
            ...
            policy: ACCEPT
            ports:
              external: ['6379', '26379', '6380', '26380']
      - type: postgresql_cluster
        value:
          data:
            ...
            logship:
              topics:
                postgresql_logs: mdb/porto/test/postgresql-logs
                pgbouncer_logs: mdb/porto/test/pgbouncer-logs
                odyssey_logs: mdb/porto/test/odyssey-logs
            perf_diag:
              tvm_secret:
                data: {{ salt.yav.get('ver-01e9dzjxfy1q4xt26p2mkyrfvf[secret]') }}
                encryption_version: 1
              topics:
                pg_stat_activity: mdb/porto/test/perf_diag/pg_stat_activity
                pg_stat_statements: mdb/porto/test/perf_diag/pg_stat_statements
                pg_stat_statements_query: mdb/porto/test/perf_diag/pg_stat_statements_query
                grpc_pg_stat_activity: mdb/porto/test_rt/perf_diag/pg_stat_activity
                grpc_pg_stat_statements: mdb/porto/test_rt/perf_diag/pg_stat_statements
              tvm_client_id: 2016993
              tvm_server_id: 2001059
            backup:
              start:
      ...
      - type: mysql_cluster
        value:
          data:
            logship:
              topics:
                mysql_audit_logs: mdb/porto/test/mysql-audit-logs
                mysql_error_logs: mdb/porto/test/mysql-error-logs
                mysql_general_logs: mdb/porto/test/mysql-general-logs
                mysql_slow_logs: mdb/porto/test/mysql-slow-logs
            perf_diag:
              tvm_secret:
                data: {{ salt.yav.get('ver-01e9dzjxfy1q4xt26p2mkyrfvf[secret]') }}
                encryption_version: 1
              topics:
                my_sessions: mdb/porto/test/perf_diag/my_sessions
                my_statements: mdb/porto/test/perf_diag/my_statements
                grpc_my_sessions: mdb/porto/test_rt/perf_diag/my_sessions
                grpc_my_statements: mdb/porto/test_rt/perf_diag/my_statements
              tvm_client_id: 2016993
              tvm_server_id: 2001059
            backup:
              start:
        ...
        value:
          data:
            logship:
              use_rt: false
              topics:
                elasticsearch_logs: mdb/porto/test/elasticsearch-logs
                kibana_logs: mdb/porto/test/kibana-logs
            use_yasmagent: true
            mdb_metrics:
              main:
      ...
      - type: kafka_cluster
        value:
          data:
            ...
            common:
              dh: {{ salt.yav.get('ver-01fc4afdjsxrpdmbchdvxkms2f[dhparam]') | tojson }}
            logship:
              use_rt: false
              topics:
                kafka_logs: mdb/porto/test/kafka-logs
            kafka:
      ...
      - type: greenplum_cluster
        value:
          data:
            ...
            logship:
              topics:
                greenplum_logs: mdb/porto/test/greenplum-logs
                odyssey_logs: mdb/porto/test/greenplum-odyssey-logs
          firewall:
            ACCEPT:
            - int: eth0
              net: ::/0
