...
func TestDBSpecificPostgresql(t *testing.T) {

	tests := postgresql.GetTestServices()
	...
	for i, test := range tests {
		t.Run(fmt.Sprintf("%s status %d", test.Expected, i), func(t *testing.T) {
			...
			topology := generateClusterTopologyByHealth(metadb.PostgresqlCluster, cid, roles, health)
