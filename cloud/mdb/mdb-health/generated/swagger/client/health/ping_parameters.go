...
// WithXRequestID adds the xRequestID to the ping params
func (o *PingParams) WithXRequestID(xRequestID *string) *PingParams {
	o.SetXRequestID(xRequestID)
	return o
}

// SetXRequestID adds the xRequestId to the ping params
func (o *PingParams) SetXRequestID(xRequestID *string) {
