...
def clickhouse_reschedule_maintenance(
    cluster: ClusterInfo,
    ...
    """
    ensure_no_feature_flag('MDB_CLICKHOUSE_DISABLE_LEGACY_MAINTENANCE_API')
    ...
    return create_finished_operation_for_current_rev(
        operation_type=ClickhouseOperations.maintenance_reschedule,
        cid=cluster.cid,
