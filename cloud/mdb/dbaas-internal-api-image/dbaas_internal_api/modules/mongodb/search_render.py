# -*- coding: utf-8 -*-
"""
DBaaS Internal API MongoDB search attributes
"""
...
def mongodb_cluster_search_attributes(cluster: ClusterInfo) -> dict:
    """
    Collect MongoDB specific search attributes
    """
    pillar = MongoDBPillar.load(cluster.pillar)
    return {
