# -*- coding: utf-8 -*-
"""
DBaaS Internal API Redis cluster stop
"""
...
def redis_stop_cluster(cluster: ClusterInfo, **_) -> Operation:
    """
    Stop cluster
    """
    ensure_no_feature_flag('MDB_REDIS_DISABLE_LEGACY_CLUSTER_OPERATE_API')
    return create_operation(
        task_type=RedisTasks.stop,
        operation_type=RedisOperations.stop,
