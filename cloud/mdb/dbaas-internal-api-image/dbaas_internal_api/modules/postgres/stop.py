# -*- coding: utf-8 -*-
"""
DBaaS Internal API PostgreSQL cluster stop
"""
...
def postgresql_stop_cluster(cluster: ClusterInfo, **_) -> Operation:
    """
    Stop cluster
    """
    return create_operation(
        task_type=PostgresqlTasks.stop,
        operation_type=PostgresqlOperations.stop,
