# -*- coding: utf-8 -*-
"""
DBaaS Internal API MySQL cluster start
"""
...
def mysql_start_cluster(cluster: ClusterInfo) -> Operation:
    """
    Start cluster
    """
    return create_operation(
        task_type=MySQLTasks.start,
        operation_type=MySQLOperations.start,
