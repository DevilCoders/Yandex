...
if MYPY:
    ...
    from urllib4.poolmanager import PoolManager  # type: ignore
...
class HttpTransport(Transport):
    ...
    def __init__(
        ...
        self._retry = urllib4.util.Retry()
        self.options = options
    ...
    def _make_pool(
        ...
        if proxy:
            return urllib4.ProxyManager(proxy, **opts)
        else:
            return urllib4.PoolManager(**opts)
