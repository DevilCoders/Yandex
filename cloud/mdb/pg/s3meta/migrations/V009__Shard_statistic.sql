...
CREATE MATERIALIZED VIEW s3.shard_stat (
    ...
    deleted_objects_parts_count
        ...
        sum(coalesce(cc.simple_objects_count, 0))::bigint,
        sum(coalesce(cc.multipart_objects_count, 0))::bigint,
        sum(coalesce(cc.deleted_objects_count, 0))::bigint,
        sum(coalesce(cc.objects_parts_count, 0))::bigint,
        sum(coalesce(cc.deleted_objects_parts_count, 0))::bigint
    FROM s3.parts s
