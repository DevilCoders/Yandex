...
// Source: a.yandex-team.ru/cloud/mdb/mdb-pillar-secrets/internal/auth (interfaces: Authenticator)
...
func (m *MockAuthenticator) Authenticate(arg0 context.Context, arg1 ...cloudauth.Resource) (accessservice.Subject, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthenticatorMockRecorder) Authenticate(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
