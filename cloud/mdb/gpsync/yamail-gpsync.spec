...
Summary: Meta package for gpsync
...
/etc/init.d/gpsync
/etc/logrotate.d/gpsync
%dir /etc/gpsync/plugins
%attr(0400, root, root) /etc/sudoers.d/gpsync
%attr(0644, root, root) /etc/cron.d/wd-gpsync
%attr(0744, root, root) /etc/cron.yandex/wd_gpsync.py*
