...
func (o *DeleteTaskNoContent) Error() string {
	return fmt.Sprintf("[DELETE /walle/v1.4/tasks/{task_id}][%d] deleteTaskNoContent ", 204)
}
...
func (o *DeleteTaskDefault) Error() string {
	return fmt.Sprintf("[DELETE /walle/v1.4/tasks/{task_id}][%d] DeleteTask default  %+v", o._statusCode, o.Payload)
}
