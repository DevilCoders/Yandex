...
from tests.func import configuration
# This modules define stages to prepare the environment
from tests.func.helpers import compose, docker, templates

SESSION_STATE_CONF = os.environ['SESSION_FILE']
...
def _init_state(state_file=None):
    ...
    try:
        with open(state_file, 'rb') as session_conf:
            return pickle.load(session_conf)  # nosec
