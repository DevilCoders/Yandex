job("mdb-metrics-test"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/mdb-metrics-test/buildTimeGraph/png' />""")
    ...
    scm {
        git {
            remote {
                name('origin')
                url('ssh://robot-pgaas-ci@review.db.yandex-team.ru:9440/mdb/mdb-metrics.git')
    ...
    triggers {
        gerrit {
            ...
            project('mdb/mdb-metrics', 'reg_exp:.*')
        }
    }
