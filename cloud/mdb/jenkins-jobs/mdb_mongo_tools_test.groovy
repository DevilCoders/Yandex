job("mdb-mongo-tools-test"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/mdb-mongo-tools-test/buildTimeGraph/png' />""")
    ...
    scm {
        git {
            remote {
                name('origin')
                url('ssh://robot-pgaas-ci@review.db.yandex-team.ru:9440/mdb/mdb-mongo-tools.git')
    ...
    triggers {
        gerrit {
            ...
            project('mdb/mdb-mongo-tools', 'reg_exp:.*')
        }
    }
