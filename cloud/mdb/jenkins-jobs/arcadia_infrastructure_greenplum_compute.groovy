job("arcadia_infrastructure_greenplum_compute"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/arcadia_infrastructure_greenplum_compute/buildTimeGraph/png' />""")
    ...
    steps{
        ...
        shell('export PATH=$PATH:$(pwd)/arcadia/ && cd arcadia/cloud/mdb/dataproc-infra-tests && LC_ALL=en_US.UTF-8 make start_greenplum_env')
        shell('export PATH=$PATH:$(pwd)/arcadia/ && cd arcadia/cloud/mdb/dataproc-infra-tests && LC_ALL=en_US.UTF-8 make greenplum')
    }
