job("mdb-tune-competition-api-test"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/mdb-tune-competition-api-test/buildTimeGraph/png' />""")
    ...
    scm {
        git {
            remote {
                name('origin')
                url('ssh://robot-pgaas-ci@review.db.yandex-team.ru:9440/mdb/mdb-tune-competition-api.git')
    ...
    triggers {
        gerrit {
            ...
            project('mdb/mdb-tune-competition-api', 'reg_exp:.*')
        }
    }
