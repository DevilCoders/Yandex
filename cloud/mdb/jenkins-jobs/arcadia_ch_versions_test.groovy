job("arcadia-ch-versions-test"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/arcadia-ch-versions-test/buildTimeGraph/png' />""")
    ...
    steps {
        ...
        shell('cd arcadia/cloud/mdb/clickhouse/versions && PATH=$WORKSPACE/arcadia:$PATH make test')
        shell('''
