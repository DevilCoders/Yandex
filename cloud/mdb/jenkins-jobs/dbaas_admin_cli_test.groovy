job("dbaas-admin-cli-test"){
    description("""
<h2>Test time</h2>
<br/>
<img src='https://jenkins.db.yandex-team.ru/job/dbaas-admin-cli-test/buildTimeGraph/png' />""")
    ...
    scm {
        git {
            remote {
                name('origin')
                url('ssh://robot-pgaas-ci@review.db.yandex-team.ru:9440/mdb/dbaas-admin-cli.git')
    ...
    triggers {
        gerrit {
            ...
            project('mdb/dbaas-admin-cli', 'reg_exp:.*')
        }
    }
