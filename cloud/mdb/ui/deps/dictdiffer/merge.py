...
class Merger(object):
    ...
    def __init__(self, lca, first, second, actions, path_limits=[], additional_info=None):
    ...
    def extract_patches(self):
        ...
        *first_patches* and *second_patches*.
        """
        self.first_patches = list(diff(self.lca, self.first, path_limit=self.path_limit, expand=True))
        self.second_patches = list(diff(self.lca, self.second, path_limit=self.path_limit, expand=True))
    ...
    def find_conflicts(self):
        ...
        """
        self.conflicts = self.conflict_finder.find_conflicts(self.first_patches, self.second_patches)
    ...
    def resolve_conflicts(self):
        ...
        """
        try:
            self.resolver.resolve_conflicts(self.first_patches, self.second_patches, self.conflicts)
    ...
    def unify_patches(self):
        ...
        *unified_patches*.
        """
        self.unified_patches = self.unifier.unify(self.first_patches, self.second_patches, self.conflicts)
