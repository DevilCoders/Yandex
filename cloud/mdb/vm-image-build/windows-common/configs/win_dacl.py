...
def get_name(principal):
    ...
    if isinstance(principal, pywintypes.SIDType):
        sid_obj = principal
        if win32security.ConvertSidToStringSid(principal) == "S-1-15-3-1024-1065365936-1281604716-3511738428-1654721687-432734479-3232135806-4053264122-3456934681":
            sid_obj = win32security.ConvertStringSidToSid("S-1-0-0")
    else:
