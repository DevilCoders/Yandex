ALTER TABLE dbaas.clusters ADD COLUMN monitoring_cloud_id text DEFAULT NULL; 
ALTER TABLE dbaas.clusters_revs ADD COLUMN monitoring_cloud_id text DEFAULT NULL; 
...
DROP FUNCTION code.create_cluster;
...
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO backup_cli;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO cms;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO dbaas_api;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO dbaas_support;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO dbaas_worker;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO idm_service;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO katan_imp;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO logs_api;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO mdb_downtimer;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO mdb_health; 
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO mdb_maintenance;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO mdb_ui;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO pillar_config;
GRANT ALL ON FUNCTION code.create_cluster(i_cid text, i_name text, i_type dbaas.cluster_type, i_env dbaas.env_type, i_public_key bytea, i_network_id text, i_folder_id bigint, i_description text, i_x_request_id text, i_host_group_ids text[], i_deletion_protection boolean, i_monitoring_cloud_id text) TO pillar_secrets;
