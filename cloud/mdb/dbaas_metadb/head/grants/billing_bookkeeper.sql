...
GRANT SELECT ON TABLE dbaas.pillar TO billing_bookkeeper;
GRANT SELECT ON TABLE dbaas.folders TO billing_bookkeeper;
GRANT SELECT ON TABLE dbaas.clouds TO billing_bookkeeper;
GRANT SELECT ON TABLE dbaas.geo TO billing_bookkeeper;
GRANT SELECT ON TABLE dbaas.regions TO billing_bookkeeper;
GRANT SELECT ON TABLE dbaas.flavors TO billing_bookkeeper;
