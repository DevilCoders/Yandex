Feature: Targeted switchover
    ...
    Scenario Outline: Check targeted switchover
        ...
        And we set value "{"hostname": "pgsync_postgresql1_1.pgsync_pgsync_net", "timeline": 1, "destination": "pgsync_postgresql2_1.pgsync_pgsync_net"}" for key "/pgsync/postgresql/switchover/master" in <lock_type> "<lock_host>"
