...
CONTAINER_PORTS = {'pgsync': ['5432', '6432'], 'zookeeper': ['2181'], 'backup': ['873']}
...
def set_switchover(container, params):
    return container.exec_run('pgsync-util switchover -y {params}'.format(params=params))
