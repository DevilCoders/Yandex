...
type GetCertificateHandlerFunc func(GetCertificateParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCertificateHandlerFunc) Handle(params GetCertificateParams) middleware.Responder {
	return fn(params)
}

// GetCertificateHandler interface for that can handle valid get certificate params
type GetCertificateHandler interface {
	Handle(GetCertificateParams) middleware.Responder
}
...
/* GetCertificate swagger:route GET /v1/cert certs getCertificate
