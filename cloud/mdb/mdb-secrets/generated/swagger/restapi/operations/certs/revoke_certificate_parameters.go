...
func (o *RevokeCertificateParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RevokeCertificateParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RevokeCertificateParams) bindHostname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
