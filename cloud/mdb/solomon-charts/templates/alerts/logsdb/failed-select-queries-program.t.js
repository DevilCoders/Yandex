...
let failed_queries = series_max({<< common_selectors >>, name='ch_system_events_FailedSelectQuery_rate'});
let total_queries  = series_max({<< common_selectors >>, name='ch_system_events_SelectQuery_rate'});
