...
// WithAuthorization adds the authorization to the create group params
func (o *CreateGroupParams) WithAuthorization(authorization *string) *CreateGroupParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the create group params
func (o *CreateGroupParams) SetAuthorization(authorization *string) {
	o.Authorization = authorization
}

// WithXRequestID adds the xRequestID to the create group params
func (o *CreateGroupParams) WithXRequestID(xRequestID *string) *CreateGroupParams {
	o.SetXRequestID(xRequestID)
	return o
}

// SetXRequestID adds the xRequestId to the create group params
func (o *CreateGroupParams) SetXRequestID(xRequestID *string) {
