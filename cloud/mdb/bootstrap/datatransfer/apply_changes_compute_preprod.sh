...
do
    ...
    python3 cli.py --conf config/compute-preprod/${service}.yaml create
    python3 cli.py --conf config/compute-preprod/${service}.yaml start
    python3 cli.py --conf config/compute-preprod/${service}.yaml drop-orphans
done
