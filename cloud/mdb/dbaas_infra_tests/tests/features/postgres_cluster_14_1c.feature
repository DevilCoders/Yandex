@dependent-scenarios
Feature: Internal API PostgreSQL 14-1c Cluster lifecycle
  ...
  Background: Wait until internal api is ready
    ...
    And we are working with standard 14-1c PostgreSQL cluster

  @setup
  Scenario: PostgreSQL cluster created successfully
    Given feature flag "MDB_POSTGRESQL_14_1C" is set
