@dependent-scenarios
Feature: Internal API PostgreSQL Cluster upgrade from 11 to 12
  ...
  @setup
  Scenario: PostgreSQL cluster with version 11 and enabled feature flag creation works
  ...
  Scenario: Upgrade PostgreSQL cluster to version 12 works
    Given cluster "test_cluster" is up and running
