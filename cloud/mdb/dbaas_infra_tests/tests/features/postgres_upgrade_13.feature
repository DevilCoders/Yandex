@dependent-scenarios
Feature: Internal API PostgreSQL Cluster upgrade from 12 to 13
  ...
  Background: Wait until internal api is ready
    ...
    And we are working with standard 12 PostgreSQL cluster

  @setup
  Scenario: PostgreSQL cluster with version 12 and enabled feature flag creation works
  ...
  Scenario: Upgrade PostgreSQL cluster to version 13 works
    Given cluster "test_cluster" is up and running
