@dependent-scenarios
Feature: Internal API Redis 6 Single lifecycle
  ...
  Background: Wait until internal api is ready
    ...
    And we are working with single_instance_6 Redis cluster
  ...
  Scenario: Redis single instance task reject zero slowlog_slower_then
    ...
    """
    Then response should have status 422 and body contains "slowlogLogSlowerThan: Must be between 10 and"
  ...
  Scenario: Upgrade Redis single instance to 6.2
