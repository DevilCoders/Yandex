@dependent-scenarios
Feature: Internal API Redis Cluster lifecycle
  ...
  Background: Wait until internal api is ready
    ...
    And we are working with standard Redis cluster
  ...
  Scenario: Rename Redis cluster
    ...
    And generated task has description "Modify Redis cluster"
  ...
  @backups
  Scenario: Redis backups (5.0 to 6.0)
    Given cluster "test_redis" is up and running
  ...
  Scenario: Upgrade Redis cluster to 6.0
