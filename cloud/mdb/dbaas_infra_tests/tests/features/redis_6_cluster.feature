...
Feature: Internal API Redis 6 Cluster lifecycle
  ...
  Background: Wait until internal api is ready
    ...
    And we are working with standard_6 Redis cluster
  ...
  @backups
  Scenario: Redis backups (6.0 to 6.0, tls mode off to off)
    Given cluster "test_redis" is up and running
  ...
  @backups
  Scenario: Redis backups (tls mode off to on, 6.0 to 6.2)
