...
TerraformRunningProcess = namedtuple("TerraformProcess", ["process"])
TerraformFinishedProcessResult = namedtuple("TerraformProcessResult", ["return_code", "stdout", "stderr"])
TerraformCommandResult = Union[TerraformRunningProcess, TerraformFinishedProcessResult]
...
class Terraform:
    ...
    def apply(
        ...
        **kwargs,
        ...
        args = self._generate_default_args(plan)
        return self.cmd("apply", *args, **option_dict)

    def _generate_default_args(self, plan: Optional[str]) -> Sequence[str]:
    ...
    def destroy(self, auto_approve: Type[TerraformFlag] = IsFlagged, **kwargs) -> TerraformCommandResult:
        ...
        return self.cmd("destroy", **options)

    def plan(self, detailed_exitcode: Type[TerraformFlag] = IsFlagged, **kwargs) -> TerraformCommandResult:
    ...
    def generate_cmd_string(self, cmd: str, *args, **kwargs) -> List[str]:
        ...
        --> generate_cmd_string call:
                terraform -chdir=the_folder apply -var='a=b' -var='c=d' -no-color
        --> python call:
                tf.generate_cmd_string('apply', chdir=the_folder, no_color=IsFlagged, var={'a':'b', 'c':'d'})
    ...
    def cmd(
        ...
        **kwargs,
        ...
        if not synchronous:
            return TerraformRunningProcess(p)
        ...
        return TerraformFinishedProcessResult(ret_code, out, err)
    ...
    def set_workspace(self, workspace, *args, **kwargs) -> TerraformCommandResult:
        """Set workspace
    ...
    def create_workspace(self, workspace, *args, **kwargs) -> TerraformCommandResult:
        """Create workspace
    ...
    def delete_workspace(self, workspace, *args, **kwargs) -> TerraformCommandResult:
        """Delete workspace
    ...
    def show_workspace(self, **kwargs) -> TerraformCommandResult:
