...
func (r registryWrapper) FuncCounter(name string, function func() int64) {
	r.registry.FuncCounter(r.nameProcessor(name), function)
}
...
func (r registryWrapper) FuncGauge(name string, function func() float64) {
	r.registry.FuncGauge(r.nameProcessor(name), function)
}
