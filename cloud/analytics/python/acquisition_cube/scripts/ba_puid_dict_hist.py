#!/usr/bin/env python2
# -*- coding: utf-8 -*-
import pandas as pd, datetime, ast,  json, requests, os, time
...
def execute_query(query, cluster, alias, token, timeout=12000):
...
def chyt_execute_query(
    ...
    print("sleeping 30 seconds to avoid chyt lag")
    time.sleep(30)
    i = 0
    while True:
        try:
...
def main(prod):
    ...
    if not prod:
        ...
        tables_cube_tmp_dir = "//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp".format(folder)
    elif prod:
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/clouds'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/offers'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/segments'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/passports'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_puid_dict_'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_puid_dict_hist'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/sku_dict'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_puid_dict'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/bas'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/puid_set_'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/puid_set'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_became_paid'.format(folder)))
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_trial_consumption'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_trial_consumption'.format(folder)))
    ...
    GROUP BY
        ...
        event
    '''.format(paths_dict['billing_records_path'], folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_paid_consumption'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_paid_consumption'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_payment'.format(folder)))



    ba_tables = [
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/bas'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_paid_consumption'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_payment'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/first_trial_consumption'.format(folder),
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_set_'.format(folder)))
    ...
    print(datetime.datetime.now())
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/sources/tmp/ba_set'.format(folder)))
    ...
    SELECT
        ...
        core_fraction_number as sku_tag_core_fraction_number,
        cores as sku_tag_cores,
        cores_number as sku_tag_cores_number,
        ram as sku_tag_ram,
        ram_number as sku_tag_ram_number,
    ...
    with open('output.json', 'w') as f:
        json.dump({"tables": tables_to_save
        }, f)
