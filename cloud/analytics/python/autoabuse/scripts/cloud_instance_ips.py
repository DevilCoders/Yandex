...
def main(write):
    ...
    $result_table_latest_time = 
        '//home/cloud_analytics/import/network-logs/autoabuse/latest_time';
    ...
    SELECT *
    FROM $stats('//logs/yc-antifraud-overlay-flows-stats/1h', '2021-03-18');
