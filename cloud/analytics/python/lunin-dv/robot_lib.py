...
def _raw_grafana_execute_query(query):
...
def _raw_chyt_execute_any_query(query, request_func, columns=None):
    '''
    Executes any query (CHYT or grafana), returns pd.DataFrame
...
def execute_query_body(query, request_func, columns=None):
    df = _raw_chyt_execute_any_query(query, request_func, columns)
...
def execute_query(query, columns=None):
    ...
    """
    return execute_query_body(query, _raw_execute_yt_query, columns)
...
def grafana_execute_query(query, columns=None):
    ...
    :return: pandas dataframe, the result of query
    """
    return execute_query_body(query, _raw_grafana_execute_query, columns)
