...
def main():
    ...
    if mode == 'test':
        ...
        tables_dir = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources".format(folder)
    elif mode == 'prod':
    ...
    offers_path = get_last_not_empty_table('//home/logfeller/logs/yc-pre-billing-export-monetary-grant-offers/1h', job)
    grants_path = get_last_not_empty_table('//home/logfeller/logs/yc-pre-billing-export-monetary-grants/1h', job)

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/promocodes" ENGINE=YtTable() AS
    --INSERT INTO "<append=%false>//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/promocodes"
    SELECT
        duration,
        id as promocode_id,
    ...
    path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/promocodes".format(folder)
    print(query)
    chyt_execute_query(
        query=query,
        cluster=cluster,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/grants" ENGINE=YtTable() AS
    --INSERT INTO "<append=%false>//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/grants"
    SELECT
        id as grant_id,
        billing_account_id,
    ...
    path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/grants".format(folder)
    ...
    for sample in range(offset):
        if sample == 0:
            fr_query = 'CREATE TABLE "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/ba_history_" ENGINE = YtTable() AS\n'.format(folder)
        else:
            fr_query = 'INSERT INTO "<append=%true>//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/ba_history_"\n'.format(folder)
        query = '''
            SELECT
                multiIf(
        ...
        if sample == 0:
            path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/ba_history_".format(folder)
            chyt_execute_query(
                query=query,
                cluster=cluster,
                alias=alias,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/sales_history_" ENGINE=YtTable() AS
    --INSERT INTO "<append=%false>//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/sales_history_"
    SELECT
        billing_account_id,
        days_ as date,
        sales_name,
    ...
    FROM(
        ...
        FROM(
            ...
            FROM (SELECT * FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/account_sales_changes_schema" ORDER BY event_time DESC)
            GROUP BY
                billing_account_id,
                date
            ORDER BY
    ...
    path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/sales_history_".format(folder)
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist_" ENGINE=YtTable() AS
    --INSERT INTO "<append=%false>//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist_"
    SELECT
        block_reason,
        unblock_reason,
        is_verified,
    ...
    FROM(
        ...
        FROM(
            SELECT
                t0.*,
                multiIf(
                    sales_name IN ('golubin', 'datishin', 'sergeykn', 'alexche', 'amashika'), sales_name,
                ...
                multiIf(
                    ...
                    master_account_id != '' AND master_account_id IS NOT NULL, 'VAR',
                    sales_name IN ('golubin', 'datishin', 'sergeykn', 'alexche', 'amashika'), 'Enterprise',
            ...
            FROM(
                SELECT
                    *
                FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_history_"
            ) as t0
            ANY LEFT JOIN (
                SELECT
                    billing_account_id,
                    ...
                    architects,
                    potential
                FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/sales_history_"
            ) as t1
            ON t0.billing_account_id = t1.billing_account_id AND t0.date = t1.date
        ) as gen
        ANY LEFT JOIN(
                    ...
                    billing_account_id,
                    groupArray(account_name)[1] as account_name
                FROM (SELECT * FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/sales_history_" ORDER BY date DESC)
                GROUP BY
                    billing_account_id
        ) as acc_name
    ...
    path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist_".format(folder)
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist" ENGINE=YtTable() AS
    --INSERT INTO "<append=%false>//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist"
    SELECT
        source_1.*,
    ...
    FROM(
        ...
        FROM(
            ...
            FROM(
                SELECT
                    *
                FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist_"
            ) as t0
            ANY LEFT JOIN (
                SELECT
                    t2.*,
    ...
    ANY LEFT JOIN (
        ...
        FROM(
            ...
            FROM(
                ...
                FROM "//home/{1}/cooking_cubes/acquisition_cube/preprod/sources/grants"
                WHERE
    ...
    path = "//home/{0}/cooking_cubes/acquisition_cube/preprod/sources/ba_hist".format(folder)
