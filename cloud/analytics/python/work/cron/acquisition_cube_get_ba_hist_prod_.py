    ...
    FROM(
        ...
        FROM(
            SELECT
                t0.*,
                multiIf(
                    sales_name IN ('kevdok','golubin', 'datishin', 'sergeykn', 'alexche', 'amashika', 'glebmarkevich', 'kalifornia', 'mikhaylenko', 'andreigusev','obelkin', 'dmkonovalov', 'pavelio', 'ebelobrova','niktk', 'maxtsygankov', 'dkharlamov', 'andreieremin'), sales_name,
                    feature_flags LIKE '%"isv": true%' AND (NOT match(sales_name, '(andreigusev|niktk|ebelobrova|maxtsygankov|pavelio|dmkonovalov)') OR sales_name IS NULL), 'marinapolik',
                ...
                multiIf(
                    sales_name IN ('golubin', 'datishin', 'sergeykn', 'alexche', 'amashika', 'kevdok', 'bogachenko', 'lexponomareva'), 'Enterprise',
                    sales_name IN ('andreigusev','obelkin', 'dmkonovalov', 'pavelio', 'ebelobrova','niktk', 'maxtsygankov', 'bayazitov') OR billing_account_id IN ('dn2dtdnj2i6beqsbiq4q','dn2iiqtf27l25b8pr0to'), 'Large ISV',
                    --sales_name IN ('ebelobrova','niktk', 'maxtsygankov'), 'ISV ML',
                    sales_name IN ('glebmarkevich','kalifornia', 'mikhaylenko', 'dkharlamov', 'andreieremin'), 'Medium',
