...
def main():
    ...
    if mode == 'test':
        ...
        tables_cube_tmp_dir = "//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp".format(folder)
    elif mode == 'prod':
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/clouds" ENGINE = YtTable() AS
    SELECT
        t0.*,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/clouds'.format(folder)
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/clouds'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/offers" ENGINE = YtTable() AS
    SELECT
        passport_uid as puid,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/offers'.format(folder)
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/offers'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/segments" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/segments'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/segments'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/passports" ENGINE = YtTable() AS
    SELECT
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/passports'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/passports'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_" ENGINE = YtTable() AS
    SELECT
        ba_of_se.*,
        balance_name,
        balance_long_name
        ...
        FROM(
            ...
            ANY LEFT JOIN(
                SELECT
                    ...
                    promocode_source,
                    promocode_client_type
                FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/offers"
            ) as of
            ON ba.puid = of.puid
        ) as ba_of
        ANY LEFT JOIN(
            SELECT
                ...
                active_grant_ids,
                active_grants
            FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/segments"
        ) as se
    ...
    ANY LEFT JOIN(
        SELECT
            ...
            balance_name,
            balance_long_name
        FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/passports"
    ) as pa
    ON ba_of_se.puid = pa.puid
    '''.format(paths_dict['billing_accounts_path'], folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_hist" ENGINE = YtTable() AS
    SELECT
        DISTINCT
        ba_of_cl.*,
        balance_name,
    ...
    FROM(
        ...
        ANY LEFT JOIN(
            SELECT
                ...
                mail_billing,
                is_corporate_card
            FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/clouds"
        ) as cl
    ...
    '''.format(paths_dict['ba_hist'], folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_hist'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_hist'.format(folder)))

    query = '''
    CREATE TABLE "//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod_" ENGINE = YtTable() AS
    SELECT
        DISTINCT
        t0.*,
    ...
    FROM(
        SELECT
            ...
            balance_name,
            balance_long_name
        FROM "//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_hist"
    ) as t0
    ANY LEFT JOIN(
            SELECT
            billing_account_id,
    ...
    '''.format(folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod_'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod_'.format(folder)))

    try:
        cluster.driver.remove('//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod'.format(folder))
    except:
        pass
    cluster.driver.copy(
        '//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod_'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod'.format(folder)
    )
    cluster.driver.remove('//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_preprod_'.format(folder))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/sku_dict" ENGINE = YtTable() AS
    SELECT
        t0.*,
        service_long_name,
        subservice_name,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/sku_dict'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/sku_dict'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict" ENGINE = YtTable() AS
    SELECT
        t0.*,
        email,
        first_name,
    ...
    FROM(
        SELECT
            *
        FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict_"
    ) as t0
    ANY LEFT JOIN(
        SELECT
            email,
    ...
    ON t0.puid = t1.puid
    '''.format('', folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/bas" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
        'ba_created' as event,
        toString(toDateTime(ba_created_at), 'Etc/UTC') as event_time
    FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_puid_dict"
    '''.format('', folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/bas'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/bas'.format(folder)))

    puid_tables = [
        paths_dict['visits_path'],
        paths_dict['calls'],
        paths_dict['click_email'],
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/clouds'.format(folder)
    ]
    puid_schema = get_result_schema(puid_tables, cluster)
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set_" ENGINE = YtTable() AS
    {0}
    '''.format(
        'UNION ALL\n'.join(make_query_for_union(puid_schema, get_yt_table_schema(table, cluster), table) for table in puid_tables),
        folder
    )
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set_'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set_'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set" ENGINE = YtTable() AS
    SELECT
        t0.*,
        billing_account_id,
        ba_created_at,
    ...
    FROM(
        SELECT
            *
        FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set_"
    ) as t0
    ANY LEFT JOIN(
        SELECT
            *
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_became_paid" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_became_paid'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_became_paid'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_trial_consumption" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_trial_consumption'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_trial_consumption'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_paid_consumption" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
    ...
    GROUP BY
        ...
        event
    '''.format(paths_dict['billing_records_path'], folder)
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_paid_consumption'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_paid_consumption'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_payment" ENGINE = YtTable() AS
    SELECT
        billing_account_id,
    ...
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_payment'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_payment'.format(folder)))



    ba_tables = [
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/bas'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_paid_consumption'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_payment'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/first_trial_consumption'.format(folder),
        '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_became_paid'.format(folder)
    ]
    ba_schema = get_result_schema(ba_tables, cluster)
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set_" ENGINE = YtTable() AS
    {0}
    '''.format(
        'UNION ALL\n'.join(make_query_for_union(ba_schema, get_yt_table_schema(table, cluster), table) for table in ba_tables),
        folder
    )
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set_'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set_'.format(folder)))

    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set" ENGINE = YtTable() AS
    SELECT
        ba_ba_dict.*,
        name,
        service_id,
    ...
    FROM(
        ...
        FROM(
            SELECT
                *
            FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set_"
        ) as ba
        ANY LEFT JOIN(
            SELECT
                *
    ...
    ANY LEFT JOIN(
        SELECT
            *
        FROM "//home/{1}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/sku_dict"
    ) as sku
    ON ba_ba_dict.sku_id = sku.sku_id
    '''.format('', folder, paths_dict['billing_accounts_path'])
    path = '//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set'.format(folder)
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set'.format(folder)))

    from acquisition_cube_init_funnel_steps import schema_cube as schema
    job = cluster.job()
    job.concat(
        job.table('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/puid_set'.format(folder)),
        job.table('//home/{0}/cooking_cubes/acquisition_cube/without_history_part/preprod/sources/tmp/ba_set'.format(folder))
    ) \
    .project(
        **apply_types_in_project(schema)
    ) \
    .put('%s/%s_preprod_temp' % (paths_dict['cube_tmp'],str(datetime.datetime.today().date())), schema = schema)
    job.run()

    job = cluster.job()
    cube = job.table('%s/%s_preprod_temp' % (paths_dict['cube_tmp'],str(datetime.datetime.today().date()))) \
        .groupby(
            'puid'
        ) \
        .sort(
    ...
    cube \
    .put('%s/%s_preprod_to_validate' % (paths_dict['funnel_cube'],str(datetime.datetime.today().date())), schema = schema)
    job.run()
    ...
    FROM "{1}"
    '''.format(
        '%s/%s' % (paths_dict['funnel_cube'],'cube_without_history_part_preprod_'),
        '%s/%s_preprod_to_validate' % (paths_dict['funnel_cube'],str(datetime.datetime.today().date())),
    )
    path = '%s/%s' % (paths_dict['funnel_cube'],'cube_without_history_part_preprod_')
    chyt_execute_query(
        query=query,
        cluster=cluster_chyt,
        alias=alias,
    ...
    print("Done for {0}".format('%s/%s' % (paths_dict['funnel_cube'],'cube_without_history_part_preprod_')))



    job = cluster.job()
    stream = job.table('%s/%s' % (paths_dict['funnel_cube'],'cube_without_history_part_preprod_')) \
    .project(
        **apply_types_in_project(schema)
    )
    stream.put('%s/%s' % (paths_dict['funnel_cube'],'cube_without_history_part_preprod'), schema = schema)
    #stream.put('%s/%s_preprod' % (paths_dict['funnel_cube'],str(datetime.date.today())), schema = schema)
    job.run()

    tables_to_save = date_range_by_days(str(datetime.date.today() - datetime.timedelta(days = 90)), str(datetime.date.today())) + ['cube_without_history_part', 'cube_without_history_part_preprod']
