...
def main():
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/clouds" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/offers" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        passport_uid as puid,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/segments" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/passports" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_puid_dict_" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        ba_of_se.*,
        balance_name,
        balance_long_name
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_puid_dict_hist" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        ba_of_cl.*,
        balance_name,
        balance_long_name
    ...
    query = '''
    CREATE TABLE "//home/{0}/cooking_cubes/acquisition_cube/for_billing_cube/ba_puid_dict_hist_" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/sku_dict" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
        service_long_name,
        subservice_name,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_puid_dict" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
        email,
        first_name,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/bas" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
        'ba_created' as event,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/puid_set_" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    {0}
    '''.format(
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/puid_set" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
        billing_account_id,
        ba_created_at,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_became_paid" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/first_trial_consumption" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/first_paid_consumption" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/first_payment" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        billing_account_id,
    ...
    for sample in range(offset):
        if sample == 0:
            fr_query = '''CREATE TABLE "//home/{0}/cooking_cubes/acquisition_cube/sources/tmp/day_use_consumption" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS\n'''.format(folder)
        else:
        ...
        SELECT
            ...
            multiIf(
                t0.sku_id = 'dn2a572mhk1urociqg1i', toString(toDate(toDateTime(end_time))),
                toString(toDate(toDateTime(end_time)))
            ) as date,
        ...
        FROM(
            ...
            FROM(
                SELECT
                    *,
                    toString(toDate(toDateTime(end_time))) as date
                FROM "{0}"
                WHERE
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/day_use_payments" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.billing_account_id as billing_account_id,
        '' as sku_id,
        '' as cloud_id,
        date,
        toString(toDateTime(modified_at)) as event_time,
    ...
    for sample in range(offset):
        if sample == 0:
            fr_query = '''CREATE TABLE "//home/{0}/cooking_cubes/acquisition_cube/sources/tmp/ba_sets_hist" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS\n'''.format(folder)
        else:
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_set_" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    {0}
    '''.format(
    ...
    query = '''
    CREATE TABLE "//home/{1}/cooking_cubes/acquisition_cube/sources/tmp/ba_set" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        ba_ba_dict.*,
        name,
        service_id,
    ...
    try:
        ...
        pass
    query = '''
    CREATE TABLE "{0}" ENGINE = YtTable('{{primary_medium=ssd_blobs}}') AS
    SELECT
        t0.*,
        real_consumption,
        trial_consumption,
    ...
    if ok == 0:
        ...
        tables_to_save = date_range_by_days(str(datetime.date.today() - datetime.timedelta(days = 90)), str(datetime.date.today())) + ['cube', 'validation', 'ba_metadata', 'ba_history']
        ...
        requests.post('https://api.telegram.org/bot{0}/sendMessage?chat_id={1}&text={2}'.format(
            telebot_creds['value']['token'],
            telebot_creds['value']['chat_id'],
            '''Acquisition {0} cube: \nSandbox Task {1} Has Started!!! '''.format(mode, task_id)
            )
        )

        time.sleep(60)
        while True:
            url = 'https://sandbox.yandex-team.ru/api/v1.0/task?limit=100&author=ktereshin&id={0}'.format(task_id)
            response = requests.get(url, headers = headers)
            res = response.json()
            if len(res['items']) > 0:
                if res['items'][0]['status'] == u'EXECUTING':
                    print('qwertert')
                    time.sleep(300)
                    continue
                if res['items'][0]['status'] == u'SUCCESS':
                    break
                if res['items'][0]['status'] in [u'EXCEPTION', u'EXPIRED', u'FAILURE', u'TIMEOUT']:
                    requests.post('https://api.telegram.org/bot{0}/sendMessage?chat_id={1}&text={2}'.format(
                        telebot_creds['value']['token'],
                        telebot_creds['value']['chat_id'],
                        '''Acquisition {0} cube: \nSandbox Task Has Failed  With {1} Status!!! '''.format(mode, res['items'][0]['status'])
                        )
                    )
                    break

        if res['items'][0]['status'] not in [u'EXCEPTION', u'EXPIRED', u'FAILURE', u'TIMEOUT']:
