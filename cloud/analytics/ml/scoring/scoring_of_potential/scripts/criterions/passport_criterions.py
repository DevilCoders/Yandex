...
@timing
@click.command()
@click.option('--result_table_path', default='//home/cloud_analytics/scoring_of_potential/spark_criterions')
@click.option('--spark_path', default='//home/comdep-analytics/zedlaa/spark/all_2')
@click.option('--script', default='spark_criterions.sql')
def main(spark_path, result_table_path, script):
