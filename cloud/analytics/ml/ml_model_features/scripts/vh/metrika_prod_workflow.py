...
def main(local_src: bool = False,  is_prod: bool = False, with_start: bool = False, rebuild: bool = False) -> None:
    ...
    run_small_job_op(
        ...
        input=package,
        max_ram=128,
        script='scripts/metrika/metrika_prod_hits.py',
    ...
    run_small_job_op(
        ...
        input=package,
        max_ram=128,
        script='scripts/metrika/metrika_prod_visits.py',
        yt_token='robot-clanalytics-yt',
        yql_token='robot-clanalytics-yql',
        script_args=['--rebuild' if rebuild else '']
    )
    ...
    vh.run(
        ...
        keep_going=True,
        start=with_start,
        workflow_guid=('8b61c3df-91df-4929-9271-4c50c6653c82' if is_prod else None),
