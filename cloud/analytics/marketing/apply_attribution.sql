$script = @@
import numpy as np
def apply_attribution(events, target_event_ = 'ba_created'.encode('UTF-8'), attribution_type_ = 'last'.encode('UTF-8')):
    ...
    try:
        ...
        return []
    events_before_target = [e for e in events if (e[1].decode('UTF-8') in {'visit', 'marketing_event_application'}) 
...
def apply_attribution_all(events, target_event_ = 'ba_created'):
    target_event = target_event_.decode('UTF-8')
    attr_weights = []
...
$apply_attribution = Python3::apply_attribution(
    Callable<(List<Tuple<Uint64, String, Uint64, String>>,String, String)->List<Tuple<Uint64, String, Double>>>,
...
$apply_attribution_all = Python3::apply_attribution_all(
    Callable<(List<Tuple<Uint64, String, Uint64, String, String, String, String, String, String, String, String, String,  String, String, String, String, String>>,String)->List<Tuple<Uint64, String, Uint64, String, String, String, String, String, String, String, String, String, String, String, String, String, String,  List<Double>>>>,
