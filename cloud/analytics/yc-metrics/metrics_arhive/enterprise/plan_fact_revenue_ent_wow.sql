...
DEFINE SUBQUERY $plan_fact_revenue_ent_wow() AS
    ...
    DEFINE SUBQUERY $res($param,$period) AS
        SELECT 
            per as `date`,
            'plan_fact_revenue_ent_wow' as metric_id,
            'Plan Fact Revenue Ent WoW' as metric_name,
...
EXPORT $plan_fact_revenue_ent_wow;