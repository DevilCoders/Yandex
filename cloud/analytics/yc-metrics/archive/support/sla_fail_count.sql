...
<{Код
{{include href="https://a.yandex-team.ru/api/tree/blob/trunk/arcadia/cloud/analytics/yc-metrics/metrics/support/sla_fail_count.sql" formatter="yql"}}
}>
___DOC___*/
...
DEFINE SUBQUERY $sla_fail_count() AS
