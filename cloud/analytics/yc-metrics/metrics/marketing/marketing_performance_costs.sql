...
Сумма потраченная на Performance за указанный период по ((https://yt.yandex-team.ru/hahn/navigation?path=//home/marketing-data/money_log/v2/datasets/project_2 данным)) операционного маркетинга. 
<{Код
