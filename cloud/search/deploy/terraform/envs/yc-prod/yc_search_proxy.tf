...
// it is used in communal L7 decribed here https://a.yandex-team.ru/arc/trunk/arcadia/cloud/platform/selfhost/terraform/prod/l7/cpl-router/virtual_hosts.tf
