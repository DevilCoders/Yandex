locals {
  services = {
    yc_search_proxy = {
      ...
      image_id       = "fd8p5rkho1oti5b3lppa" # yc --profile search-prod compute image get-latest-from-family yc-search-base-1804
    }
    ...
    yc_search_marketplace_backend = {
      ...
      packet_name    = "yc-search-backend"
      packet_version = "0.9151479.trunk"
      image_id       = "fd8p5rkho1oti5b3lppa" # yc --profile search-preprod compute image get-latest-from-family yc-search-base-1804
    }
