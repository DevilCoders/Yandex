...
static const TMap<TString, NProto::EClientIpcType> IpcTypes = {
    { "grpc",  NProto::IPC_GRPC  },
    { "vhost", NProto::IPC_VHOST },
    { "nbd",   NProto::IPC_NBD   },
    { "nvme",  NProto::IPC_NVME  },
    { "scsi",  NProto::IPC_SCSI  },
    { "rdma",  NProto::IPC_RDMA  },
};
...
public:
        ...
        : TCommand(std::move(client))
    {
        ...
        auto ipcTypes = JoinSeq('|', GetKeys(IpcTypes));
