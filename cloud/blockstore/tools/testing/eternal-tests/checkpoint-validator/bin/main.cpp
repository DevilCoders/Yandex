#include <cloud/blockstore/client/lib/factory.h>
#include <cloud/blockstore/tools/testing/eternal-tests/checkpoint-validator/lib/validator.h>
...
public:
    ...
    int Run(int argc, const char* argv[])
    {
        ...
        STORAGE_INFO("Starting to reading all blocks");
