...
type CreateVolumeOpts struct {
	...
	IsSystem              bool
	EncryptionMode        protos.EEncryptionMode
...
func (client *safeClient) CreateVolume(
	...
	if opts != nil {
		...
		req.EncryptionSpec = &protos.TEncryptionSpec{
			KeyParam: &protos.TEncryptionSpec_Key{
				Key: &protos.TEncryptionKey{
					Mode: opts.EncryptionMode,
					KeyPath: &protos.TKeyPath{
						Path: &protos.TKeyPath_FilePath{
							FilePath: opts.EncryptionKeyFilePath,
						},
					},
				},
			},
...
func (client *safeClient) DestroyVolume(ctx context.Context, diskId string) error {
