...
func testDiscoveryClientDiscover(
	...
	client, err := discovery.DiscoverInstance(context.TODO())
...
func TestDiscoveryClientVolatileNetwork(t *testing.T) {
	...
	expectedRoute := []string{
		"host-1", "host-2", "host-3", "host-3", "host-1", "host-3", "host-4",
	}
...
func TestDiscoveryClientGoodOne(t *testing.T) {
	balancer := createBalancer([]string{"good"})
