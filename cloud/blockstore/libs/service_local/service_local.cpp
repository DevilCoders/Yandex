...
public:
    ...
    void CreateVolume(const TString& diskId, ui32 blockSize, ui64 blocksCount)
    {
        ...
        TFile fileData(MakeDataPath(diskId), EOpenModeFlag::CreateAlways);
...
public:
    ...
    TFuture<NProto::TCreateCheckpointResponse> CreateCheckpoint(
        TCallContextPtr ctx,
        std::shared_ptr<NProto::TCreateCheckpointRequest> request) override;

    TFuture<NProto::TDeleteCheckpointResponse> DeleteCheckpoint(
        TCallContextPtr ctx,
        std::shared_ptr<NProto::TDeleteCheckpointRequest> request) override;

    TFuture<NProto::TUploadClientMetricsResponse> UploadClientMetrics(
        TCallContextPtr ctx,
        std::shared_ptr<NProto::TUploadClientMetricsRequest> request) override;
};
...
TFuture<NProto::TCreateCheckpointResponse> TLocalService::CreateCheckpoint(
    TCallContextPtr ctx,
    std::shared_ptr<NProto::TCreateCheckpointRequest> request)
{
    Y_UNUSED(ctx);
    Y_UNUSED(request);
    return MakeFuture(NProto::TCreateCheckpointResponse());
}

TFuture<NProto::TDeleteCheckpointResponse> TLocalService::DeleteCheckpoint(
    TCallContextPtr ctx,
    std::shared_ptr<NProto::TDeleteCheckpointRequest> request)
{
    Y_UNUSED(ctx);
    Y_UNUSED(request);
    return MakeFuture(NProto::TDeleteCheckpointResponse());
}

TFuture<NProto::TUploadClientMetricsResponse> TLocalService::UploadClientMetrics(
    TCallContextPtr ctx,
