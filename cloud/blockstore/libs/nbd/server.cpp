...
public:
    ...
    TVector<TIncompleteRequest> GetIncompleteRequests()
    {
        ...
        return Handler->GetIncompleteRequests();
    }
...
public:
    ...
    TVector<TIncompleteRequest> GetIncompleteRequests()
    {
        ...
        return Connection->GetIncompleteRequests();
    }
...
public:
    ...
    TFuture<TVector<TIncompleteRequest>> GetIncompleteRequests()
    {
        return Executor->Execute([&] {
...
public:
        ...
        IServerHandlerFactoryPtr handlerFactory) override
    {
        ...
        return future.Apply([=] (const auto& f) mutable {
    ...
    {
        TVector<TFuture<TVector<TIncompleteRequest>>> futures;
        for (auto& executorThread: ExecutorThreads) {
            futures.push_back(executorThread->GetIncompleteRequests());
        }
