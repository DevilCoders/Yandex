...
public:
        ...
        TCont* cont) override
    {
        ...
        return ProcessRequests(ctx, reader, writer, cont);
    }
    ...
    TCont* cont)
{
    ...
    const auto cancelError = MakeError(E_CANCELLED, "Server is shutting down");
...
TVector<TIncompleteRequest> TServerHandler::GetIncompleteRequests()
{
