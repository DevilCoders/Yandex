...
Y_UNIT_TEST_SUITE(TDiskRegistryDatabaseTest)
{
    ...
    Y_UNIT_TEST(ShouldStoreDirtyDevices)
    {
        ...
        executor.WriteTx([&] (TDiskRegistryDatabase db) {
            ...
            db.UpdateDirtyDevice("uuid-2");
            db.UpdateDirtyDevice("uuid-3");
        });
        ...
        executor.ReadTx([&] (TDiskRegistryDatabase db) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(items.size(), 3);
            UNIT_ASSERT_VALUES_EQUAL(items[0], "uuid-1");
            UNIT_ASSERT_VALUES_EQUAL(items[1], "uuid-2");
            UNIT_ASSERT_VALUES_EQUAL(items[2], "uuid-3");
        });
    }
    ...
    Y_UNIT_TEST(ShouldDeleteDirtyDevices)
    {
        ...
        executor.ReadTx([&] (TDiskRegistryDatabase db) {
            ...
            UNIT_ASSERT_VALUES_EQUAL(items.size(), 2);
            UNIT_ASSERT_VALUES_EQUAL(items[0], "uuid-1");
            UNIT_ASSERT_VALUES_EQUAL(items[1], "uuid-3");
        });
    }
    ...
    Y_UNIT_TEST(ShouldStoreDisksToNotify)
    {
        ...
        executor.WriteTx([&] (TDiskRegistryDatabase db) mutable {
            db.AddDiskToNotify("disk-1");
            db.AddDiskToNotify("disk-2");
            db.AddDiskToNotify("disk-3");
        });

        executor.ReadTx([&] (TDiskRegistryDatabase db) mutable {
            TVector<TString> diskIds;
            UNIT_ASSERT(db.ReadDisksToNotify(diskIds));
        ...
        executor.WriteTx([&] (TDiskRegistryDatabase db) mutable {
            db.DeleteDiskToNotify("disk-1");
            db.DeleteDiskToNotify("disk-3");
        });
