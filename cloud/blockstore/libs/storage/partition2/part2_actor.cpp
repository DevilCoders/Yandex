...
bool TPartitionActor::HandleRequests(STFUNC_SIG)
{
    switch (ev->GetTypeRewrite()) {
        ...
        BLOCKSTORE_PARTITION2_REQUESTS_PRIVATE(BLOCKSTORE_HANDLE_REQUEST, TEvPartitionPrivate)
        BLOCKSTORE_PARTITION_COMMON_REQUESTS_PRIVATE(BLOCKSTORE_HANDLE_REQUEST, TEvPartitionCommonPrivate)
        BLOCKSTORE_PARTITION_REQUESTS_FWD_SERVICE(BLOCKSTORE_HANDLE_REQUEST, TEvService)
        BLOCKSTORE_PARTITION_REQUESTS_FWD_VOLUME(BLOCKSTORE_HANDLE_REQUEST, TEvVolume)
...
bool TPartitionActor::RejectRequests(STFUNC_SIG)
{
    switch (ev->GetTypeRewrite()) {
        ...
        BLOCKSTORE_PARTITION2_REQUESTS_PRIVATE(BLOCKSTORE_REJECT_REQUEST, TEvPartitionPrivate)
        BLOCKSTORE_PARTITION_REQUESTS_FWD_SERVICE(BLOCKSTORE_REJECT_REQUEST, TEvService)
        BLOCKSTORE_PARTITION_REQUESTS_FWD_VOLUME(BLOCKSTORE_REJECT_REQUEST, TEvVolume)
