...
#define BLOCKSTORE_PART_COMMON_SIMPLE_COUNTERS(xxx, ...)                       \
    ...
    xxx(ReadSuffer,             Generic, Permanent,                __VA_ARGS__)\
    xxx(WriteSuffer,            Generic, Permanent,                __VA_ARGS__)\
...
#define BLOCKSTORE_REQUEST_COUNTER(name, ...)                                  \
        TRequestCounters<THistogram<TRequestTimeBuckets>> name;                \
...
#undef BLOCKSTORE_CUMULATIVE_COUNTER
    ...
    {
#define BLOCKSTORE_REQUEST_COUNTER(name, ...)                                 \
        THistogram<TRequestTimeBuckets> name;                                 \
// BLOCKSTORE_REQUEST_COUNTER
