...
private:
    ...
    void Forward(const TEventPtr& ev, const TActorContext& ctx);
};
...
template <class TEventPtr>
void TBootstrapperActor::Forward(const TEventPtr& ev, const TActorContext& ctx)
{
...
STFUNC(TBootstrapperActor::StateInit)
{
    switch (ev->GetTypeRewrite()) {
        ...
        default:
            HandleUnexpectedEvent(ctx, ev, TBlockStoreComponents::BOOTSTRAPPER);
            break;
    }
}
