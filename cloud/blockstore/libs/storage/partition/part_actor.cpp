...
bool TPartitionActor::HandleRequests(STFUNC_SIG)
{
    switch (ev->GetTypeRewrite()) {
        ...
        BLOCKSTORE_PARTITION_REQUESTS_PRIVATE(BLOCKSTORE_HANDLE_REQUEST, TEvPartitionPrivate)
...
bool TPartitionActor::RejectRequests(STFUNC_SIG)
{
    switch (ev->GetTypeRewrite()) {
        ...
        BLOCKSTORE_PARTITION_REQUESTS_PRIVATE(BLOCKSTORE_REJECT_REQUEST, TEvPartitionPrivate)
