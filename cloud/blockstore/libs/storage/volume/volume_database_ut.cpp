...
Y_UNIT_TEST_SUITE(TVolumeDatabaseTest)
{
    ...
    Y_UNIT_TEST(ShouldStoreCheckpointRequests)
    {
        ...
        executor.WriteTx([&] (TVolumeDatabase db) {
            ...
            db.MarkCheckpointRequestCompleted(1);
            db.MarkCheckpointRequestCompleted(3);
        });
    ...
    Y_UNIT_TEST(ShouldRemoveOutdatedDeletedCheckpointsFromHistory)
    {
        ...
        executor.WriteTx([&] (TVolumeDatabase db) {
            ...
            db.MarkCheckpointRequestCompleted(1);
            db.MarkCheckpointRequestCompleted(2);
            db.MarkCheckpointRequestCompleted(3);
            db.MarkCheckpointRequestCompleted(4);
        });
        ...
        executor.WriteTx([&] (TVolumeDatabase db) {
            ...
            db.MarkCheckpointRequestCompleted(5);
        });
