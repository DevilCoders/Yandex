...
def test_node_type():
    ...
    storage.DisableLocalService = True
    storage.SchemeShardDir = "/Root/nbs"
    storage.MeteringFilename = "metal"
    ...
    storage.DisableLocalService = True
    storage.SchemeShardDir = "/Root/nbs"
    storage.MeteringFilename = "global"
    ...
    # MeteringFilename = svm for nbs_control
    assert html.find('<td>MeteringFilename</td><td>svm</td>') != -1
