...
def default_storage_config(cache_folder):
    ...
    storage.TabletBootInfoCacheFilePath = \
        cache_folder + "/tablet_boot_info_cache.txt"
    storage.PathDescriptionCacheFilePath = \
        cache_folder + "/path_description_cache.txt"
...
def __run_test(test_case):
    ...
    env = LocalLoadTest(
        ...
        dynamic_pdisk_size=64 * 1024 * 1024 * 1024,
