...
class Meta(object):
    def __init__(self, dct):
        ...
        self.parent_block_uid = dct.get('parentBlockUid')
        self.parent_block_code = dct.get('parentBlockCode')
        self.parent_block_url = dct.get('parentBlockURL')
    ...
    def get_parent_block_uid(self):
        return self.parent_block_uid

    def get_parent_block_code(self):
        return self.parent_block_code

    def get_parent_block_url(self):
        return self.parent_block_url
...
class Status(object):
    ...
    def __repr__(self):
        return 'Status(error_msg=%r, success_msg=%r, log=%r)' % (self.error_msg, self.success_msg, self.log)

    def __str__(self):
        return 'Status{\n    error message file => %s\n    success message file => %s\n    log file => %s\n}' % (self.error_msg, self.success_msg, self.log)
