module "skm_bundle" {
    ...
    encrypted_dek = var.encrypted_dek != "" ? var.encrypted_dek : module.constants.by_environment.encrypted_dek
    kms_key_id = var.kms_key_id != "" ? var.kms_key_id : module.constants.by_environment.kms_key_id
