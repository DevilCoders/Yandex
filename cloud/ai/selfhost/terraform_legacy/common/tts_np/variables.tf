...
variable "envoy_version" {
    description = "Version of of envoy, used as billing proxy."
    default     = "ead18edcae3dcde5de0a2280b6d19f9e88491e79"
}

variable "billing_proxy_logs_relay_version" {
    description = "Version of docker image of billing logs relay."
    default     = "0.16"
}
...
variable "tts_downstream_port" {
    default = 17004
}

variable "tts_upstream_port" {
  default = 17005
}

variable "platform_id" {
    default = "gpu-private-v3"
}
