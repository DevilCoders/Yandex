...
from e2e_model.data import End2EndSampleBuilder, collate_wrapper
...
def parse_args():
    ...
    parser.add_argument("--data-config", type=str, default="e2e_model/configs/data.json")
    parser.add_argument("--model-config", type=str, default="e2e_model/configs/model.json")
    parser.add_argument("--optimizer-config", type=str, default="e2e_model/configs/optimizer.json")
...
def main(args):
    ...
    sample_builder = End2EndSampleBuilder(
    ...
    acoustic_model = End2EndTrainModule(
