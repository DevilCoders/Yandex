...
curl -s -H "X-YaCloud-SubjectToken: ${TOKEN}" https://storage.cloud-preprod.yandex.net/yc-billing-configs/selfsku-test/test_bundle -o test_bundle && chmod a+x test_bundle
