create table ods.bln_billing_account
(
    name                varchar(255),
    balance             varchar(255),
...
grant select, update, insert, delete, truncate on ods.bln_billing_account to "etl-user";

grant usage on schema ods to "etl-user";
