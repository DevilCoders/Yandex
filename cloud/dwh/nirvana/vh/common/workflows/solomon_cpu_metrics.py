...
from cloud.dwh.nirvana.vh.common.operations import get_default_solomon_cpu_metrics_op
...
class SolomonCpuMetricsReactiveWorkflowBase(ReactiveWorkflowBase, abc.ABC):
    """
    ...
    * `destination_path` - YT destination folder
    ...
    def _fill_graph(self, graph: vh.Graph, deploy_config: DeployConfig):
        ...
        daily_solomon_to_yt_op = get_default_solomon_cpu_metrics_op(deploy_config)
