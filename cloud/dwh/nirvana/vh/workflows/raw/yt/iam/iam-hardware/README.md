...
Данные из каталога hardware в БД global/iam: `global/iam/hardware`.
...
ycp --profile preprod datatransfer v1 endpoint create --request iam_prod_hardware.yaml
```
...
ycp --profile preprod datatransfer v1 endpoint create --request iam_preprod_hardware.yaml
```
