...
from cloud.dwh.nirvana.vh.common.workflows import SolomonCpuMetricsReactiveWorkflowBase
from cloud.dwh.nirvana.vh.config.base import BaseDeployConfig as DeployConfig


class ReactiveWorkflow(HourlyRandomMinuteCronReactiveWorkflowBase, SolomonCpuMetricsReactiveWorkflowBase):
    def _get_workflow_tags(self) -> Tuple[str, ...]:
        return 'solomon', 'yandexcloud'
