...
class ReactiveWorkflow(InputTriggerMultiMrTableSingleYqlReactiveWorkflowBase):
    ...
    def _get_workflow_tags(self) -> Tuple[str, ...]:
        return 'dm', 'billing', 'billing_record_user_labels'

    def _get_artifact_success_result(self, deploy_config: DeployConfig) -> str:
        return self._get_environment_parameters(environment=deploy_config.environment)['query_parameters']['destination_path']
