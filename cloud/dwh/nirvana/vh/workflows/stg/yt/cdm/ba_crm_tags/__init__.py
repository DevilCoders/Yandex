...
from cloud.dwh.nirvana.vh.common.workflows import InputTriggerMultiMrTableSingleYqlWithChecksReactiveWorkflowBase
from cloud.dwh.nirvana.vh.config.base import BaseDeployConfig as DeployConfig


class ReactiveWorkflow(InputTriggerMultiMrTableSingleYqlWithChecksReactiveWorkflowBase):
