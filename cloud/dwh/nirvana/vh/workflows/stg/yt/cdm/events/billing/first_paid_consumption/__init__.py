...
from cloud.dwh.nirvana.vh.common.workflows import CreateOrUpdateYqlReactiveWorkflowBase
...
class ReactiveWorkflow(HourlyRandomMinuteCronReactiveWorkflowBase, CreateOrUpdateYqlReactiveWorkflowBase):
