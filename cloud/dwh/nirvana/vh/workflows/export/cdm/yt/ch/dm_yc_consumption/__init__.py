...
from cloud.dwh.nirvana.vh.common.workflows import YtToBillingClickHouseReactiveWorkflowBase
...
class ReactiveWorkflow(HourlyRandomMinuteCronReactiveWorkflowBase, YtToBillingClickHouseReactiveWorkflowBase):
    def _get_workflow_tags(self) -> Tuple[str, ...]:
        return 'billing', 'yt_to_ch', 'dm_yc_consumption'
