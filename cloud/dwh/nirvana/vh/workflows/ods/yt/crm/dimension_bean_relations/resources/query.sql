...
$result = (
    SELECT
        $toString(`bean_id`)                                                            AS crm_bean_id,
        $toString(`bean_module`)                                                        AS crm_bean_module,
        ...
        $toString(`dimension_id`)                                                       AS crm_dimension_id,
        $toString(`id`)                                                                 AS dimension_bean_relation_id,
