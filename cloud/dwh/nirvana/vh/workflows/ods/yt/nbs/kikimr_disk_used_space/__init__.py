...
from cloud.dwh.nirvana.vh.common.workflows import InputTriggerMrDirectorySingleYqlReactiveWorkflowBase
from cloud.dwh.nirvana.vh.config.base import BaseDeployConfig as DeployConfig


class ReactiveWorkflow(InputTriggerMrDirectorySingleYqlReactiveWorkflowBase):
    def _get_workflow_tags(self) -> Tuple[str, ...]:
        return 'kikimr', 'disk_used_space'
