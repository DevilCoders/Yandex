...
import (
	...
	core_metrics "a.yandex-team.ru/library/go/core/metrics"
)
...
func (r *subregistry) FuncCounter(_ string, _ func() int64) {
}
...
func (r *subregistry) FuncGauge(_ string, _ func() float64) {
}
...
func CreateRegistryMock() *RegistryMock {
	return &RegistryMock{
		sensors: make(map[string]sensor),
	}
}

func (r *RegistryMock) getOrCreateSensor(
	name string,
	tags map[string]string,
	sensor sensor,
) sensor {
...
func (r *RegistryMock) GetCounter(
	...
	return r.getOrCreateSensor(name, tags, &CounterMock{}).(*CounterMock)
}
...
func (r *RegistryMock) GetGauge(
	...
	return r.getOrCreateSensor(name, tags, &GaugeMock{}).(*GaugeMock)
}
...
func (r *RegistryMock) GetHistogram(
	...
	return r.getOrCreateSensor(name, tags, &HistogramMock{
		Buckets: buckets,
	}).(*HistogramMock)
}
...
func (r *RegistryMock) GetTimer(
	...
	return r.getOrCreateSensor(name, tags, &TimerMock{}).(*TimerMock)
}
...
func (r *RegistryMock) FuncCounter(_ string, _ func() int64) {
}
...
func (r *RegistryMock) FuncGauge(_ string, _ func() float64) {
}
