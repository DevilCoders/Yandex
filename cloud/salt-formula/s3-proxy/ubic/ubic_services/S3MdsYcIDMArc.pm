package Ubic::Service::S3MdsYcIDMArc;
...
sub new {
    ...
    $params->{bin} = "/usr/bin/s3-mds-yc-idm-arc --config $config";
...
sub start_impl {
    ...
    Ubic::Service::Shared::Dirs::directory_checker( "/var/log/s3-mds-yc-idm-arc/", $self->{daemon_user} );
...
Ubic::Service::S3MdsYcIDMArc - run S3-YC-IDM Proxy as Ubic service

=head1 SYNOPSIS

# /etc/ubic/service/s3-mds-yc-idm-arc.json
  {
      "module": "Ubic::Service::S3MdsYcIDMArc",
      "options": {
          "config": "/etc/s3-mds-yc-idm-arc/s3-mds-yc-idm-arc.json",
          "timeout_options": {
              "start": {
                  "step": 1,
                  "trials": 3
