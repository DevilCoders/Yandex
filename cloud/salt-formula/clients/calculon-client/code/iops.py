...
#man1-5289-005.cloud.yandex.net ssd host
#fola-4189-13.cloud.yandex.net hdd host
...
def make_fio_initials(disks):
  ...
  for io_type in io_types:
    fname = os.path.join(cfg_dir, 'rand_{}.ini'.format(io_type))
    IOPS_LOG.info("Got new file to make: {}. Trying to render...".format(fname))
    data = render(tpl_path, {'type': io_type, 'disks': disks})
...
def get_iops(duration, artifacts_dir, disks):
  ...
  data = process_results(disks, artifacts_dir)
  return data


if __name__ == '__main__':
  print(get_iops(30, './t', ['sda3', 'sdb3', 'sdc3', 'sdd3', 'sde3', 'sdf3', 'sdh3', 'sdg3']))
