...
yc-secret-cli --profile $profile hostgroup add-secret bootstrap_base-role_prod_iam --secret-id $secret_id;
yc-secret-cli --profile $profile hostgroup add-secret bootstrap_base-role_prod_seed --secret-id $secret_id;
