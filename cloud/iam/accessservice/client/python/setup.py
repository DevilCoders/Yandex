...
class CopyModules(setuptools.Command):
    ...
    def run(self):
        ...
        yc_as_client_dest = "yc_as_client"
        relpaths = {
            "cloud/iam/accessservice/client/python": yc_as_client_dest,
        }
        ...
        shutil.copyfile(
            arcadia_root + "/cloud/iam/accessservice/client/python/setup.py",
...
setuptools.setup(
    name="yc_as_client",
    version="0.1.8",
    description="Python client for YC AccessService",
    author="cloud-iam@",
