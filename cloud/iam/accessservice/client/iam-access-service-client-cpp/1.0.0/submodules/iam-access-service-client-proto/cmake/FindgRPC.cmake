...
#
# grpc_generate_cpp (<SRCS> <HDRS> <DEST> <ROOT> [<ARGN>...])
#
...
#
function(GRPC_GENERATE_CPP SRCS HDRS DEST ROOT)
  file(GLOB_RECURSE PROTO_FILES ${ROOT}/${ARGN}/*.proto)

  if(NOT PROTO_FILES)
    message(SEND_ERROR "Error: GRPC_GENERATE_CPP() called without any proto files: for ${ROOT}")
    return()
  endif()
  ...
  foreach(FIL ${PROTO_FILES})
    ...
    list(APPEND ${SRCS} "${DEST}/${REL_DIR}/${FIL_WE}.grpc.pb.cc")
    list(APPEND ${HDRS} "${DEST}/${REL_DIR}/${FIL_WE}.grpc.pb.h")

    add_custom_command(
            OUTPUT "${DEST}/${REL_DIR}/${FIL_WE}.grpc.pb.cc"
            "${DEST}/${REL_DIR}/${FIL_WE}.grpc.pb.h"
            COMMAND protobuf::protoc
            ARGS --grpc_out ${DEST} ${_protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${REL_FIL}
