...
class CopyModules(setuptools.Command):
    ...
    def run(self):
        ...
        yc_as_mock_dest = "yc_as_mock"
        relpaths = {
            "cloud/iam/accessservice/mock/python": yc_as_mock_dest,
            "cloud/bitbucket/private-api/yandex/cloud/priv/servicecontrol/v1": "yc_as_mock/servicecontrol/v1",
        }
        ...
        shutil.copyfile(
            arcadia_root + "/cloud/iam/accessservice/mock/python/setup.py",
...
setuptools.setup(
    name="yc_as_mock",
    version="0.0.1",
    description="Python mock for YC AccessService",
    author="cloud-iam@",
