...
from yc_as_mock import mock_service
from yc_as_mock import control_service
...
def run(host="0.0.0.0", port=4284, control_server_port=2484, max_workers=1):
    ...
    mock_state = mock_service.AccessServiceMockState()
    access_service = mock_service.AccessServiceMockServicer(mock_state)
    ...
    control_server = control_service.ControlServer(mock_state, "AccessServiceMockControl")
