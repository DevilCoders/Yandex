module "balancer" {
  ...
  region_suffix                    = "private-api.eu-central-1.aws.prod.iam"
  ...
  endpoint_service_acceptance_required = true
  ...
  zone_notify                      = module.constants.zone_private_iam
