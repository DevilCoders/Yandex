                ...
                case 'individual' :
                    ...
                    default :
                        document.getElementById('fl-st').innerHTML+=strid+'<br>';
                         ...
                         if (check('state')) {
                               if (data['active']) {
                                    document.getElementById('fl-ap').innerHTML+=id+'<br>';
                               }
                               else {
                                   document.getElementById('fl-sp').innerHTML+=id+'<br>';
                               }
                         }
                         else {
                                document.getElementById('fl-ap').innerHTML+=id+'<br>';
                ...
                default:
                    ...
                    if (check('usestatus')) {
                        ...
                        case true:
                            if (check('state')) {
                                if (data['active']) {
                                    document.getElementById('ul-ap').innerHTML+=str+'<br>';
                                }
                                else {
                                    document.getElementById('ul-sp').innerHTML+=str+'<br>';
                                }
                            }
                            else {
                                document.getElementById('ul-ap').innerHTML+=str+'<br>';
                        ...
                        case false:
                            if (check('state')) {
                                if (data['active']) {
                                    document.getElementById('ul-at').innerHTML+=str+'<br>';
                                }
                                else {
                                    document.getElementById('ul-st').innerHTML+=str+'<br>';
                                }
                            }
                            else{
                                document.getElementById('ul-at').innerHTML+=str+'<br>';
