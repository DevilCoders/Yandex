#!/usr/bin/env python3
"""This module contains KeyManagementService class."""
...
class KeyManagementService(Base):
    """This class provides an methods for KMS quota service."""
    ...
    def __init__(self,
        ...
        self.name = 'key-management-service'
        self.client = client
