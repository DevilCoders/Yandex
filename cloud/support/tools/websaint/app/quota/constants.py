...
from app.quota.utils.request import gRPCRequest, RestRequest
...
CONVERTABLE_VALUES = (
    ...
    'compute.snapshots.size', 'compute.ssdDisks.size', 'compute.ssdFilesystems.size',
    'compute.hddFilesystems.size', 'compute.ssdNonReplicatedDisks.size',
    'ydb.dedicatedComputeMemory.size'
)
BAD_STATES = (
...
SERVICES = {
    ...
    "virtual-private-cloud": {
        ...
        "endpoint": {
            ...
            "preprod": "network-api.private-api.cloud-preprod.yandex.net:9823"
        }
    },
    "billing": {
        "client": RestRequest,
