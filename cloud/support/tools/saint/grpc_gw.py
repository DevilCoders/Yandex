...
from yandex.cloud.priv.compute.v1.admin import node_service_pb2_grpc as compute_host_service
from yandex.cloud.priv.compute.v1.admin import node_service_pb2 as compute_host_service_pb2
...
from yandex.cloud.priv.mdb.kafka.v1 import cluster_service_pb2_grpc as cluster_kafka_service
from yandex.cloud.priv.mdb.kafka.v1 import cluster_service_pb2 as cluster_kafka_service_pb2
from yandex.cloud.priv.mdb.elasticsearch.v1 import cluster_service_pb2_grpc as cluster_elasticsearch_service
from yandex.cloud.priv.mdb.elasticsearch.v1 import cluster_service_pb2 as cluster_elasticsearch_service_pb2
from yandex.cloud.priv.mdb.greenplum.v1 import cluster_service_pb2_grpc as cluster_greenplum_service
from yandex.cloud.priv.mdb.greenplum.v1 import cluster_service_pb2 as cluster_greenplum_service_pb2
from yandex.cloud.priv.mdb.sqlserver.v1 import cluster_service_pb2_grpc as cluster_sqlserver_service
from yandex.cloud.priv.mdb.sqlserver.v1 import cluster_service_pb2 as cluster_sqlserver_service_pb2
...
class GrpcChannels:
    ...
    @property
    def compute_host_service_channel(self):
        iam_token = self.iam_token
        endpoint = self.endpoints.compute_api[self.profile.name.upper()]
        return get_grpc_channel(compute_host_service.NodeServiceStub,
                                endpoint, iam_token)
    ...
    @property
    def cluster_kafka_channel(self):
        return get_grpc_channel(cluster_kafka_service.ClusterServiceStub,
                                "mdb-internal-api.private-api.cloud.yandex.net", self.iam_token)
    @property
    def cluster_elasticsearch_channel(self):
        return get_grpc_channel(cluster_elasticsearch_service.ClusterServiceStub,
                                "mdb-internal-api.private-api.cloud.yandex.net", self.iam_token)

    @property
    def cluster_greenplum_channel(self):
        return get_grpc_channel(cluster_greenplum_service.ClusterServiceStub,
                                "mdb-internal-api.private-api.cloud.yandex.net", self.iam_token)

    @property
    def cluster_sqlserver_channel(self):
        return get_grpc_channel(cluster_sqlserver_service.ClusterServiceStub,
                                "mdb-internal-api.private-api.cloud.yandex.net", self.iam_token)
