...
constexpr size_t FileStoreRequestCount =
    static_cast<size_t>(EFileStoreRequest::MAX);
...
enum class EFileStoreSystemRequest
{
    ...
    FILESTORE_SYSTEM_REQUESTS(FILESTORE_DECLARE_REQUEST)
    MAX
};
...
const TString& GetFileStoreSystemRequestName(EFileStoreSystemRequest requestType);
