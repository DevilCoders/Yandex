...
private:
    ...
    void ReplyAndDie(
        const TActorContext& ctx,
        const NProto::TError& error = NProto::TError());
};
    ...
    const NProto::TError& error)
{
    ...
    // FILESTORE_TRACE_SENT(ctx, &RequestInfo->TraceId, this, response);
    ...
    const TActorContext& ctx)
{
    ...
    // FILESTORE_TRACE_RECEIVED(ctx, &requestInfo->TraceId, this, msg);
