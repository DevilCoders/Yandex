...
{
private:
    TByteVector EncodedBlocks{{GetAllocatorByTag(EAllocatorTag::BlockList)}};
    TByteVector EncodedDeletionMarkers{{GetAllocatorByTag(EAllocatorTag::BlockList)}};
...
public:
    ...
    static TBlockList EncodeBlocks(const TBlock& block, ui32 blocksCount);
    static TBlockList EncodeBlocks(const TVector<TBlock>& blocks);
};
