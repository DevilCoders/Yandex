...
from cloud.marketplace.functests.yc_marketplace_functests.fixtures.common_data import get_fixture as get_common
...
def get_fixture():
    ...
    default_category = config.get_value("marketplace.default_isv_category")
    isv0 = generate_id()
    isv1 = generate_id()
