...
from cloud.marketplace.common.yc_marketplace_common.models.billing import BillingOperation
from cloud.marketplace.common.yc_marketplace_common.models.billing.billing_account import BillingAccount
from cloud.marketplace.common.yc_marketplace_common.models.billing.billing_account import BillingAccountFeatureRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.billing_account import BillingAccountFullView
from cloud.marketplace.common.yc_marketplace_common.models.billing.calculators import DryRunRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.calculators import DryRunResponse
from cloud.marketplace.common.yc_marketplace_common.models.billing.cloud import BindCloudAccountRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.cloud import CloudBatchRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.cloud import CloudBatchResponseEntry
from cloud.marketplace.common.yc_marketplace_common.models.billing.grant_policy import GrantPolicyCreateRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.grant_policy import GrantPolicyList
from cloud.marketplace.common.yc_marketplace_common.models.billing.grant_policy import GrantPolicyPublicView
from cloud.marketplace.common.yc_marketplace_common.models.billing.monetary_grant_offer import \
    BindMonetaryGrantOfferRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.monetary_grant_offer import \
    MonetaryGrantOfferPublicView
from cloud.marketplace.common.yc_marketplace_common.models.billing.person import PrivatePersonsList
from cloud.marketplace.common.yc_marketplace_common.models.billing.pricing import PricingVersion
from cloud.marketplace.common.yc_marketplace_common.models.billing.publisher_account import PublisherAccount
from cloud.marketplace.common.yc_marketplace_common.models.billing.publisher_account import \
    PublisherAccountCreateRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.publisher_account import PublisherAccountGetRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.publisher_account import \
    PublisherAccountUpdateRequest
...
from cloud.marketplace.common.yc_marketplace_common.models.billing.sku import CreateSkuRequest
from cloud.marketplace.common.yc_marketplace_common.models.billing.sku import SkuLinkView
from cloud.marketplace.common.yc_marketplace_common.models.billing.sku import SkuList
from cloud.marketplace.common.yc_marketplace_common.models.billing.sku import SkuProductLinkRequest
...
class BillingPrivateClient:
    ...
    def dry_run(self, request: DryRunRequest):
        path = "/dryRun"
        return self.__client.post(path, request.to_primitive(), model=DryRunResponse)
