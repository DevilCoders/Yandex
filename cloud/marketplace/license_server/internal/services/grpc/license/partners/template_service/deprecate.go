...
func (s *templateService) Deprecate(ctx context.Context, request *partners.DeprecateTemplateRequest) (*operation.Operation, error) {
	...
	meta := &partners.DeprecateTemplateMetadata{
