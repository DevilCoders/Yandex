...
func (suite *DeprecateGrpcTestSuite) TestDeprecateOk() {
	...
	resOp, err := suite.service.Deprecate(context.Background(), &partners.DeprecateTemplateRequest{Id: lt.ID})
...
func (suite *DeprecateGrpcTestSuite) TestDeprecateError() {
	resOp, err := suite.service.Deprecate(context.Background(), &partners.DeprecateTemplateRequest{Id: "NO_ID"})
