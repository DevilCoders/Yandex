...
func (s *templateVersionService) ListByTemplateID(ctx context.Context, request *partners.ListTemplateVersionByTemplateIDRequest) (*license.ListTemplateVersionResponse, error) {
