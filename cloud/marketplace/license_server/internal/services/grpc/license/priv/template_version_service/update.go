...
func (s *templateVersionService) Update(ctx context.Context, request *priv.UpdateTemplateVersionRequest) (*operation.Operation, error) {
	...
	meta := &priv.UpdateTemplateVersionMetadata{TemplateVersionId: request.Id}
