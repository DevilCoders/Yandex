...
func (s *instanceService) Cancel(ctx context.Context, request *console.CancelInstanceRequest) (*operation.Operation, error) {
	...
	meta := &console.CancelInstanceMetadata{InstanceId: request.Id}
