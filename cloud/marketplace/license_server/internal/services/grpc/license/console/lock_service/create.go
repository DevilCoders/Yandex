...
func (s *lockService) Create(ctx context.Context, request *console.CreateLockRequest) (*operation.Operation, error) {
	...
	var meta *console.CreateLockMetadata
	var res *license.Lock
	if opErr == nil {
		meta = &console.CreateLockMetadata{LockId: result.Lock.ID}
