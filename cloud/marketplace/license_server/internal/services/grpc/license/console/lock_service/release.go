...
import (
	...
	console "a.yandex-team.ru/cloud/bitbucket/private-api/yandex/cloud/priv/marketplace/licenseserver/v1/license/console"
...
func (s *lockService) Release(ctx context.Context, request *console.ReleaseLockRequest) (*operation.Operation, error) {
	...
	var meta *console.ReleaseLockMetadata
	var res *license.Lock
	if opErr == nil {
		meta = &console.ReleaseLockMetadata{LockId: result.Lock.ID}
