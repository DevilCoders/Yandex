...
func (ligp *DeprecateParams) validate() error {
...
func (a *DeprecateAction) checkParams(ctx context.Context, params DeprecateParams) error {
	err := params.validate()
	if err != nil {
		ctxtools.Logger(ctx).Debug("license instance deprecate params did not pass validation")
		return err
	}
	ctxtools.Logger(ctx).Debug("license instance deprecate params passed validation")
	return nil
}
...
func (a *DeprecateAction) Do(ctx context.Context, params DeprecateParams) (*DeprecateResult, error) {
	...
	li.State = license.DeprecatedInstanceState
