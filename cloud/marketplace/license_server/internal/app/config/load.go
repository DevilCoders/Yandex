...
func Load(ctx context.Context, paths []string) (*Service, error) {
	var cfg = new(Service)
...
func LoadMigrationConfig(ctx context.Context, paths []string) (*MigrationService, error) {
	var cfg = new(MigrationService)
...
func LoadWorkerConfig(ctx context.Context, paths []string) (*AutorecreateWorkerService, error) {
	var cfg = new(AutorecreateWorkerService)
