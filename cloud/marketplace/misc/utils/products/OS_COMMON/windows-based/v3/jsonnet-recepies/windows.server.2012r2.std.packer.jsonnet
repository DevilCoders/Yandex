...

{
  'variables': variables.windows_server {
    //source_image_name: 'windows-2012r2-std-base-v20200824',
    source_image_family: 'windows-2012r2-std-base',
    image_description: 'Microsoft Windows Server 2012R2 Standard',
    image_family: 'windows-2012r2-std-gvlk',
  },
