...
YC_API_URL='https://iaas.private-api.gpn.yandexcloud.net:8093'
YC_IAM_URL='https://identity.private-api.gpn.yandexcloud.net:14338'
YC_IAM_PRIV_URL='https://identity.private-api.gpn.yandexcloud.net:14338'
YC_CLOUD='ycmarketplace'
YC_FOLDER='mkt-prod'
YC_DEFAULT_FOLDER_ID="bn39unkjs7318rbcb8n4"

YC_USER='yndx.cloud.mkt.gpn'
YC_IAM_USER='yndx-cloud-mkt'
YC_USER_PRIV="pillar/private-gpn-1/secret/${YC_USER}"
...
declare -a instances=(
	"mkt-api-1 1 3G ipv6 ru-gpn-spb99 mkt-base-16 32212254720 network-hdd"
	"mkt-api-2 1 3G ipv6 ru-gpn-spb99 mkt-base-16 32212254720 network-hdd"
	"mkt-api-3 1 3G ipv6 ru-gpn-spb99 mkt-base-16 32212254720 network-hdd"
