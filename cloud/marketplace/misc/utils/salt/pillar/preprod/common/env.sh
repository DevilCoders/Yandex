...
YC_API_URL='https://iaas.private-api.cloud-preprod.yandex.net'
YC_IAM_URL='https://identity.private-api.cloud-preprod.yandex.net:14336'
YC_IAM_PRIV_URL='https://identity.private-api.cloud-preprod.yandex.net:14336'
YC_CLOUD='ycmarketplace'
YC_FOLDER='mkt-prod'
YC_DEFAULT_FOLDER_ID="aoeul32f0fg9kajucevc"

YC_USER='yndx.cloud.mkt'
YC_IAM_USER='yndx-cloud-mkt'
YC_USER_PRIV="pillar/preprod/secret/${YC_USER}"

YC_NETWORK_INTERFACE_IPV4='cloudmktprodnetsv4'
YC_NETWORK_INTERFACE_IPV6='cloudmktprodnets'

YC_BUILD_SUBNET_A='bucnhfutklkd0nctbdne'
YC_BUILD_SUBNET_B='bltkqposkvc0h5hf7jei'
YC_BUILD_SUBNET_C='fo26pqmdf2urudp2rqfr'
...
declare -a instances=(
	"mkt-api-4 4 8G ipv6 ru-central1-a mkt-base-16 32212254720 network-hdd"
	"mkt-api-5 4 8G ipv6 ru-central1-b mkt-base-16 32212254720 network-hdd"
	"mkt-api-6 4 8G ipv6 ru-central1-c mkt-base-16 32212254720 network-hdd"
	"mkt-queue-1 1 3G ipv6 ru-central1-c mkt-base-16 32212254720 network-hdd"
	"mkt-queue-2 1 3G ipv6 ru-central1-b mkt-base-16 32212254720 network-hdd"
	"mkt-factory-1 2 6G ipv6;build ru-central1-c mktbase-factory 32212254720 network-hdd"
	"mkt-factory-2 2 6G ipv6;build ru-central1-b mktbase-factory 32212254720 network-hdd"
)
