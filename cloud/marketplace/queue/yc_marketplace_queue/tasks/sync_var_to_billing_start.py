...
from cloud.marketplace.common.yc_marketplace_common.models.billing.billing_account import BillingAccountFeatureFlags
...
def task(params: TaskParams, *args, **kwargs) -> Union[TaskResolution, None]:
    ...
    op = client.add_feature_flag(params.params["billing_account_id"], BillingAccountFeatureRequest({
        "feature_flag": BillingAccountFeatureFlags.VAR,
    }))
