...
from cloud.marketplace.common.yc_marketplace_common.lib import OsProduct
...
def get_product(id: ResourceIdType, url: Optional[str]) -> OsProductResponse:
    if url is not None:
        OsProduct.rpc_set_logo_uri(id, url)
    return OsProduct.rpc_get_full(id)
